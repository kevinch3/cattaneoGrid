import{a as ae,b as ve,c as Pe,d as Te,e as we}from"./chunk-6FHZCKEO.js";import{a as Ee,b as He}from"./chunk-FP22JLSY.js";import{$a as l,Ba as T,Ea as Me,H as b,Ja as Se,Ka as xe,La as Y,M,Ma as x,Na as y,Oa as _,Pa as Z,Qa as le,R as k,Ra as c,S as R,Sa as u,T as S,Ta as f,U as I,Ua as h,Va as m,Wa as P,X as ue,Xa as w,Ya as ye,Za as E,_a as z,a as F,b as G,ba as D,ca as q,cb as Ae,d as v,da as he,db as De,eb as fe,fb as Q,gb as C,ha as pe,hb as p,i as ce,ib as K,jb as J,kb as ee,l as me,lb as ne,mb as X,oa as ke,qa as Re,qb as be,ra as s,rb as Ce,xa as ge}from"./chunk-UDDB25VY.js";var ie=class{constructor(){this.content=null,this.isPlaying=!1,this.currentTime=0}};var oe=(()=>{let o=class o{constructor(){this.persisted=null,this.lastSaveMs=0,this._completedIds=D(new Set),this.completedIds=this._completedIds.asReadonly(),this.persisted=this.loadFromStorage(),this._completedIds.set(new Set(this.persisted?.completed??[]));let e=this.persisted?{content:this.persisted.content,isPlaying:!1,currentTime:this.persisted.times[this.persisted.content.id]??0}:new ie;this.state=new ce(e)}performAction(e,n,i){let t=this.state.value;switch(e){case"play":if(n){let A=n.id===t.content?.id?t.currentTime:this.persisted?.times[n.id]??0;this.state.next({content:n,isPlaying:!0,currentTime:A}),this.persistContent(n)}break;case"pause":this.state.next(G(F({},t),{isPlaying:!1}));break;case"stop":if(this.state.next(G(F({},t),{isPlaying:!1,currentTime:0})),t.content&&this.persisted){let d=t.content.id;delete this.persisted.times[d],this.persisted.completed.includes(d)||(this.persisted.completed.push(d),this._completedIds.update(A=>new Set([...A,d]))),this.saveToStorage()}break;case"seek":typeof i=="number"&&(this.state.next(G(F({},t),{currentTime:i})),t.content&&this.throttledSaveTime(t.content.id,i));break}}getState(){return this.state.asObservable()}persistContent(e){this.persisted?this.persisted.content=e:this.persisted={content:e,times:{},completed:[]},this.saveToStorage()}throttledSaveTime(e,n){let i=Date.now();i-this.lastSaveMs<5e3||(this.lastSaveMs=i,this.persisted&&(this.persisted.times[e]=n,this.saveToStorage()))}loadFromStorage(){try{let e=localStorage.getItem("player-state");if(!e)return null;let n=JSON.parse(e);return!n.content?.id||!n.content?.link?null:{content:n.content,times:n.times??{},completed:n.completed??[]}}catch(e){return null}}saveToStorage(){try{localStorage.setItem("player-state",JSON.stringify(this.persisted))}catch(e){}}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var Be=[{episodio:"B",titulo:"Resident #stayhome #quedateencasa special - Sunsetstrip Home Edition 4/4/2020",likes:"48",descargas:"51.2K",fecha:"2020-04-04",descripcion:`Full Sunsetstrip Home Edition 5 hr set, recorded on 4/4/2020
...
Elke Kleijn - Eenvoud (Navar Remix)`}];var Le=(()=>{let o=class o{fetchEpisodes(){let e=Be,n=e.map(g=>this.parseIntegerField(g.likes)),i=e.map(g=>this.parseDescargas(g.descargas)),t=e.map(g=>this.parseDateField(g.fecha)),d=e.map(g=>this.parseDateField(g.fechasubida)),A=e.map(g=>this.parseIntegerField(g.episodio)),L=this.createColorScale(this.getMinValue(n),this.getMaxValue(n)),O=this.createColorScale(this.getMinValue(i),this.getMaxValue(i)),N=this.createColorScale(this.getMinValue(t),this.getMaxValue(t)),W=this.createColorScale(this.getMinValue(d),this.getMaxValue(d)),V=this.createColorScale(this.getMinValue(A),this.getMaxValue(A));return me(e.map(g=>this.convertToEpisodeSort(g,L,O,N,W,V)))}convertToEpisodeSort(e,n,i,t,d,A){let L=this.parseIntegerField(e.likes),O=this.parseDescargas(e.descargas),N=this.parseDateField(e.fecha),W=this.parseDateField(e.fechasubida),V=this.parseIntegerField(e.episodio),g=e.tracklist??e.descripcion??"";return G(F({},e),{tracklist:g,_fechasubida:this.createExtendedField(e.fechasubida??"",W,this.resolveColor(d,W)),_fecha:this.createExtendedField(e.fecha??"",N,this.resolveColor(t,N)),_descargas:this.createExtendedField(e.descargas??"",O,this.resolveColor(i,O)),_likes:this.createExtendedField(e.likes??"",L,this.resolveColor(n,L)),_episodio:this.createExtendedField(e.episodio??"",V,this.resolveColor(A,V))})}createExtendedField(e,n=null,i="grey"){return{value:e??"",number:n,color:i}}parseDescargas(e){if(typeof e!="string")return null;let n=e.trim();if(!n)return null;let i=n.toLowerCase().endsWith("k")?1e3:1,t=parseFloat(n);return Number.isFinite(t)?t*i:null}parseIntegerField(e){if(typeof e!="string")return null;let n=parseInt(e,10);return Number.isFinite(n)?n:null}parseDateField(e){if(typeof e!="string")return null;let n=new Date(e).getTime();return Number.isFinite(n)?n:null}getMinValue(e){let n=null;for(let i of e)typeof i=="number"&&Number.isFinite(i)&&(n===null||i<n)&&(n=i);return n}getMaxValue(e){let n=null;for(let i of e)typeof i=="number"&&Number.isFinite(i)&&(n===null||i>n)&&(n=i);return n}createColorScale(e,n){if(e===null||n===null)return null;let i=n-e;return t=>{let d=i>0?(t-e)/i:0,A=Math.round(255*d),L=Math.round(128*(1-d));return`rgb(${A},${L},0)`}}resolveColor(e,n){return!e||n===null?"grey":e(n)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var re=(()=>{let o=class o{constructor(){this.options=D([{value:"_likes",label:"Likes"},{value:"_descargas",label:"Descargas"},{value:"_fecha",label:"Fecha"},{value:"_episodio",label:"Episodio"}]),this.selectedField=D("_likes")}setField(e){this.selectedField.set(e)}addOption(e){this.options().find(n=>n.value===e.value)||this.options.update(n=>[...n,e])}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();function Ze(a){try{return localStorage.getItem(a)}catch(o){return null}}function Qe(a,o){try{localStorage.setItem(a,o)}catch(r){}}var U=(()=>{let o=class o{constructor(){this.presets=[{label:"Default",style:"default",mode:"system"},{label:"Minimal 2D",style:"minimal-2d",mode:"system"}],this._activePreset=D(this.loadInitialPreset()),this.activePreset=this._activePreset.asReadonly(),this._resolvedMode=D("light"),this.resolvedMode=this._resolvedMode.asReadonly(),this._mediaQuery=null,this._mediaListener=null,this.destroyRef=M(ue),this.updateResolvedMode(this._activePreset().mode),this.applyPreset(),q(()=>{this._activePreset(),this.initSystemListener()}),q(()=>{let e=this._resolvedMode();typeof document<"u"&&document.body.setAttribute("data-mode",e)}),this.destroyRef.onDestroy(()=>{this.removeMediaListener()})}setPreset(e){this._activePreset.set(e),this.applyPreset(),Qe("theme-preset",JSON.stringify({style:e.style,mode:e.mode}))}loadInitialPreset(){let e=this.presets.find(n=>n.style==="default");try{let n=Ze("theme-preset");if(!n)return e;let i=JSON.parse(n);return this.presets.find(d=>d.style===i.style&&d.mode===i.mode)??e}catch(n){return e}}updateResolvedMode(e){if(e==="system"){let n=typeof window<"u"?window.matchMedia("(prefers-color-scheme: dark)").matches:!1;this._resolvedMode.set(n?"dark":"light")}else this._resolvedMode.set(e)}applyPreset(){let e=this._activePreset();this.updateResolvedMode(e.mode),document.body.setAttribute("data-theme",e.style);let n=`/assets/themes/theme-${e.style}.css`,i=document.getElementById("theme-css");i?i.href=n:(i=document.createElement("link"),i.id="theme-css",i.rel="stylesheet",i.href=n,document.head.appendChild(i))}initSystemListener(){let e=this._activePreset();this.removeMediaListener(),e.mode==="system"&&typeof window<"u"&&(this._mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this._mediaListener=()=>{this._resolvedMode.set(this._mediaQuery.matches?"dark":"light")},this._mediaQuery.addEventListener("change",this._mediaListener))}removeMediaListener(){this._mediaQuery&&this._mediaListener&&(this._mediaQuery.removeEventListener("change",this._mediaListener),this._mediaListener=null,this._mediaQuery=null)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var Xe="cattaneo-episodes",B="blobs";var $=null;function te(){return $||($=new Promise((a,o)=>{let r=indexedDB.open(Xe,1);r.onerror=()=>{$=null,o(r.error)},r.onsuccess=()=>{a(r.result)},r.onupgradeneeded=e=>{let n=e.target.result;n.objectStoreNames.contains(B)||n.createObjectStore(B,{keyPath:"id"})}}),$)}function Ne(a){return v(this,null,function*(){let o=yield te();return new Promise((r,e)=>{let t=o.transaction([B],"readonly").objectStore(B).get(a);t.onsuccess=()=>r(t.result),t.onerror=()=>e(t.error)})})}function Fe(a){return v(this,null,function*(){let o=yield te();return new Promise((r,e)=>{let t=o.transaction([B],"readwrite").objectStore(B).put(a);t.onsuccess=()=>r(),t.onerror=()=>e(t.error)})})}function Ge(a){return v(this,null,function*(){let o=yield te();return new Promise((r,e)=>{let t=o.transaction([B],"readwrite").objectStore(B).delete(a);t.onsuccess=()=>r(),t.onerror=()=>e(t.error)})})}function Ke(){return v(this,null,function*(){let a=yield te();return new Promise((o,r)=>{let i=a.transaction([B],"readonly").objectStore(B).getAllKeys();i.onsuccess=()=>o(i.result??[]),i.onerror=()=>r(i.error)})})}var se=(()=>{let o=class o{constructor(){this.downloaded=D(new Map),this.progress=D(new Map),this.activeDownloads=new Map,this.loadFromIdb()}startDownload(e){return v(this,null,function*(){if(this.activeDownloads.has(e.id))return;let n=new AbortController;this.activeDownloads.set(e.id,n);try{let i=yield fetch(e.link,{signal:n.signal,mode:"cors"});if(!i.ok)throw new Error(`HTTP ${i.status}`);let t=i.headers.get("content-length"),d=t?parseInt(t,10):null,A=i.body?.getReader();if(!A)throw new Error("No response body");let L=[],O=0;for(;;){let{done:g,value:j}=yield A.read();if(g)break;if(L.push(j),O+=j.byteLength,d){let je=Math.round(O/d*100);this.progress.update(qe=>new Map(qe).set(e.id,je))}}let N=new Blob(L,{type:"audio/mpeg"}),W=URL.createObjectURL(N),V={id:e.id,blobUrl:W,title:e.title,sizeBytes:N.size,storedAt:Date.now()};yield Fe({id:e.id,blob:N,title:e.title,storedAt:Date.now()}),this.downloaded.update(g=>new Map(g).set(e.id,V)),this.progress.update(g=>{let j=new Map(g);return j.delete(e.id),j})}catch(i){i instanceof Error&&i.name==="AbortError"||console.error("Download failed:",i),this.progress.update(t=>{let d=new Map(t);return d.delete(e.id),d})}finally{this.activeDownloads.delete(e.id)}})}cancelDownload(e){let n=this.activeDownloads.get(e);n&&n.abort()}deleteDownload(e){return v(this,null,function*(){let n=this.downloaded().get(e);n&&URL.revokeObjectURL(n.blobUrl),yield Ge(e),this.downloaded.update(i=>{let t=new Map(i);return t.delete(e),t})})}getBlobUrl(e){return this.downloaded().get(e)?.blobUrl??null}loadFromIdb(){return v(this,null,function*(){try{let e=yield Ke(),n=new Map;for(let i of e){let t=yield Ne(i);if(t){let d=URL.createObjectURL(t.blob);n.set(i,{id:i,blobUrl:d,title:t.title,sizeBytes:t.blob.size,storedAt:t.storedAt})}}this.downloaded.set(n)}catch(e){console.warn("Failed to load downloads from IDB:",e)}})}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var en=(a,o)=>o.episodio;function nn(a,o){a&1&&(S(),h(0,"svg",6),P(1,"path",8),m())}function an(a,o){a&1&&(S(),h(0,"svg",6),P(1,"path",9),m())}function on(a,o){a&1&&(S(),h(0,"svg",7),P(1,"rect",10)(2,"path",11),m())}function rn(a,o){a&1&&(S(),h(0,"svg",7),P(1,"rect",10)(2,"path",11),m())}function tn(a,o){if(a&1&&(h(0,"div",4),x(1,nn,2,0,":svg:svg",6)(2,an,2,0,":svg:svg",6)(3,on,3,0,":svg:svg",7)(4,rn,3,0,":svg:svg",7),p(5),m()),a&2){let r;l();let e=X(3),n=l();s(),y((r=n.sort.selectedField())==="_likes"?1:r==="_descargas"?2:r==="_fecha"?3:r==="_fechasubida"?4:-1),s(4),J(" ",e," ")}}function sn(a,o){if(a&1&&(h(0,"span",18),p(1),m()),a&2){let r=l(2).$implicit,e=l();s(),J("",e.trackCount(r.tracklist)," tracks")}}function ln(a,o){if(a&1&&(h(0,"div",12,0)(2,"div",13),p(3),m(),h(4,"div",14)(5,"span",15),S(),h(6,"svg",16),P(7,"path",8),m(),p(8),m(),I(),h(9,"span",17),S(),h(10,"svg",16),P(11,"path",9),m(),p(12),m(),x(13,sn,2,1,"span",18),m(),I(),P(14,"div",19),m()),a&2){let r,e=l().$implicit,n=l();Q("background-color",((r=e[n.sort.selectedField()])==null?null:r.color)??"grey"),s(3),K(e.titulo),s(5),J(" ",e.likes," "),s(4),J(" ",e.descargas," "),s(),y(n.trackCount(e.tracklist)>0?13:-1),s(),ye("innerHTML",n.tracklistWithBreaks(e.tracklist),ke)}}function dn(a,o){if(a&1){let r=w();h(0,"div",2),z("click",function(){let n=k(r).$index,i=l();return R(i.onEpisodeClick(n))}),h(1,"div",3),p(2),m(),ee(3),x(4,tn,6,2,"div",4),m(),x(5,ln,15,7,"div",5)}if(a&2){let r,e=o.$implicit,n=o.$index,i=l();Q("background-color",((r=e[i.sort.selectedField()])==null?null:r.color)??"grey")("animation-delay",i.animatingSort?i.Math.min(n,20)*70+"ms":"0ms"),C("completed",i.playerService.completedIds().has(e.episodio??""))("downloaded",i.downloadService.downloaded().has(e.episodio??"")),Y("data-episode-id",e.link),s(2),K(e.episodio),s();let t=ne(i.tileSubLabel(e,i.sort.selectedField()));s(),y(t?4:-1),s(),y(i.selectedIndex===n?5:-1)}}var Oe=(()=>{let o=class o{constructor(){this.selectedIndex=null,this.episodes=[],this.animatingSort=!1,this.Math=Math,this.playerService=M(oe),this.downloadService=M(se),this.episodesService=M(Le),this.cdr=M(Ce),this.sort=M(re),this.theme=M(U),q(()=>{let e=this.sort.selectedField();if(this.episodes.length){let n=this.selectedIndex!==null?this.episodes[this.selectedIndex]?.link??null:null;he(()=>this.triggerSortAnimation()),this.sortEpisodes(e),this.selectedIndex=n!==null?this.episodes.findIndex(i=>i.link===n):null,this.selectedIndex===-1&&(this.selectedIndex=null),this.cdr.markForCheck()}})}ngOnInit(){this.episodesService.fetchEpisodes().subscribe({next:e=>{this.episodes=e,e.some(n=>!!n.fechasubida)&&this.sort.addOption({value:"_fechasubida",label:"Fecha subida"}),this.sortEpisodes(this.sort.selectedField()),this.cdr.markForCheck()},error:e=>console.error("Error fetching episodes:",e)})}triggerSortAnimation(){this.theme.activePreset().style==="minimal-2d"&&(this.animatingSort=!0,setTimeout(()=>{this.animatingSort=!1,this.cdr.markForCheck()},800))}onEpisodeClick(e){this.selectedIndex=this.selectedIndex===e?null:e;let n=this.episodes[e];this.playContent({title:n.titulo,link:n.link??"",id:n.episodio??""}),this.selectedIndex!==null&&setTimeout(()=>document.querySelector(".episode-detail-row")?.scrollIntoView({behavior:"smooth",block:"center"}))}playContent(e){this.playerService.performAction("play",e)}tracklistWithBreaks(e){return e?e.replace(/\n/g,"<br>"):""}trackCount(e){return e?e.split(`
`).filter(n=>n.trim()).length:0}sortEpisodes(e){this.episodes.length&&(this.episodes=[...this.episodes].sort((n,i)=>{let t=this.getSortableValue(n,e),d=this.getSortableValue(i,e);return t===null&&d===null?0:t===null?1:d===null?-1:d-t}))}tileSubLabel(e,n){if(n==="_episodio")return null;let i=e[n];if(!i?.value)return null;if(n==="_fecha"||n==="_fechasubida"){let t=new Date(i.value);return isNaN(t.getTime())?i.value:t.toLocaleDateString("en-US",{month:"short",year:"2-digit"})}return i.value}getSortableValue(e,n){let i=e[n];if(!i)return null;if(typeof i.number=="number"&&Number.isFinite(i.number))return i.number;let t=parseFloat(i.value??"");return Number.isFinite(t)?t:null}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=T({type:o,selectors:[["app-episodes-grid"]],decls:3,vars:2,consts:[["detailRow",""],[1,"episode-grid"],[1,"episode-item",3,"click"],[1,"episodio"],[1,"field-value"],[1,"episode-detail-row",3,"background-color"],["viewBox","0 0 16 16","width","8","height","8","fill","currentColor","aria-hidden","true"],["viewBox","0 0 16 16","width","8","height","8","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M8 14s-6-3.9-6-8a4 4 0 0 1 6-3.46A4 4 0 0 1 14 6c0 4.1-6 8-6 8z"],["d","M8 12L2 6h4V1h4v5h4L8 12z"],["x","1.5","y","2.5","width","13","height","12","rx","1.5"],["d","M1.5 6.5h13M5 1v3M11 1v3"],[1,"episode-detail-row"],[1,"titulo"],[1,"meta"],[1,"likes"],["viewBox","0 0 16 16","width","11","height","11","fill","currentColor","aria-hidden","true",2,"vertical-align","-1px"],[1,"descargas"],[1,"track-count"],[1,"tracklist",3,"innerHTML"]],template:function(n,i){n&1&&(h(0,"div",1),_(1,dn,6,13,null,null,en),m()),n&2&&(C("sorting",i.animatingSort),s(),Z(i.episodes))},dependencies:[ae],styles:['@charset "UTF-8";.episode-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{display:grid;padding:0;width:auto;position:relative;z-index:1;cursor:pointer;height:85px;align-content:center;transition:all .3s ease;content-visibility:auto;contain-intrinsic-size:120px 85px}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .episodio[_ngcontent-%COMP%]{text-align:center;text-shadow:0 1px 2px rgba(0,0,0,.25)}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .field-value[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:3px;font-size:10px;opacity:.65;margin-top:3px;text-shadow:0 1px 2px rgba(0,0,0,.25);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding:0 4px}.episode-grid[_ngcontent-%COMP%]   .episode-item.completed[_ngcontent-%COMP%]:after{content:"";position:absolute;top:0;right:0;width:14px;height:14px;background:#fff9;clip-path:polygon(0 0,100% 0,100% 100%)}.episode-grid[_ngcontent-%COMP%]   .episode-item.downloaded[_ngcontent-%COMP%]:before{content:"\\2193";position:absolute;top:2px;left:2px;width:12px;height:12px;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;background:#ffffffb3;border-radius:2px;color:#333}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%]{border:1px solid var(--border, transparent);opacity:0;animation:_ngcontent-%COMP%_tile-in .5s steps(2) forwards;font-family:var(--font-ui)}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_tile-sort .6s steps(2) forwards}@keyframes _ngcontent-%COMP%_tile-in{0%{opacity:0;transform:scaleX(1.06)}40%{opacity:1;transform:scaleX(.97) translate(1px)}70%{opacity:.7;transform:scaleX(1.02)}to{opacity:1;transform:none}}@keyframes _ngcontent-%COMP%_tile-sort{0%{opacity:1;filter:blur(0)}20%{opacity:.3;filter:blur(1px);transform:scaleX(1.04)}50%{opacity:.8;filter:blur(0);transform:scaleX(.98)}to{opacity:1;transform:none}}.episode-detail-row[_ngcontent-%COMP%]{grid-column:1/-1;transition:all .3s ease;padding:40px 30px;word-break:break-word;overflow-wrap:break-word;min-width:0}.episode-detail-row[_ngcontent-%COMP%]   .titulo[_ngcontent-%COMP%]{font-size:2em;font-weight:600;margin-bottom:8px}.episode-detail-row[_ngcontent-%COMP%]   .meta[_ngcontent-%COMP%]{display:flex;gap:16px;font-size:13px;opacity:.75;margin-bottom:16px}.episode-detail-row[_ngcontent-%COMP%]   .tracklist[_ngcontent-%COMP%]{max-height:300px;overflow-y:auto;font-size:13px;line-height:1.7;font-family:var(--font-ui, "Libre Franklin", sans-serif)}body[data-theme=minimal-2d][_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%]{font-family:var(--font-ui);font-size:12px;color:var(--text);border-left:2px solid var(--accent, #333);padding-left:12px}'],changeDetection:0});let a=o;return a})();var Ie=[{path:"",component:Oe},{path:"dmca",loadComponent:()=>import("./chunk-3YSTDGJ2.js").then(a=>a.DmcaPageComponent)},{path:"privacy",loadComponent:()=>import("./chunk-FWF53HWC.js").then(a=>a.PrivacyPageComponent)},{path:"terms",loadComponent:()=>import("./chunk-LCSB3KAZ.js").then(a=>a.TermsPageComponent)},{path:"**",redirectTo:""}];var de={providers:[we(Ie)]};var cn=(a,o)=>o.label,mn=(a,o)=>o.value;function un(a,o){if(a&1){let r=w();h(0,"button",16),z("click",function(){let n=k(r).$index,i=l(2);return R(i.selectTheme(n))}),p(1),m()}if(a&2){let r=o.$implicit,e=l(2);C("selected",e.theme.activePreset()===r),s(),K(r.label)}}function hn(a,o){if(a&1&&(h(0,"div",10),_(1,un,2,3,"button",15,cn),m()),a&2){let r=l();s(),Z(r.theme.presets)}}function pn(a,o){if(a&1){let r=w();h(0,"button",16),z("click",function(){let n=k(r).$implicit,i=l(2);return R(i.selectSort(n.value))}),p(1),m()}if(a&2){let r=o.$implicit,e=l(2);C("selected",e.sort.selectedField()===r.value),s(),K(r.label)}}function kn(a,o){if(a&1&&(h(0,"div",10),_(1,pn,2,3,"button",15,mn),m()),a&2){let r=l();s(),Z(r.sort.options())}}var ze=(()=>{let o=class o{constructor(){this.theme=M(U),this.sort=M(re),this.elRef=M(pe),this.openMenu=D(null)}onDocumentClick(e){this.elRef.nativeElement.contains(e.target)||this.openMenu.set(null)}toggleMenu(e,n){n.stopPropagation(),this.openMenu.update(i=>i===e?null:e)}selectTheme(e){this.theme.setPreset(this.theme.presets[e]),this.openMenu.set(null)}selectSort(e){this.sort.setField(e),this.openMenu.set(null)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=T({type:o,selectors:[["app-header"]],hostBindings:function(n,i){n&1&&E("click",function(d){return i.onDocumentClick(d)},Re)},decls:18,vars:6,consts:[[1,"app-header"],[1,"logo"],[1,"controls"],[1,"menu-wrap"],["aria-label","Theme",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","aria-hidden","true"],["x","1.5","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor"],["x","9","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.55"],["x","1.5","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.3"],["x","9","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.15"],[1,"dropdown"],["aria-label","Sort by",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M2 4h8M2 8h5M2 12h3"],["d","M12 3v10M10 11l2 2 2-2"],[1,"option",3,"selected"],[1,"option",3,"click"]],template:function(n,i){n&1&&(h(0,"header",0)(1,"span",1),p(2,"CATTANEO"),m(),h(3,"div",2)(4,"div",3)(5,"button",4),z("click",function(d){return i.toggleMenu("theme",d)}),S(),h(6,"svg",5),P(7,"rect",6)(8,"rect",7)(9,"rect",8)(10,"rect",9),m()(),x(11,hn,3,0,"div",10),m(),I(),h(12,"div",3)(13,"button",11),z("click",function(d){return i.toggleMenu("sort",d)}),S(),h(14,"svg",12),P(15,"path",13)(16,"path",14),m()(),x(17,kn,3,0,"div",10),m()()()),n&2&&(s(5),C("open",i.openMenu()==="theme"),s(6),y(i.openMenu()==="theme"?11:-1),s(2),C("open",i.openMenu()==="sort"),s(4),y(i.openMenu()==="sort"?17:-1))},dependencies:[ae],styles:['@charset "UTF-8";.app-header[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;padding:0 20px;height:var(--header-height, 52px);background:var(--bg-header, #fff);border-bottom:1px solid var(--border-header, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);flex-shrink:0}.app-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{font-weight:700;font-size:15px;letter-spacing:3px;color:var(--text-logo, #111)}.app-header[_ngcontent-%COMP%]   .controls[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px}.menu-wrap[_ngcontent-%COMP%]{position:relative}.menu-btn[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 6px);background:transparent;color:var(--text, #222);cursor:pointer;transition:background .15s,border-color .15s}.menu-btn[_ngcontent-%COMP%]:hover{background:var(--bg, #f5f5f5);border-color:var(--text-muted, #aaa)}.menu-btn.open[_ngcontent-%COMP%]{background:var(--text, #222);border-color:var(--text, #222);color:var(--bg, #fff)}.dropdown[_ngcontent-%COMP%]{position:absolute;top:calc(100% + 6px);right:0;min-width:130px;background:var(--bg-header, #fff);border:1px solid var(--border, #e0e0e0);border-radius:6px;box-shadow:0 4px 16px #0000001a;z-index:200;overflow:hidden}.option[_ngcontent-%COMP%]{display:block;width:100%;padding:8px 12px;font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:12px;text-align:left;background:transparent;border:none;color:var(--text, #222);cursor:pointer;transition:background .1s}.option[_ngcontent-%COMP%]:hover{background:var(--border, #f0f0f0)}.option.selected[_ngcontent-%COMP%]{font-weight:600;padding-left:10px;border-left:2px solid var(--text, #222)}'],changeDetection:0});let a=o;return a})();var Je=(()=>{let o=class o{};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=T({type:o,selectors:[["app-footer"]],decls:11,vars:0,consts:[[1,"app-footer"],["routerLink","/dmca"],[1,"sep"],["routerLink","/privacy"],["routerLink","/terms"]],template:function(n,i){n&1&&(c(0,"footer",0)(1,"a",1),p(2,"DMCA"),u(),c(3,"span",2),p(4,"\xB7"),u(),c(5,"a",3),p(6,"Privacy Policy"),u(),c(7,"span",2),p(8,"\xB7"),u(),c(9,"a",4),p(10,"Terms of Use"),u()())},dependencies:[Te],styles:['.app-footer[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:10px;height:32px;background:var(--bg-footer, #f5f5f5);border-top:1px solid var(--border, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:11px;flex-shrink:0}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{color:var(--text-muted, #aaa);text-decoration:none;letter-spacing:.5px;transition:color .2s}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{color:var(--text)}.app-footer[_ngcontent-%COMP%]   .sep[_ngcontent-%COMP%]{color:var(--border, #ccc)}'],changeDetection:0});let a=o;return a})();var We=(()=>{let o=class o{constructor(){this.isSupported=typeof navigator<"u"&&"mediaSession"in navigator}setMetadata(e){this.isSupported&&(navigator.mediaSession.metadata=new MediaMetadata({title:e.title,artist:"Hern\xE1n Cattaneo",artwork:[{src:"assets/icons/favicon_io/android-chrome-192x192.png",sizes:"192x192",type:"image/png"},{src:"assets/icons/favicon_io/android-chrome-512x512.png",sizes:"512x512",type:"image/png"}]}))}setPlaybackState(e){this.isSupported&&(navigator.mediaSession.playbackState=e)}setPositionState(e,n){if(this.isSupported&&!(!Number.isFinite(e)||!Number.isFinite(n)))try{navigator.mediaSession.setPositionState({duration:e,playbackRate:1,position:n})}catch(i){console.debug("setPositionState error:",i)}}registerHandlers(e){this.isSupported&&(navigator.mediaSession.setActionHandler("play",e.play),navigator.mediaSession.setActionHandler("pause",e.pause),navigator.mediaSession.setActionHandler("seekbackward",()=>e.seekbackward()),navigator.mediaSession.setActionHandler("seekforward",()=>e.seekforward()),navigator.mediaSession.setActionHandler("seekto",n=>{typeof n.seekTime=="number"&&e.seek(n.seekTime)}))}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=b({token:o,factory:o.\u0275fac,providedIn:"root"});let a=o;return a})();var Rn=["audioPlayer"],gn=()=>[import("./chunk-HFKCG7NK.js").then(a=>a.VisualizerComponent)];function Mn(a,o){a&1&&(S(),c(0,"svg",3),f(1,"rect",15)(2,"rect",16),u())}function Sn(a,o){a&1&&(S(),c(0,"svg",3),f(1,"polygon",17),u())}function xn(a,o){if(a&1){let r=w();c(0,"button",25),E("click",function(){k(r);let n=l(4);return R(n.confirmDelete())}),p(1," \u2715 Remove "),u()}}function yn(a,o){if(a&1){let r=w();c(0,"div",21),E("pointerdown",function(n){k(r);let i=l(3);return R(i.downloadPointerDown(n))})("pointerup",function(){k(r);let n=l(3);return R(n.downloadPointerUp())})("pointerleave",function(){k(r);let n=l(3);return R(n.downloadPointerUp())}),c(1,"button",22),S(),c(2,"svg",3),f(3,"path",23),u()(),x(4,xn,2,0,"button",24),u()}if(a&2){let r=l(3);s(4),y(r.isConfirmingDelete?4:-1)}}function An(a,o){if(a&1&&(c(0,"span",26),p(1),u()),a&2){l(2);let r=X(0);s(),J("",r,"%")}}function Dn(a,o){a&1&&(S(),c(0,"svg",27),f(1,"circle",28),u())}function fn(a,o){if(a&1&&(c(0,"button",19),x(1,An,2,1,"span",26)(2,Dn,2,0,":svg:svg",27),u()),a&2){l();let r=X(0);s(),y(r>=0?1:2)}}function bn(a,o){if(a&1){let r=w();c(0,"button",29),E("click",function(){k(r);let n=l(3);return R(n.startDownload())}),S(),c(1,"svg",3),f(2,"path",30),u()()}}function Cn(a,o){if(a&1&&(ee(0),x(1,yn,5,1,"div",18)(2,fn,3,1,"button",19)(3,bn,3,0,"button",20)),a&2){let r,e=l(2),n=ne(e.downloadService.progress().get(e.currentContent.id)),i=e.downloadService.downloaded().has(e.currentContent.id);s(),y((r=!0)===i?1:r===(typeof n=="number")?2:3)}}function vn(a,o){a&1&&f(0,"app-visualizer")}function Pn(a,o){if(a&1){let r=w();c(0,"div",1)(1,"button",2),E("click",function(){k(r);let n=l();return R(n.togglePlay())}),x(2,Mn,3,0,":svg:svg",3)(3,Sn,2,0,":svg:svg",3),u(),c(4,"button",4),E("click",function(){k(r);let n=l();return R(n.showVisualizer=!n.showVisualizer)}),S(),c(5,"svg",3),f(6,"rect",5)(7,"rect",6)(8,"rect",7)(9,"rect",8),u()(),x(10,Cn,4,2),I(),c(11,"div",9)(12,"div",10),p(13),u(),c(14,"div",11),Me(15,vn,1,0),Se(16,15,gn),u(),c(18,"input",12),E("pointerdown",function(){k(r);let n=l();return R(n.isDragging=!0)})("pointerup",function(){k(r);let n=l();return R(n.isDragging=!1)})("pointercancel",function(){k(r);let n=l();return R(n.isDragging=!1)})("input",function(n){k(r);let i=l();return R(i.onSeek(n))}),u()(),c(19,"audio",13,0),E("timeupdate",function(){k(r);let n=l();return R(n.onTimeUpdate())})("loadedmetadata",function(){k(r);let n=l();return R(n.onMetadata())})("ended",function(){k(r);let n=l();return R(n.onAudioEnded())}),f(21,"source",14),u()()}if(a&2){let r=l();s(),Y("aria-label",r.isPlaying?"Pause":"Play"),s(),y(r.isPlaying?2:3),s(2),C("active",r.showVisualizer),Y("aria-label",r.showVisualizer?"Hide visualizer":"Show visualizer"),s(6),y(r.currentContent?10:-1),s(3),K(r.currentContent.title),s(),C("vis-open",r.showVisualizer),s(2),xe(r.showVisualizer),s(2),Q("--progress-pct",r.progressPercent+"%"),C("dragging",r.isDragging),le("value",r.progressPercent),s(3),le("src",r.currentContent.link)}}var Ve=(()=>{let o=class o{set audioPlayerRef(e){this.audioElement=e?.nativeElement??null,this.audioElement&&this.audioAnalysis.connect(this.audioElement),this.syncAudio()}constructor(e){this.playerService=e,this.currentContent=null,this.progressPercent=0,this.duration=0,this.isPlaying=!1,this.isDragging=!1,this.showVisualizer=!1,this.isConfirmingDelete=!1,this.downloadLongPressTimer=null,this.LONG_PRESS_MS=500,this.audioElement=null,this.lastState=null,this.activeLink=null,this.lastReportedPosition=0,this.audioAnalysis=M(He),this.mediaSessionService=M(We),this.downloadService=M(se),typeof document<"u"&&document.addEventListener("click",()=>{this.isConfirmingDelete&&(this.isConfirmingDelete=!1)}),this.mediaSessionService.registerHandlers({play:()=>{this.lastState?.content&&this.playerService.performAction("play",this.lastState.content)},pause:()=>this.playerService.performAction("pause"),seekbackward:()=>{if(!this.audioElement)return;let n=Math.max(0,this.audioElement.currentTime-15);this.playerService.performAction("seek",void 0,n),this.audioElement&&(this.audioElement.currentTime=n)},seekforward:()=>{if(!this.audioElement)return;let n=Math.min(this.duration,this.audioElement.currentTime+15);this.playerService.performAction("seek",void 0,n),this.audioElement&&(this.audioElement.currentTime=n)},seek:n=>{let i=Math.max(0,Math.min(this.duration,n));this.playerService.performAction("seek",void 0,i),this.audioElement&&(this.audioElement.currentTime=i)}}),this.playerService.getState().pipe(Ee()).subscribe(n=>{this.lastState=n,this.currentContent=n.content,this.isPlaying=n.isPlaying,n.content&&(this.mediaSessionService.setMetadata(n.content),this.mediaSessionService.setPlaybackState(n.isPlaying?"playing":"paused")),this.syncAudio()})}togglePlay(){this.lastState&&(this.audioAnalysis.resume(),this.lastState.isPlaying?this.playerService.performAction("pause"):this.playerService.performAction("play",this.lastState.content??void 0))}onMetadata(){this.duration=this.audioElement?.duration??0,this.mediaSessionService.setPositionState(this.duration,this.audioElement?.currentTime??0),this.syncAudio()}onTimeUpdate(){if(!this.audioElement||!this.lastState)return;!this.isDragging&&this.audioElement.duration&&(this.progressPercent=this.audioElement.currentTime/this.audioElement.duration*100);let e=this.audioElement.currentTime;Math.abs(e-this.lastState.currentTime)>1&&this.playerService.performAction("seek",void 0,e),Math.abs(e-this.lastReportedPosition)>2&&(this.mediaSessionService.setPositionState(this.duration,e),this.lastReportedPosition=e)}onSeek(e){let n=+e.target.value,i=n/100*this.duration;this.progressPercent=n,this.playerService.performAction("seek",void 0,i),this.audioElement&&(this.audioElement.currentTime=i)}onAudioEnded(){this.playerService.performAction("stop")}startDownload(){this.currentContent&&this.downloadService.startDownload(this.currentContent)}downloadPointerDown(e){if(this.isConfirmingDelete){e.stopPropagation();return}this.downloadLongPressTimer=window.setTimeout(()=>{this.isConfirmingDelete=!0},this.LONG_PRESS_MS)}downloadPointerUp(){this.downloadLongPressTimer!==null&&(clearTimeout(this.downloadLongPressTimer),this.downloadLongPressTimer=null)}confirmDelete(){return v(this,null,function*(){this.currentContent&&(yield this.downloadService.deleteDownload(this.currentContent.id),this.isConfirmingDelete=!1)})}syncAudio(){if(!this.audioElement||!this.lastState)return;let{content:e,currentTime:n,isPlaying:i}=this.lastState;if(!e){this.audioElement.pause(),this.activeLink&&(this.audioElement.removeAttribute("src"),this.audioElement.load(),this.activeLink=null);return}let t=this.downloadService.getBlobUrl(e.id)??e.link;this.activeLink!==t&&(this.audioElement.src=t,this.audioElement.load(),this.activeLink=t),Math.abs(this.audioElement.currentTime-n)>1&&(this.audioElement.currentTime=n),i&&this.audioElement.paused?this.audioElement.play():!i&&!this.audioElement.paused&&this.audioElement.pause()}};o.\u0275fac=function(n){return new(n||o)(ge(oe))},o.\u0275cmp=T({type:o,selectors:[["app-episode-player"]],viewQuery:function(n,i){if(n&1&&Ae(Rn,5),n&2){let t;De(t=fe())&&(i.audioPlayerRef=t.first)}},decls:1,vars:1,consts:[["audioPlayer",""],[1,"floating-player"],[1,"play-btn",3,"click"],["viewBox","0 0 16 16","width","14","height","14","fill","currentColor","aria-hidden","true"],[1,"vis-btn",3,"click"],["x","1","y","8","width","3","height","7","rx","1"],["x","5","y","4","width","3","height","11","rx","1"],["x","9","y","6","width","3","height","9","rx","1"],["x","13","y","2","width","3","height","13","rx","1"],[1,"track-info"],[1,"track-title"],[1,"vis-wrapper"],["type","range","min","0","max","100","step","0.1","aria-label","Seek",1,"seek-bar",3,"pointerdown","pointerup","pointercancel","input","value"],["controls","","crossorigin","anonymous",2,"display","none",3,"timeupdate","loadedmetadata","ended"],["type","audio/mpeg",3,"src"],["x","2","y","1","width","5","height","14","rx","1"],["x","9","y","1","width","5","height","14","rx","1"],["points","3,1 15,8 3,15"],[1,"download-btn-wrapper"],["aria-label","Downloading...",1,"download-btn","downloading"],["aria-label","Download episode",1,"download-btn"],[1,"download-btn-wrapper",3,"pointerdown","pointerup","pointerleave"],["aria-label","Downloaded - long press to delete",1,"download-btn","downloaded"],["d","M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"],["aria-label","Delete download",1,"delete-confirm-btn"],["aria-label","Delete download",1,"delete-confirm-btn",3,"click"],[1,"progress-text"],["viewBox","0 0 16 16","width","12","height","12","fill","currentColor","aria-hidden","true"],["cx","8","cy","8","r","6","fill","none","stroke","currentColor","stroke-width","1","opacity","0.3"],["aria-label","Download episode",1,"download-btn",3,"click"],["d","M8 12L2 6h4V1h4v5h4L8 12z"]],template:function(n,i){n&1&&x(0,Pn,22,16,"div",1),n&2&&y(i.currentContent?0:-1)},styles:['@charset "UTF-8";[_nghost-%COMP%]{pointer-events:none}.floating-player[_ngcontent-%COMP%]{pointer-events:auto;position:fixed;bottom:52px;left:20px;right:20px;z-index:100;display:flex;align-items:center;gap:12px;padding:12px 16px;background:var(--bg-player, #fff);border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 8px);box-shadow:var(--player-shadow, 0 2px 12px rgba(0, 0, 0, .1));font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);transition:background .3s ease,border-color .3s ease,box-shadow .3s ease}.play-btn[_ngcontent-%COMP%]{width:36px;height:36px;flex-shrink:0;border-radius:var(--player-radius, 50%);border:1px solid var(--border, transparent);background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:box-shadow .2s}.track-info[_ngcontent-%COMP%]{flex:1;min-width:0}.track-title[_ngcontent-%COMP%]{font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--text)}.seek-bar[_ngcontent-%COMP%]{-webkit-appearance:none;appearance:none;display:block;width:100%;height:3px;margin-top:8px;border-radius:2px;outline:none;cursor:pointer;background:linear-gradient(to right,var(--player-fill, #222) var(--progress-pct, 0%),var(--player-track, #e0e0e0) var(--progress-pct, 0%));touch-action:pan-x}.seek-bar[_ngcontent-%COMP%]::-webkit-slider-thumb{-webkit-appearance:none;width:0;height:0;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease,margin-top .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-webkit-slider-thumb, .seek-bar[_ngcontent-%COMP%]:active::-webkit-slider-thumb{width:18px;height:18px;margin-top:-7px}.seek-bar[_ngcontent-%COMP%]::-moz-range-thumb{width:0;height:0;border:none;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-moz-range-thumb, .seek-bar[_ngcontent-%COMP%]:active::-moz-range-thumb{width:18px;height:18px}body[data-theme=minimal-2d][data-mode=dark][_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=minimal-2d][data-mode=dark]   [_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_glow-pulse 1.4s ease-in-out infinite}@keyframes _ngcontent-%COMP%_glow-pulse{0%,to{box-shadow:none}50%{box-shadow:var(--glow, none)}}.vis-wrapper[_ngcontent-%COMP%]{overflow:hidden;max-height:0;opacity:0;transition:max-height .35s ease,opacity .25s ease}.vis-wrapper.vis-open[_ngcontent-%COMP%]{max-height:52px;opacity:1}.vis-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s}.vis-btn.active[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}.download-btn-wrapper[_ngcontent-%COMP%]{display:flex;align-items:center;gap:4px;position:relative}.download-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s,color .2s;font-size:11px;font-weight:500}.download-btn[_ngcontent-%COMP%]:hover{opacity:.75}.download-btn.downloaded[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}.download-btn.downloading[_ngcontent-%COMP%]{opacity:.7}.download-btn[_ngcontent-%COMP%]   .progress-text[_ngcontent-%COMP%]{font-size:10px;font-weight:600}.delete-confirm-btn[_ngcontent-%COMP%]{padding:4px 8px;font-size:10px;font-weight:600;white-space:nowrap;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 4px);background:#dc35451a;color:#dc3545;cursor:pointer;transition:background .2s,color .2s}.delete-confirm-btn[_ngcontent-%COMP%]:hover{background:#dc354533}']});let a=o;return a})();var Ue=(()=>{let o=class o{constructor(){this._theme=M(U)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=T({type:o,selectors:[["app-root"]],decls:6,vars:0,consts:[[1,"app-container"],[1,"app-content"]],template:function(n,i){n&1&&(c(0,"div",0),f(1,"app-header"),c(2,"main",1),f(3,"router-outlet"),u(),f(4,"app-episode-player")(5,"app-footer"),u())},dependencies:[Pe,ze,Je,Ve],styles:[".app-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;height:100vh;max-height:-webkit-fill-available;background:var(--bg, #fff)}.app-content[_ngcontent-%COMP%]{flex:1;overflow-y:auto;padding-bottom:144px}"]});let a=o;return a})();ve(Ue,G(F({},de),{providers:[be(),...de.providers]})).then(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.register("./sw.js").catch(a=>console.warn("SW registration failed",a))}).catch(a=>console.error(a));
