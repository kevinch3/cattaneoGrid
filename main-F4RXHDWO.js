import{a as Z,b as ye,c as Ae,d as De,e as fe}from"./chunk-6FHZCKEO.js";import{a as be,b as Ce}from"./chunk-FP22JLSY.js";import{$a as d,Ba as C,Ea as de,H as w,Ja as ce,Ka as me,La as I,M as k,Ma as y,Na as A,Oa as z,Pa as J,Qa as $,R,Ra as u,S as g,Sa as p,T as M,Ta as v,U as B,Ua as m,Va as l,Wa as D,X as ie,Xa as L,Ya as ue,Za as N,_a as F,a as P,b as T,ba as b,ca as O,cb as he,da as oe,db as pe,eb as ke,fb as W,gb as x,ha as re,hb as h,i as ne,ib as E,jb as V,kb as Re,l as ae,lb as ge,mb as Me,oa as te,qa as se,qb as Se,ra as s,rb as xe,xa as le}from"./chunk-UDDB25VY.js";var _=class{constructor(){this.content=null,this.isPlaying=!1,this.currentTime=0}};var Q=(()=>{let i=class i{constructor(){this.persisted=null,this.lastSaveMs=0,this._completedIds=b(new Set),this.completedIds=this._completedIds.asReadonly(),this.persisted=this.loadFromStorage(),this._completedIds.set(new Set(this.persisted?.completed??[]));let e=this.persisted?{content:this.persisted.content,isPlaying:!1,currentTime:this.persisted.times[this.persisted.content.id]??0}:new _;this.state=new ne(e)}performAction(e,n,a){let t=this.state.value;switch(e){case"play":if(n){let f=n.id===t.content?.id?t.currentTime:this.persisted?.times[n.id]??0;this.state.next({content:n,isPlaying:!0,currentTime:f}),this.persistContent(n)}break;case"pause":this.state.next(T(P({},t),{isPlaying:!1}));break;case"stop":if(this.state.next(T(P({},t),{isPlaying:!1,currentTime:0})),t.content&&this.persisted){let c=t.content.id;delete this.persisted.times[c],this.persisted.completed.includes(c)||(this.persisted.completed.push(c),this._completedIds.update(f=>new Set([...f,c]))),this.saveToStorage()}break;case"seek":typeof a=="number"&&(this.state.next(T(P({},t),{currentTime:a})),t.content&&this.throttledSaveTime(t.content.id,a));break}}getState(){return this.state.asObservable()}persistContent(e){this.persisted?this.persisted.content=e:this.persisted={content:e,times:{},completed:[]},this.saveToStorage()}throttledSaveTime(e,n){let a=Date.now();a-this.lastSaveMs<5e3||(this.lastSaveMs=a,this.persisted&&(this.persisted.times[e]=n,this.saveToStorage()))}loadFromStorage(){try{let e=localStorage.getItem("player-state");if(!e)return null;let n=JSON.parse(e);return!n.content?.id||!n.content?.link?null:{content:n.content,times:n.times??{},completed:n.completed??[]}}catch(e){return null}}saveToStorage(){try{localStorage.setItem("player-state",JSON.stringify(this.persisted))}catch(e){}}};i.\u0275fac=function(n){return new(n||i)},i.\u0275prov=w({token:i,factory:i.\u0275fac,providedIn:"root"});let o=i;return o})();var ve=[{episodio:"B",titulo:"Resident #stayhome #quedateencasa special - Sunsetstrip Home Edition 4/4/2020",likes:"48",descargas:"51.2K",fecha:"2020-04-04",descripcion:`Full Sunsetstrip Home Edition 5 hr set, recorded on 4/4/2020
...
Elke Kleijn - Eenvoud (Navar Remix)`}];var Pe=(()=>{let i=class i{fetchEpisodes(){let e=ve,n=e.map(S=>this.parseIntegerField(S.likes)),a=e.map(S=>this.parseDescargas(S.descargas)),t=e.map(S=>this.parseDateField(S.fecha)),c=e.map(S=>this.parseDateField(S.fechasubida)),f=e.map(S=>this.parseIntegerField(S.episodio)),G=this.createColorScale(this.getMinValue(n),this.getMaxValue(n)),U=this.createColorScale(this.getMinValue(a),this.getMaxValue(a)),j=this.createColorScale(this.getMinValue(t),this.getMaxValue(t)),q=this.createColorScale(this.getMinValue(c),this.getMaxValue(c)),Y=this.createColorScale(this.getMinValue(f),this.getMaxValue(f));return ae(e.map(S=>this.convertToEpisodeSort(S,G,U,j,q,Y)))}convertToEpisodeSort(e,n,a,t,c,f){let G=this.parseIntegerField(e.likes),U=this.parseDescargas(e.descargas),j=this.parseDateField(e.fecha),q=this.parseDateField(e.fechasubida),Y=this.parseIntegerField(e.episodio),S=e.tracklist??e.descripcion??"";return T(P({},e),{tracklist:S,_fechasubida:this.createExtendedField(e.fechasubida??"",q,this.resolveColor(c,q)),_fecha:this.createExtendedField(e.fecha??"",j,this.resolveColor(t,j)),_descargas:this.createExtendedField(e.descargas??"",U,this.resolveColor(a,U)),_likes:this.createExtendedField(e.likes??"",G,this.resolveColor(n,G)),_episodio:this.createExtendedField(e.episodio??"",Y,this.resolveColor(f,Y))})}createExtendedField(e,n=null,a="grey"){return{value:e??"",number:n,color:a}}parseDescargas(e){if(typeof e!="string")return null;let n=e.trim();if(!n)return null;let a=n.toLowerCase().endsWith("k")?1e3:1,t=parseFloat(n);return Number.isFinite(t)?t*a:null}parseIntegerField(e){if(typeof e!="string")return null;let n=parseInt(e,10);return Number.isFinite(n)?n:null}parseDateField(e){if(typeof e!="string")return null;let n=new Date(e).getTime();return Number.isFinite(n)?n:null}getMinValue(e){let n=null;for(let a of e)typeof a=="number"&&Number.isFinite(a)&&(n===null||a<n)&&(n=a);return n}getMaxValue(e){let n=null;for(let a of e)typeof a=="number"&&Number.isFinite(a)&&(n===null||a>n)&&(n=a);return n}createColorScale(e,n){if(e===null||n===null)return null;let a=n-e;return t=>{let c=a>0?(t-e)/a:0,f=Math.round(255*c),G=Math.round(128*(1-c));return`rgb(${f},${G},0)`}}resolveColor(e,n){return!e||n===null?"grey":e(n)}};i.\u0275fac=function(n){return new(n||i)},i.\u0275prov=w({token:i,factory:i.\u0275fac,providedIn:"root"});let o=i;return o})();var X=(()=>{let i=class i{constructor(){this.options=b([{value:"_likes",label:"Likes"},{value:"_descargas",label:"Descargas"},{value:"_fecha",label:"Fecha"},{value:"_episodio",label:"Episodio"}]),this.selectedField=b("_likes")}setField(e){this.selectedField.set(e)}addOption(e){this.options().find(n=>n.value===e.value)||this.options.update(n=>[...n,e])}};i.\u0275fac=function(n){return new(n||i)},i.\u0275prov=w({token:i,factory:i.\u0275fac,providedIn:"root"});let o=i;return o})();function Ge(o){try{return localStorage.getItem(o)}catch(i){return null}}function Ke(o,i){try{localStorage.setItem(o,i)}catch(r){}}var K=(()=>{let i=class i{constructor(){this.presets=[{label:"Default",style:"default",mode:"system"},{label:"Minimal 2D",style:"minimal-2d",mode:"system"}],this._activePreset=b(this.loadInitialPreset()),this.activePreset=this._activePreset.asReadonly(),this._resolvedMode=b("light"),this.resolvedMode=this._resolvedMode.asReadonly(),this._mediaQuery=null,this._mediaListener=null,this.destroyRef=k(ie),this.updateResolvedMode(this._activePreset().mode),this.applyPreset(),O(()=>{this._activePreset(),this.initSystemListener()}),O(()=>{let e=this._resolvedMode();typeof document<"u"&&document.body.setAttribute("data-mode",e)}),this.destroyRef.onDestroy(()=>{this.removeMediaListener()})}setPreset(e){this._activePreset.set(e),this.applyPreset(),Ke("theme-preset",JSON.stringify({style:e.style,mode:e.mode}))}loadInitialPreset(){let e=this.presets.find(n=>n.style==="default");try{let n=Ge("theme-preset");if(!n)return e;let a=JSON.parse(n);return this.presets.find(c=>c.style===a.style&&c.mode===a.mode)??e}catch(n){return e}}updateResolvedMode(e){if(e==="system"){let n=typeof window<"u"?window.matchMedia("(prefers-color-scheme: dark)").matches:!1;this._resolvedMode.set(n?"dark":"light")}else this._resolvedMode.set(e)}applyPreset(){let e=this._activePreset();this.updateResolvedMode(e.mode),document.body.setAttribute("data-theme",e.style);let n=`/assets/themes/theme-${e.style}.css`,a=document.getElementById("theme-css");a?a.href=n:(a=document.createElement("link"),a.id="theme-css",a.rel="stylesheet",a.href=n,document.head.appendChild(a))}initSystemListener(){let e=this._activePreset();this.removeMediaListener(),e.mode==="system"&&typeof window<"u"&&(this._mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this._mediaListener=()=>{this._resolvedMode.set(this._mediaQuery.matches?"dark":"light")},this._mediaQuery.addEventListener("change",this._mediaListener))}removeMediaListener(){this._mediaQuery&&this._mediaListener&&(this._mediaQuery.removeEventListener("change",this._mediaListener),this._mediaListener=null,this._mediaQuery=null)}};i.\u0275fac=function(n){return new(n||i)},i.\u0275prov=w({token:i,factory:i.\u0275fac,providedIn:"root"});let o=i;return o})();var Oe=(o,i)=>i.episodio;function Ie(o,i){o&1&&(M(),m(0,"svg",6),D(1,"path",8),l())}function ze(o,i){o&1&&(M(),m(0,"svg",6),D(1,"path",9),l())}function Je(o,i){o&1&&(M(),m(0,"svg",7),D(1,"rect",10)(2,"path",11),l())}function We(o,i){o&1&&(M(),m(0,"svg",7),D(1,"rect",10)(2,"path",11),l())}function Ve(o,i){if(o&1&&(m(0,"div",4),y(1,Ie,2,0,":svg:svg",6)(2,ze,2,0,":svg:svg",6)(3,Je,3,0,":svg:svg",7)(4,We,3,0,":svg:svg",7),h(5),l()),o&2){let r;d();let e=Me(3),n=d();s(),A((r=n.sort.selectedField())==="_likes"?1:r==="_descargas"?2:r==="_fecha"?3:r==="_fechasubida"?4:-1),s(4),V(" ",e," ")}}function Ue(o,i){if(o&1&&(m(0,"span",18),h(1),l()),o&2){let r=d(2).$implicit,e=d();s(),V("",e.trackCount(r.tracklist)," tracks")}}function je(o,i){if(o&1&&(m(0,"div",12,0)(2,"div",13),h(3),l(),m(4,"div",14)(5,"span",15),M(),m(6,"svg",16),D(7,"path",8),l(),h(8),l(),B(),m(9,"span",17),M(),m(10,"svg",16),D(11,"path",9),l(),h(12),l(),y(13,Ue,2,1,"span",18),l(),B(),D(14,"div",19),l()),o&2){let r,e=d().$implicit,n=d();W("background-color",((r=e[n.sort.selectedField()])==null?null:r.color)??"grey"),s(3),E(e.titulo),s(5),V(" ",e.likes," "),s(4),V(" ",e.descargas," "),s(),A(n.trackCount(e.tracklist)>0?13:-1),s(),ue("innerHTML",n.tracklistWithBreaks(e.tracklist),te)}}function qe(o,i){if(o&1){let r=L();m(0,"div",2),F("click",function(){let n=R(r).$index,a=d();return g(a.onEpisodeClick(n))}),m(1,"div",3),h(2),l(),Re(3),y(4,Ve,6,2,"div",4),l(),y(5,je,15,7,"div",5)}if(o&2){let r,e=i.$implicit,n=i.$index,a=d();W("background-color",((r=e[a.sort.selectedField()])==null?null:r.color)??"grey")("animation-delay",a.animatingSort?a.Math.min(n,20)*70+"ms":"0ms"),x("completed",a.playerService.completedIds().has(e.episodio??"")),I("data-episode-id",e.link),s(2),E(e.episodio),s();let t=ge(a.tileSubLabel(e,a.sort.selectedField()));s(),A(t?4:-1),s(),A(a.selectedIndex===n?5:-1)}}var Te=(()=>{let i=class i{constructor(){this.selectedIndex=null,this.episodes=[],this.animatingSort=!1,this.Math=Math,this.playerService=k(Q),this.episodesService=k(Pe),this.cdr=k(xe),this.sort=k(X),this.theme=k(K),O(()=>{let e=this.sort.selectedField();if(this.episodes.length){let n=this.selectedIndex!==null?this.episodes[this.selectedIndex]?.link??null:null;oe(()=>this.triggerSortAnimation()),this.sortEpisodes(e),this.selectedIndex=n!==null?this.episodes.findIndex(a=>a.link===n):null,this.selectedIndex===-1&&(this.selectedIndex=null),this.cdr.markForCheck()}})}ngOnInit(){this.episodesService.fetchEpisodes().subscribe({next:e=>{this.episodes=e,e.some(n=>!!n.fechasubida)&&this.sort.addOption({value:"_fechasubida",label:"Fecha subida"}),this.sortEpisodes(this.sort.selectedField()),this.cdr.markForCheck()},error:e=>console.error("Error fetching episodes:",e)})}triggerSortAnimation(){this.theme.activePreset().style==="minimal-2d"&&(this.animatingSort=!0,setTimeout(()=>{this.animatingSort=!1,this.cdr.markForCheck()},800))}onEpisodeClick(e){this.selectedIndex=this.selectedIndex===e?null:e;let n=this.episodes[e];this.playContent({title:n.titulo,link:n.link??"",id:n.episodio??""}),this.selectedIndex!==null&&setTimeout(()=>document.querySelector(".episode-detail-row")?.scrollIntoView({behavior:"smooth",block:"center"}))}playContent(e){this.playerService.performAction("play",e)}tracklistWithBreaks(e){return e?e.replace(/\n/g,"<br>"):""}trackCount(e){return e?e.split(`
`).filter(n=>n.trim()).length:0}sortEpisodes(e){this.episodes.length&&(this.episodes=[...this.episodes].sort((n,a)=>{let t=this.getSortableValue(n,e),c=this.getSortableValue(a,e);return t===null&&c===null?0:t===null?1:c===null?-1:c-t}))}tileSubLabel(e,n){if(n==="_episodio")return null;let a=e[n];if(!a?.value)return null;if(n==="_fecha"||n==="_fechasubida"){let t=new Date(a.value);return isNaN(t.getTime())?a.value:t.toLocaleDateString("en-US",{month:"short",year:"2-digit"})}return a.value}getSortableValue(e,n){let a=e[n];if(!a)return null;if(typeof a.number=="number"&&Number.isFinite(a.number))return a.number;let t=parseFloat(a.value??"");return Number.isFinite(t)?t:null}};i.\u0275fac=function(n){return new(n||i)},i.\u0275cmp=C({type:i,selectors:[["app-episodes-grid"]],decls:3,vars:2,consts:[["detailRow",""],[1,"episode-grid"],[1,"episode-item",3,"click"],[1,"episodio"],[1,"field-value"],[1,"episode-detail-row",3,"background-color"],["viewBox","0 0 16 16","width","8","height","8","fill","currentColor","aria-hidden","true"],["viewBox","0 0 16 16","width","8","height","8","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M8 14s-6-3.9-6-8a4 4 0 0 1 6-3.46A4 4 0 0 1 14 6c0 4.1-6 8-6 8z"],["d","M8 12L2 6h4V1h4v5h4L8 12z"],["x","1.5","y","2.5","width","13","height","12","rx","1.5"],["d","M1.5 6.5h13M5 1v3M11 1v3"],[1,"episode-detail-row"],[1,"titulo"],[1,"meta"],[1,"likes"],["viewBox","0 0 16 16","width","11","height","11","fill","currentColor","aria-hidden","true",2,"vertical-align","-1px"],[1,"descargas"],[1,"track-count"],[1,"tracklist",3,"innerHTML"]],template:function(n,a){n&1&&(m(0,"div",1),z(1,qe,6,11,null,null,Oe),l()),n&2&&(x("sorting",a.animatingSort),s(),J(a.episodes))},dependencies:[Z],styles:['@charset "UTF-8";.episode-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{display:grid;padding:0;width:auto;position:relative;z-index:1;cursor:pointer;height:85px;align-content:center;transition:all .3s ease;content-visibility:auto;contain-intrinsic-size:120px 85px}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .episodio[_ngcontent-%COMP%]{text-align:center;text-shadow:0 1px 2px rgba(0,0,0,.25)}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .field-value[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:3px;font-size:10px;opacity:.65;margin-top:3px;text-shadow:0 1px 2px rgba(0,0,0,.25);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding:0 4px}.episode-grid[_ngcontent-%COMP%]   .episode-item.completed[_ngcontent-%COMP%]:after{content:"";position:absolute;top:0;right:0;width:14px;height:14px;background:#fff9;clip-path:polygon(0 0,100% 0,100% 100%)}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%]{border:1px solid var(--border, transparent);opacity:0;animation:_ngcontent-%COMP%_tile-in .5s steps(2) forwards;font-family:var(--font-ui)}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_tile-sort .6s steps(2) forwards}@keyframes _ngcontent-%COMP%_tile-in{0%{opacity:0;transform:scaleX(1.06)}40%{opacity:1;transform:scaleX(.97) translate(1px)}70%{opacity:.7;transform:scaleX(1.02)}to{opacity:1;transform:none}}@keyframes _ngcontent-%COMP%_tile-sort{0%{opacity:1;filter:blur(0)}20%{opacity:.3;filter:blur(1px);transform:scaleX(1.04)}50%{opacity:.8;filter:blur(0);transform:scaleX(.98)}to{opacity:1;transform:none}}.episode-detail-row[_ngcontent-%COMP%]{grid-column:1/-1;transition:all .3s ease;padding:40px 30px;word-break:break-word;overflow-wrap:break-word;min-width:0}.episode-detail-row[_ngcontent-%COMP%]   .titulo[_ngcontent-%COMP%]{font-size:2em;font-weight:600;margin-bottom:8px}.episode-detail-row[_ngcontent-%COMP%]   .meta[_ngcontent-%COMP%]{display:flex;gap:16px;font-size:13px;opacity:.75;margin-bottom:16px}.episode-detail-row[_ngcontent-%COMP%]   .tracklist[_ngcontent-%COMP%]{max-height:300px;overflow-y:auto;font-size:13px;line-height:1.7;font-family:var(--font-ui, "Libre Franklin", sans-serif)}body[data-theme=minimal-2d][_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%]{font-family:var(--font-ui);font-size:12px;color:var(--text);border-left:2px solid var(--accent, #333);padding-left:12px}'],changeDetection:0});let o=i;return o})();var we=[{path:"",component:Te},{path:"dmca",loadComponent:()=>import("./chunk-3YSTDGJ2.js").then(o=>o.DmcaPageComponent)},{path:"privacy",loadComponent:()=>import("./chunk-FWF53HWC.js").then(o=>o.PrivacyPageComponent)},{path:"terms",loadComponent:()=>import("./chunk-LCSB3KAZ.js").then(o=>o.TermsPageComponent)},{path:"**",redirectTo:""}];var ee={providers:[fe(we)]};var Ye=(o,i)=>i.label,Ze=(o,i)=>i.value;function _e(o,i){if(o&1){let r=L();m(0,"button",16),F("click",function(){let n=R(r).$index,a=d(2);return g(a.selectTheme(n))}),h(1),l()}if(o&2){let r=i.$implicit,e=d(2);x("selected",e.theme.activePreset()===r),s(),E(r.label)}}function Qe(o,i){if(o&1&&(m(0,"div",10),z(1,_e,2,3,"button",15,Ye),l()),o&2){let r=d();s(),J(r.theme.presets)}}function Xe(o,i){if(o&1){let r=L();m(0,"button",16),F("click",function(){let n=R(r).$implicit,a=d(2);return g(a.selectSort(n.value))}),h(1),l()}if(o&2){let r=i.$implicit,e=d(2);x("selected",e.sort.selectedField()===r.value),s(),E(r.label)}}function $e(o,i){if(o&1&&(m(0,"div",10),z(1,Xe,2,3,"button",15,Ze),l()),o&2){let r=d();s(),J(r.sort.options())}}var Ee=(()=>{let i=class i{constructor(){this.theme=k(K),this.sort=k(X),this.elRef=k(re),this.openMenu=b(null)}onDocumentClick(e){this.elRef.nativeElement.contains(e.target)||this.openMenu.set(null)}toggleMenu(e,n){n.stopPropagation(),this.openMenu.update(a=>a===e?null:e)}selectTheme(e){this.theme.setPreset(this.theme.presets[e]),this.openMenu.set(null)}selectSort(e){this.sort.setField(e),this.openMenu.set(null)}};i.\u0275fac=function(n){return new(n||i)},i.\u0275cmp=C({type:i,selectors:[["app-header"]],hostBindings:function(n,a){n&1&&N("click",function(c){return a.onDocumentClick(c)},se)},decls:18,vars:6,consts:[[1,"app-header"],[1,"logo"],[1,"controls"],[1,"menu-wrap"],["aria-label","Theme",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","aria-hidden","true"],["x","1.5","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor"],["x","9","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.55"],["x","1.5","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.3"],["x","9","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.15"],[1,"dropdown"],["aria-label","Sort by",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M2 4h8M2 8h5M2 12h3"],["d","M12 3v10M10 11l2 2 2-2"],[1,"option",3,"selected"],[1,"option",3,"click"]],template:function(n,a){n&1&&(m(0,"header",0)(1,"span",1),h(2,"CATTANEO"),l(),m(3,"div",2)(4,"div",3)(5,"button",4),F("click",function(c){return a.toggleMenu("theme",c)}),M(),m(6,"svg",5),D(7,"rect",6)(8,"rect",7)(9,"rect",8)(10,"rect",9),l()(),y(11,Qe,3,0,"div",10),l(),B(),m(12,"div",3)(13,"button",11),F("click",function(c){return a.toggleMenu("sort",c)}),M(),m(14,"svg",12),D(15,"path",13)(16,"path",14),l()(),y(17,$e,3,0,"div",10),l()()()),n&2&&(s(5),x("open",a.openMenu()==="theme"),s(6),A(a.openMenu()==="theme"?11:-1),s(2),x("open",a.openMenu()==="sort"),s(4),A(a.openMenu()==="sort"?17:-1))},dependencies:[Z],styles:['@charset "UTF-8";.app-header[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;padding:0 20px;height:var(--header-height, 52px);background:var(--bg-header, #fff);border-bottom:1px solid var(--border-header, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);flex-shrink:0}.app-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{font-weight:700;font-size:15px;letter-spacing:3px;color:var(--text-logo, #111)}.app-header[_ngcontent-%COMP%]   .controls[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px}.menu-wrap[_ngcontent-%COMP%]{position:relative}.menu-btn[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 6px);background:transparent;color:var(--text, #222);cursor:pointer;transition:background .15s,border-color .15s}.menu-btn[_ngcontent-%COMP%]:hover{background:var(--bg, #f5f5f5);border-color:var(--text-muted, #aaa)}.menu-btn.open[_ngcontent-%COMP%]{background:var(--text, #222);border-color:var(--text, #222);color:var(--bg, #fff)}.dropdown[_ngcontent-%COMP%]{position:absolute;top:calc(100% + 6px);right:0;min-width:130px;background:var(--bg-header, #fff);border:1px solid var(--border, #e0e0e0);border-radius:6px;box-shadow:0 4px 16px #0000001a;z-index:200;overflow:hidden}.option[_ngcontent-%COMP%]{display:block;width:100%;padding:8px 12px;font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:12px;text-align:left;background:transparent;border:none;color:var(--text, #222);cursor:pointer;transition:background .1s}.option[_ngcontent-%COMP%]:hover{background:var(--border, #f0f0f0)}.option.selected[_ngcontent-%COMP%]{font-weight:600;padding-left:10px;border-left:2px solid var(--text, #222)}'],changeDetection:0});let o=i;return o})();var He=(()=>{let i=class i{};i.\u0275fac=function(n){return new(n||i)},i.\u0275cmp=C({type:i,selectors:[["app-footer"]],decls:11,vars:0,consts:[[1,"app-footer"],["routerLink","/dmca"],[1,"sep"],["routerLink","/privacy"],["routerLink","/terms"]],template:function(n,a){n&1&&(u(0,"footer",0)(1,"a",1),h(2,"DMCA"),p(),u(3,"span",2),h(4,"\xB7"),p(),u(5,"a",3),h(6,"Privacy Policy"),p(),u(7,"span",2),h(8,"\xB7"),p(),u(9,"a",4),h(10,"Terms of Use"),p()())},dependencies:[De],styles:['.app-footer[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:10px;height:32px;background:var(--bg-footer, #f5f5f5);border-top:1px solid var(--border, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:11px;flex-shrink:0}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{color:var(--text-muted, #aaa);text-decoration:none;letter-spacing:.5px;transition:color .2s}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{color:var(--text)}.app-footer[_ngcontent-%COMP%]   .sep[_ngcontent-%COMP%]{color:var(--border, #ccc)}'],changeDetection:0});let o=i;return o})();var en=["audioPlayer"],nn=()=>[import("./chunk-HFKCG7NK.js").then(o=>o.VisualizerComponent)];function an(o,i){o&1&&(M(),u(0,"svg",3),v(1,"rect",15)(2,"rect",16),p())}function on(o,i){o&1&&(M(),u(0,"svg",3),v(1,"polygon",17),p())}function rn(o,i){o&1&&v(0,"app-visualizer")}function tn(o,i){if(o&1){let r=L();u(0,"div",1)(1,"button",2),N("click",function(){R(r);let n=d();return g(n.togglePlay())}),y(2,an,3,0,":svg:svg",3)(3,on,2,0,":svg:svg",3),p(),u(4,"button",4),N("click",function(){R(r);let n=d();return g(n.showVisualizer=!n.showVisualizer)}),M(),u(5,"svg",3),v(6,"rect",5)(7,"rect",6)(8,"rect",7)(9,"rect",8),p()(),B(),u(10,"div",9)(11,"div",10),h(12),p(),u(13,"div",11),de(14,rn,1,0),ce(15,14,nn),p(),u(17,"input",12),N("pointerdown",function(){R(r);let n=d();return g(n.isDragging=!0)})("pointerup",function(){R(r);let n=d();return g(n.isDragging=!1)})("pointercancel",function(){R(r);let n=d();return g(n.isDragging=!1)})("input",function(n){R(r);let a=d();return g(a.onSeek(n))}),p()(),u(18,"audio",13,0),N("timeupdate",function(){R(r);let n=d();return g(n.onTimeUpdate())})("loadedmetadata",function(){R(r);let n=d();return g(n.onMetadata())})("ended",function(){R(r);let n=d();return g(n.onAudioEnded())}),v(20,"source",14),p()()}if(o&2){let r=d();s(),I("aria-label",r.isPlaying?"Pause":"Play"),s(),A(r.isPlaying?2:3),s(2),x("active",r.showVisualizer),I("aria-label",r.showVisualizer?"Hide visualizer":"Show visualizer"),s(8),E(r.currentContent.title),s(),x("vis-open",r.showVisualizer),s(2),me(r.showVisualizer),s(2),W("--progress-pct",r.progressPercent+"%"),x("dragging",r.isDragging),$("value",r.progressPercent),s(3),$("src",r.currentContent.link)}}var Be=(()=>{let i=class i{set audioPlayerRef(e){this.audioElement=e?.nativeElement??null,this.audioElement&&this.audioAnalysis.connect(this.audioElement),this.syncAudio()}constructor(e){this.playerService=e,this.currentContent=null,this.progressPercent=0,this.duration=0,this.isPlaying=!1,this.isDragging=!1,this.showVisualizer=!1,this.audioElement=null,this.lastState=null,this.activeLink=null,this.audioAnalysis=k(Ce),this.playerService.getState().pipe(be()).subscribe(n=>{this.lastState=n,this.currentContent=n.content,this.isPlaying=n.isPlaying,this.syncAudio()})}togglePlay(){this.lastState&&(this.audioAnalysis.resume(),this.lastState.isPlaying?this.playerService.performAction("pause"):this.playerService.performAction("play",this.lastState.content??void 0))}onMetadata(){this.duration=this.audioElement?.duration??0,this.syncAudio()}onTimeUpdate(){if(!this.audioElement||!this.lastState)return;!this.isDragging&&this.audioElement.duration&&(this.progressPercent=this.audioElement.currentTime/this.audioElement.duration*100);let e=this.audioElement.currentTime;Math.abs(e-this.lastState.currentTime)>1&&this.playerService.performAction("seek",void 0,e)}onSeek(e){let n=+e.target.value,a=n/100*this.duration;this.progressPercent=n,this.playerService.performAction("seek",void 0,a),this.audioElement&&(this.audioElement.currentTime=a)}onAudioEnded(){this.playerService.performAction("stop")}syncAudio(){if(!this.audioElement||!this.lastState)return;let{content:e,currentTime:n,isPlaying:a}=this.lastState;if(!e){this.audioElement.pause(),this.activeLink&&(this.audioElement.removeAttribute("src"),this.audioElement.load(),this.activeLink=null);return}this.activeLink!==e.link&&(this.audioElement.src=e.link,this.audioElement.load(),this.activeLink=e.link),Math.abs(this.audioElement.currentTime-n)>1&&(this.audioElement.currentTime=n),a&&this.audioElement.paused?this.audioElement.play():!a&&!this.audioElement.paused&&this.audioElement.pause()}};i.\u0275fac=function(n){return new(n||i)(le(Q))},i.\u0275cmp=C({type:i,selectors:[["app-episode-player"]],viewQuery:function(n,a){if(n&1&&he(en,5),n&2){let t;pe(t=ke())&&(a.audioPlayerRef=t.first)}},decls:1,vars:1,consts:[["audioPlayer",""],[1,"floating-player"],[1,"play-btn",3,"click"],["viewBox","0 0 16 16","width","14","height","14","fill","currentColor","aria-hidden","true"],[1,"vis-btn",3,"click"],["x","1","y","8","width","3","height","7","rx","1"],["x","5","y","4","width","3","height","11","rx","1"],["x","9","y","6","width","3","height","9","rx","1"],["x","13","y","2","width","3","height","13","rx","1"],[1,"track-info"],[1,"track-title"],[1,"vis-wrapper"],["type","range","min","0","max","100","step","0.1","aria-label","Seek",1,"seek-bar",3,"pointerdown","pointerup","pointercancel","input","value"],["controls","","crossorigin","anonymous",2,"display","none",3,"timeupdate","loadedmetadata","ended"],["type","audio/mpeg",3,"src"],["x","2","y","1","width","5","height","14","rx","1"],["x","9","y","1","width","5","height","14","rx","1"],["points","3,1 15,8 3,15"]],template:function(n,a){n&1&&y(0,tn,21,15,"div",1),n&2&&A(a.currentContent?0:-1)},styles:['@charset "UTF-8";[_nghost-%COMP%]{pointer-events:none}.floating-player[_ngcontent-%COMP%]{pointer-events:auto;position:fixed;bottom:52px;left:20px;right:20px;z-index:100;display:flex;align-items:center;gap:12px;padding:12px 16px;background:var(--bg-player, #fff);border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 8px);box-shadow:var(--player-shadow, 0 2px 12px rgba(0, 0, 0, .1));font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);transition:background .3s ease,border-color .3s ease,box-shadow .3s ease}.play-btn[_ngcontent-%COMP%]{width:36px;height:36px;flex-shrink:0;border-radius:var(--player-radius, 50%);border:1px solid var(--border, transparent);background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:box-shadow .2s}.track-info[_ngcontent-%COMP%]{flex:1;min-width:0}.track-title[_ngcontent-%COMP%]{font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--text)}.seek-bar[_ngcontent-%COMP%]{-webkit-appearance:none;appearance:none;display:block;width:100%;height:3px;margin-top:8px;border-radius:2px;outline:none;cursor:pointer;background:linear-gradient(to right,var(--player-fill, #222) var(--progress-pct, 0%),var(--player-track, #e0e0e0) var(--progress-pct, 0%));touch-action:pan-x}.seek-bar[_ngcontent-%COMP%]::-webkit-slider-thumb{-webkit-appearance:none;width:0;height:0;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease,margin-top .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-webkit-slider-thumb, .seek-bar[_ngcontent-%COMP%]:active::-webkit-slider-thumb{width:18px;height:18px;margin-top:-7px}.seek-bar[_ngcontent-%COMP%]::-moz-range-thumb{width:0;height:0;border:none;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-moz-range-thumb, .seek-bar[_ngcontent-%COMP%]:active::-moz-range-thumb{width:18px;height:18px}body[data-theme=minimal-2d][data-mode=dark][_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=minimal-2d][data-mode=dark]   [_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_glow-pulse 1.4s ease-in-out infinite}@keyframes _ngcontent-%COMP%_glow-pulse{0%,to{box-shadow:none}50%{box-shadow:var(--glow, none)}}.vis-wrapper[_ngcontent-%COMP%]{overflow:hidden;max-height:0;opacity:0;transition:max-height .35s ease,opacity .25s ease}.vis-wrapper.vis-open[_ngcontent-%COMP%]{max-height:52px;opacity:1}.vis-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s}.vis-btn.active[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}']});let o=i;return o})();var Le=(()=>{let i=class i{constructor(){this._theme=k(K)}};i.\u0275fac=function(n){return new(n||i)},i.\u0275cmp=C({type:i,selectors:[["app-root"]],decls:6,vars:0,consts:[[1,"app-container"],[1,"app-content"]],template:function(n,a){n&1&&(u(0,"div",0),v(1,"app-header"),u(2,"main",1),v(3,"router-outlet"),p(),v(4,"app-episode-player")(5,"app-footer"),p())},dependencies:[Ae,Ee,He,Be],styles:[".app-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;height:100vh;max-height:-webkit-fill-available;background:var(--bg, #fff)}.app-content[_ngcontent-%COMP%]{flex:1;overflow-y:auto;padding-bottom:144px}"]});let o=i;return o})();ye(Le,T(P({},ee),{providers:[Se(),...ee.providers]})).catch(o=>console.error(o));
