import{a as ie,b as Pe,c as Te,d as we,e as Ee}from"./chunk-6FHZCKEO.js";import{a as ue,b as He}from"./chunk-2N2NV2X5.js";import{$a as l,Ba as B,Ea as ye,H as T,Ja as Ae,Ka as De,La as Y,M as g,Ma as y,Na as A,Oa as _,Pa as Z,Qa as de,R as p,Ra as c,S as k,Sa as m,T as S,Ta as D,U as J,Ua as h,Va as u,Wa as H,X as ee,Xa as C,Ya as fe,Za as v,_a as W,a as K,b as O,ba as b,ca as q,cb as be,d as E,da as Re,db as ce,eb as me,fb as Q,gb as w,ha as ge,hb as R,i as pe,ib as I,jb as V,kb as ne,l as ke,lb as ae,mb as X,oa as Me,qa as Se,qb as Ce,ra as s,rb as ve,xa as xe}from"./chunk-UDDB25VY.js";var oe=class{constructor(){this.content=null,this.isPlaying=!1,this.currentTime=0}};var re=(()=>{let o=class o{constructor(){this.persisted=null,this.lastSaveMs=0,this._completedIds=b(new Set),this.completedIds=this._completedIds.asReadonly(),this.persisted=this.loadFromStorage(),this._completedIds.set(new Set(this.persisted?.completed??[]));let e=this.persisted?{content:this.persisted.content,isPlaying:!1,currentTime:this.persisted.times[this.persisted.content.id]??0}:new oe;this.state=new pe(e)}performAction(e,n,a){let t=this.state.value;switch(e){case"play":if(n){let x=n.id===t.content?.id?t.currentTime:this.persisted?.times[n.id]??0;this.state.next({content:n,isPlaying:!0,currentTime:x}),this.persistContent(n)}break;case"pause":this.state.next(O(K({},t),{isPlaying:!1}));break;case"stop":if(this.state.next(O(K({},t),{isPlaying:!1,currentTime:0})),t.content&&this.persisted){let d=t.content.id;delete this.persisted.times[d],this.persisted.completed.includes(d)||(this.persisted.completed.push(d),this._completedIds.update(x=>new Set([...x,d]))),this.saveToStorage()}break;case"seek":typeof a=="number"&&(this.state.next(O(K({},t),{currentTime:a})),t.content&&this.throttledSaveTime(t.content.id,a));break}}getState(){return this.state.asObservable()}persistContent(e){this.persisted?this.persisted.content=e:this.persisted={content:e,times:{},completed:[]},this.saveToStorage()}throttledSaveTime(e,n){let a=Date.now();a-this.lastSaveMs<5e3||(this.lastSaveMs=a,this.persisted&&(this.persisted.times[e]=n,this.saveToStorage()))}loadFromStorage(){try{let e=localStorage.getItem("player-state");if(!e)return null;let n=JSON.parse(e);return!n.content?.id||!n.content?.link?null:{content:n.content,times:n.times??{},completed:n.completed??[]}}catch(e){return null}}saveToStorage(){try{localStorage.setItem("player-state",JSON.stringify(this.persisted))}catch(e){}}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();var Be=[{episodio:"B",titulo:"Resident #stayhome #quedateencasa special - Sunsetstrip Home Edition 4/4/2020",likes:"48",descargas:"51.2K",fecha:"2020-04-04",descripcion:`Full Sunsetstrip Home Edition 5 hr set, recorded on 4/4/2020
...
Elke Kleijn - Eenvoud (Navar Remix)`}];var Le=(()=>{let o=class o{fetchEpisodes(){let e=Be,n=e.map(M=>this.parseIntegerField(M.likes)),a=e.map(M=>this.parseDescargas(M.descargas)),t=e.map(M=>this.parseDateField(M.fecha)),d=e.map(M=>this.parseDateField(M.fechasubida)),x=e.map(M=>this.parseIntegerField(M.episodio)),P=this.createColorScale(this.getMinValue(n),this.getMaxValue(n)),F=this.createColorScale(this.getMinValue(a),this.getMaxValue(a)),f=this.createColorScale(this.getMinValue(t),this.getMaxValue(t)),z=this.createColorScale(this.getMinValue(d),this.getMaxValue(d)),G=this.createColorScale(this.getMinValue(x),this.getMaxValue(x));return ke(e.map(M=>this.convertToEpisodeSort(M,P,F,f,z,G)))}convertToEpisodeSort(e,n,a,t,d,x){let P=this.parseIntegerField(e.likes),F=this.parseDescargas(e.descargas),f=this.parseDateField(e.fecha),z=this.parseDateField(e.fechasubida),G=this.parseIntegerField(e.episodio),M=e.tracklist??e.descripcion??"";return O(K({},e),{tracklist:M,_fechasubida:this.createExtendedField(e.fechasubida??"",z,this.resolveColor(d,z)),_fecha:this.createExtendedField(e.fecha??"",f,this.resolveColor(t,f)),_descargas:this.createExtendedField(e.descargas??"",F,this.resolveColor(a,F)),_likes:this.createExtendedField(e.likes??"",P,this.resolveColor(n,P)),_episodio:this.createExtendedField(e.episodio??"",G,this.resolveColor(x,G))})}createExtendedField(e,n=null,a="grey"){return{value:e??"",number:n,color:a}}parseDescargas(e){if(typeof e!="string")return null;let n=e.trim();if(!n)return null;let a=n.toLowerCase().endsWith("k")?1e3:1,t=parseFloat(n);return Number.isFinite(t)?t*a:null}parseIntegerField(e){if(typeof e!="string")return null;let n=parseInt(e,10);return Number.isFinite(n)?n:null}parseDateField(e){if(typeof e!="string")return null;let n=new Date(e).getTime();return Number.isFinite(n)?n:null}getMinValue(e){let n=null;for(let a of e)typeof a=="number"&&Number.isFinite(a)&&(n===null||a<n)&&(n=a);return n}getMaxValue(e){let n=null;for(let a of e)typeof a=="number"&&Number.isFinite(a)&&(n===null||a>n)&&(n=a);return n}createColorScale(e,n){if(e===null||n===null)return null;let a=n-e;return t=>{let d=a>0?(t-e)/a:0,x=Math.round(255*d),P=Math.round(128*(1-d));return`rgb(${x},${P},0)`}}resolveColor(e,n){return!e||n===null?"grey":e(n)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();var te=(()=>{let o=class o{constructor(){this.options=b([{value:"_likes",label:"Likes"},{value:"_descargas",label:"Descargas"},{value:"_fecha",label:"Fecha"},{value:"_episodio",label:"Episodio"}]),this.selectedField=b("_likes")}setField(e){this.selectedField.set(e)}addOption(e){this.options().find(n=>n.value===e.value)||this.options.update(n=>[...n,e])}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();function Ze(i){try{return localStorage.getItem(i)}catch(o){return null}}function Qe(i,o){try{localStorage.setItem(i,o)}catch(r){}}var U=(()=>{let o=class o{constructor(){this.presets=[{label:"Default",style:"default",mode:"system"},{label:"Minimal 2D",style:"minimal-2d",mode:"system"}],this._activePreset=b(this.loadInitialPreset()),this.activePreset=this._activePreset.asReadonly(),this._resolvedMode=b("light"),this.resolvedMode=this._resolvedMode.asReadonly(),this._mediaQuery=null,this._mediaListener=null,this.destroyRef=g(ee),this.updateResolvedMode(this._activePreset().mode),this.applyPreset(),q(()=>{this._activePreset(),this.initSystemListener()}),q(()=>{let e=this._resolvedMode();document?.body&&document.body.setAttribute("data-mode",e)}),this.destroyRef.onDestroy(()=>{this.removeMediaListener()})}setPreset(e){this._activePreset.set(e),this.applyPreset(),Qe("theme-preset",JSON.stringify({style:e.style,mode:e.mode}))}loadInitialPreset(){let e=this.presets.find(n=>n.style==="default");try{let n=Ze("theme-preset");if(!n)return e;let a=JSON.parse(n);return this.presets.find(d=>d.style===a.style&&d.mode===a.mode)??e}catch(n){return e}}updateResolvedMode(e){if(e==="system"){let n=typeof window<"u"?window.matchMedia("(prefers-color-scheme: dark)").matches:!1;this._resolvedMode.set(n?"dark":"light")}else this._resolvedMode.set(e)}applyPreset(){let e=this._activePreset();if(this.updateResolvedMode(e.mode),!document?.body)return;document.body.setAttribute("data-theme",e.style);let n=`/assets/themes/theme-${e.style}.css`,a=document.getElementById("theme-css");a?a.href=n:(a=document.createElement("link"),a.id="theme-css",a.rel="stylesheet",a.href=n,document.head.appendChild(a))}initSystemListener(){let e=this._activePreset();this.removeMediaListener(),e.mode==="system"&&typeof window<"u"&&(this._mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this._mediaListener=()=>{this._resolvedMode.set(this._mediaQuery.matches?"dark":"light")},this._mediaQuery.addEventListener("change",this._mediaListener))}removeMediaListener(){this._mediaQuery&&this._mediaListener&&(this._mediaQuery.removeEventListener("change",this._mediaListener),this._mediaListener=null,this._mediaQuery=null)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();var Xe="cattaneo-episodes",N="blobs";var $=null;function se(){return $||($=new Promise((i,o)=>{let r=indexedDB.open(Xe,1);r.onerror=()=>{$=null,o(r.error)},r.onsuccess=()=>{i(r.result)},r.onupgradeneeded=e=>{let n=e.target.result;n.objectStoreNames.contains(N)||n.createObjectStore(N,{keyPath:"id"})}}),$)}function Ne(i){return E(this,null,function*(){let o=yield se();return new Promise((r,e)=>{let t=o.transaction([N],"readonly").objectStore(N).get(i);t.onsuccess=()=>r(t.result),t.onerror=()=>e(t.error)})})}function Fe(i){return E(this,null,function*(){let o=yield se();return new Promise((r,e)=>{let t=o.transaction([N],"readwrite").objectStore(N).put(i);t.onsuccess=()=>r(),t.onerror=()=>e(t.error)})})}function Ge(i){return E(this,null,function*(){let o=yield se();return new Promise((r,e)=>{let t=o.transaction([N],"readwrite").objectStore(N).delete(i);t.onsuccess=()=>r(),t.onerror=()=>e(t.error)})})}function Ke(){return E(this,null,function*(){let i=yield se();return new Promise((o,r)=>{let a=i.transaction([N],"readonly").objectStore(N).getAllKeys();a.onsuccess=()=>o(a.result??[]),a.onerror=()=>r(a.error)})})}var le=(()=>{let o=class o{constructor(){this.downloaded=b(new Map),this.progress=b(new Map),this.activeDownloads=new Map,this.loadFromIdb()}startDownload(e){return E(this,null,function*(){if(this.activeDownloads.has(e.id))return;let n=new AbortController;this.activeDownloads.set(e.id,n);try{let a=yield fetch(e.link,{signal:n.signal,mode:"cors"});if(!a.ok)throw new Error(`HTTP ${a.status}`);let t=a.headers.get("content-length"),d=t?parseInt(t,10):null,x=a.body?.getReader();if(!x)throw new Error("No response body");let P=[],F=0;for(;;){let{done:M,value:j}=yield x.read();if(M)break;if(P.push(j),F+=j.byteLength,d){let je=Math.round(F/d*100);this.progress.update(qe=>new Map(qe).set(e.id,je))}}let f=new Blob(P,{type:"audio/mpeg"}),z=URL.createObjectURL(f),G={id:e.id,blobUrl:z,title:e.title,sizeBytes:f.size,storedAt:Date.now()};yield Fe({id:e.id,blob:f,title:e.title,storedAt:Date.now()}),this.downloaded.update(M=>new Map(M).set(e.id,G)),this.progress.update(M=>{let j=new Map(M);return j.delete(e.id),j})}catch(a){a instanceof Error&&a.name==="AbortError"||console.error("Download failed:",a),this.progress.update(t=>{let d=new Map(t);return d.delete(e.id),d})}finally{this.activeDownloads.delete(e.id)}})}cancelDownload(e){let n=this.activeDownloads.get(e);n&&n.abort()}deleteDownload(e){return E(this,null,function*(){let n=this.downloaded().get(e);n&&URL.revokeObjectURL(n.blobUrl),yield Ge(e),this.downloaded.update(a=>{let t=new Map(a);return t.delete(e),t})})}getBlobUrl(e){return this.downloaded().get(e)?.blobUrl??null}loadFromIdb(){return E(this,null,function*(){try{let e=yield Ke(),n=new Map;for(let a of e){let t=yield Ne(a);if(t){let d=URL.createObjectURL(t.blob);n.set(a,{id:a,blobUrl:d,title:t.title,sizeBytes:t.blob.size,storedAt:t.storedAt})}}this.downloaded.set(n)}catch(e){console.warn("Failed to load downloads from IDB:",e)}})}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();var en=(i,o)=>o.episodio;function nn(i,o){i&1&&(S(),h(0,"svg",6),H(1,"path",8),u())}function an(i,o){i&1&&(S(),h(0,"svg",6),H(1,"path",9),u())}function on(i,o){i&1&&(S(),h(0,"svg",7),H(1,"rect",10)(2,"path",11),u())}function rn(i,o){i&1&&(S(),h(0,"svg",7),H(1,"rect",10)(2,"path",11),u())}function tn(i,o){if(i&1&&(h(0,"div",4),y(1,nn,2,0,":svg:svg",6)(2,an,2,0,":svg:svg",6)(3,on,3,0,":svg:svg",7)(4,rn,3,0,":svg:svg",7),R(5),u()),i&2){let r;l();let e=X(3),n=l();s(),A((r=n.sort.selectedField())==="_likes"?1:r==="_descargas"?2:r==="_fecha"?3:r==="_fechasubida"?4:-1),s(4),V(" ",e," ")}}function sn(i,o){if(i&1&&(h(0,"span",18),R(1),u()),i&2){let r=l(2).$implicit,e=l();s(),V("",e.trackCount(r.tracklist)," tracks")}}function ln(i,o){if(i&1&&(h(0,"div",12,0)(2,"div",13),R(3),u(),h(4,"div",14)(5,"span",15),S(),h(6,"svg",16),H(7,"path",8),u(),R(8),u(),J(),h(9,"span",17),S(),h(10,"svg",16),H(11,"path",9),u(),R(12),u(),y(13,sn,2,1,"span",18),u(),J(),H(14,"div",19),u()),i&2){let r,e=l().$implicit,n=l();Q("background-color",((r=e[n.sort.selectedField()])==null?null:r.color)??"grey"),s(3),I(e.titulo),s(5),V(" ",e.likes," "),s(4),V(" ",e.descargas," "),s(),A(n.trackCount(e.tracklist)>0?13:-1),s(),fe("innerHTML",n.tracklistWithBreaks(e.tracklist),Me)}}function dn(i,o){if(i&1){let r=C();h(0,"div",2),W("click",function(){let n=p(r).$index,a=l();return k(a.onEpisodeClick(n))}),h(1,"div",3),R(2),u(),ne(3),y(4,tn,6,2,"div",4),u(),y(5,ln,15,7,"div",5)}if(i&2){let r,e=o.$implicit,n=o.$index,a=l();Q("background-color",((r=e[a.sort.selectedField()])==null?null:r.color)??"grey")("animation-delay",a.animatingSort?a.Math.min(n,20)*70+"ms":"0ms"),w("completed",a.playerService.completedIds().has(e.episodio??""))("downloaded",a.downloadService.downloaded().has(e.episodio??"")),Y("data-episode-id",e.link),s(2),I(e.episodio),s();let t=ae(a.tileSubLabel(e,a.sort.selectedField()));s(),A(t?4:-1),s(),A(a.selectedIndex===n?5:-1)}}var Oe=(()=>{let o=class o{constructor(){this.selectedIndex=null,this.episodes=[],this.animatingSort=!1,this.Math=Math,this.playerService=g(re),this.downloadService=g(le),this.episodesService=g(Le),this.cdr=g(ve),this.sort=g(te),this.theme=g(U),q(()=>{let e=this.sort.selectedField();if(this.episodes.length){let n=this.selectedIndex!==null?this.episodes[this.selectedIndex]?.link??null:null;Re(()=>this.triggerSortAnimation()),this.sortEpisodes(e),this.selectedIndex=n!==null?this.episodes.findIndex(a=>a.link===n):null,this.selectedIndex===-1&&(this.selectedIndex=null),this.cdr.markForCheck()}})}ngOnInit(){this.episodesService.fetchEpisodes().subscribe({next:e=>{this.episodes=e,e.some(n=>!!n.fechasubida)&&this.sort.addOption({value:"_fechasubida",label:"Fecha subida"}),this.sortEpisodes(this.sort.selectedField()),this.cdr.markForCheck()},error:e=>console.error("Error fetching episodes:",e)})}triggerSortAnimation(){this.theme.activePreset().style==="minimal-2d"&&(this.animatingSort=!0,setTimeout(()=>{this.animatingSort=!1,this.cdr.markForCheck()},800))}onEpisodeClick(e){this.selectedIndex=this.selectedIndex===e?null:e;let n=this.episodes[e];this.playContent({title:n.titulo,link:n.link??"",id:n.episodio??""}),this.selectedIndex!==null&&setTimeout(()=>document.querySelector(".episode-detail-row")?.scrollIntoView({behavior:"smooth",block:"center"}))}playContent(e){this.playerService.performAction("play",e)}tracklistWithBreaks(e){return e?e.replace(/\n/g,"<br>"):""}trackCount(e){return e?e.split(`
`).filter(n=>n.trim()).length:0}sortEpisodes(e){this.episodes.length&&(this.episodes=[...this.episodes].sort((n,a)=>{let t=this.getSortableValue(n,e),d=this.getSortableValue(a,e);return t===null&&d===null?0:t===null?1:d===null?-1:d-t}))}tileSubLabel(e,n){if(n==="_episodio")return null;let a=e[n];if(!a?.value)return null;if(n==="_fecha"||n==="_fechasubida"){let t=new Date(a.value);return isNaN(t.getTime())?a.value:t.toLocaleDateString("en-US",{month:"short",year:"2-digit"})}return a.value}getSortableValue(e,n){let a=e[n];if(!a)return null;if(typeof a.number=="number"&&Number.isFinite(a.number))return a.number;let t=parseFloat(a.value??"");return Number.isFinite(t)?t:null}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=B({type:o,selectors:[["app-episodes-grid"]],decls:3,vars:2,consts:[["detailRow",""],[1,"episode-grid"],[1,"episode-item",3,"click"],[1,"episodio"],[1,"field-value"],[1,"episode-detail-row",3,"background-color"],["viewBox","0 0 16 16","width","8","height","8","fill","currentColor","aria-hidden","true"],["viewBox","0 0 16 16","width","8","height","8","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M8 14s-6-3.9-6-8a4 4 0 0 1 6-3.46A4 4 0 0 1 14 6c0 4.1-6 8-6 8z"],["d","M8 12L2 6h4V1h4v5h4L8 12z"],["x","1.5","y","2.5","width","13","height","12","rx","1.5"],["d","M1.5 6.5h13M5 1v3M11 1v3"],[1,"episode-detail-row"],[1,"titulo"],[1,"meta"],[1,"likes"],["viewBox","0 0 16 16","width","11","height","11","fill","currentColor","aria-hidden","true",2,"vertical-align","-1px"],[1,"descargas"],[1,"track-count"],[1,"tracklist",3,"innerHTML"]],template:function(n,a){n&1&&(h(0,"div",1),_(1,dn,6,13,null,null,en),u()),n&2&&(w("sorting",a.animatingSort),s(),Z(a.episodes))},dependencies:[ie],styles:['@charset "UTF-8";.episode-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{display:grid;padding:0;width:auto;position:relative;z-index:1;cursor:pointer;height:85px;align-content:center;transition:all .3s ease;content-visibility:auto;contain-intrinsic-size:120px 85px}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .episodio[_ngcontent-%COMP%]{text-align:center;text-shadow:0 1px 2px rgba(0,0,0,.25)}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .field-value[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:3px;font-size:10px;opacity:.65;margin-top:3px;text-shadow:0 1px 2px rgba(0,0,0,.25);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding:0 4px}.episode-grid[_ngcontent-%COMP%]   .episode-item.completed[_ngcontent-%COMP%]:after{content:"";position:absolute;top:0;right:0;width:14px;height:14px;background:#fff9;clip-path:polygon(0 0,100% 0,100% 100%)}.episode-grid[_ngcontent-%COMP%]   .episode-item.downloaded[_ngcontent-%COMP%]:before{content:"\\2193";position:absolute;top:2px;left:2px;width:12px;height:12px;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;background:#ffffffb3;border-radius:2px;color:#333}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%]{border:1px solid var(--border, transparent);opacity:0;animation:_ngcontent-%COMP%_tile-in .5s steps(2) forwards;font-family:var(--font-ui)}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_tile-sort .6s steps(2) forwards}@keyframes _ngcontent-%COMP%_tile-in{0%{opacity:0;transform:scaleX(1.06)}40%{opacity:1;transform:scaleX(.97) translate(1px)}70%{opacity:.7;transform:scaleX(1.02)}to{opacity:1;transform:none}}@keyframes _ngcontent-%COMP%_tile-sort{0%{opacity:1;filter:blur(0)}20%{opacity:.3;filter:blur(1px);transform:scaleX(1.04)}50%{opacity:.8;filter:blur(0);transform:scaleX(.98)}to{opacity:1;transform:none}}.episode-detail-row[_ngcontent-%COMP%]{grid-column:1/-1;transition:all .3s ease;padding:40px 30px;word-break:break-word;overflow-wrap:break-word;min-width:0}.episode-detail-row[_ngcontent-%COMP%]   .titulo[_ngcontent-%COMP%]{font-size:2em;font-weight:600;margin-bottom:8px}.episode-detail-row[_ngcontent-%COMP%]   .meta[_ngcontent-%COMP%]{display:flex;gap:16px;font-size:13px;opacity:.75;margin-bottom:16px}.episode-detail-row[_ngcontent-%COMP%]   .tracklist[_ngcontent-%COMP%]{max-height:300px;overflow-y:auto;font-size:13px;line-height:1.7;font-family:var(--font-ui, "Libre Franklin", sans-serif)}body[data-theme=minimal-2d][_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%]{font-family:var(--font-ui);font-size:12px;color:var(--text);border-left:2px solid var(--accent, #333);padding-left:12px}'],changeDetection:0});let i=o;return i})();var Ie=[{path:"",component:Oe},{path:"dmca",loadComponent:()=>import("./chunk-3YSTDGJ2.js").then(i=>i.DmcaPageComponent)},{path:"privacy",loadComponent:()=>import("./chunk-FWF53HWC.js").then(i=>i.PrivacyPageComponent)},{path:"terms",loadComponent:()=>import("./chunk-LCSB3KAZ.js").then(i=>i.TermsPageComponent)},{path:"**",redirectTo:""}];var he={providers:[Ee(Ie)]};var cn=(i,o)=>o.label,mn=(i,o)=>o.value;function un(i,o){if(i&1){let r=C();h(0,"button",16),W("click",function(){let n=p(r).$index,a=l(2);return k(a.selectTheme(n))}),R(1),u()}if(i&2){let r=o.$implicit,e=l(2);w("selected",e.theme.activePreset()===r),s(),I(r.label)}}function hn(i,o){if(i&1&&(h(0,"div",10),_(1,un,2,3,"button",15,cn),u()),i&2){let r=l();s(),Z(r.theme.presets)}}function pn(i,o){if(i&1){let r=C();h(0,"button",16),W("click",function(){let n=p(r).$implicit,a=l(2);return k(a.selectSort(n.value))}),R(1),u()}if(i&2){let r=o.$implicit,e=l(2);w("selected",e.sort.selectedField()===r.value),s(),I(r.label)}}function kn(i,o){if(i&1&&(h(0,"div",10),_(1,pn,2,3,"button",15,mn),u()),i&2){let r=l();s(),Z(r.sort.options())}}var ze=(()=>{let o=class o{constructor(){this.theme=g(U),this.sort=g(te),this.elRef=g(ge),this.openMenu=b(null)}onDocumentClick(e){this.elRef.nativeElement.contains(e.target)||this.openMenu.set(null)}toggleMenu(e,n){n.stopPropagation(),this.openMenu.update(a=>a===e?null:e)}selectTheme(e){this.theme.setPreset(this.theme.presets[e]),this.openMenu.set(null)}selectSort(e){this.sort.setField(e),this.openMenu.set(null)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=B({type:o,selectors:[["app-header"]],hostBindings:function(n,a){n&1&&v("click",function(d){return a.onDocumentClick(d)},Se)},decls:18,vars:6,consts:[[1,"app-header"],[1,"logo"],[1,"controls"],[1,"menu-wrap"],["aria-label","Theme",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","aria-hidden","true"],["x","1.5","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor"],["x","9","y","1.5","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.55"],["x","1.5","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.3"],["x","9","y","9","width","5.5","height","5.5","rx","1.2","fill","currentColor","opacity","0.15"],[1,"dropdown"],["aria-label","Sort by",1,"menu-btn",3,"click"],["viewBox","0 0 16 16","width","15","height","15","fill","none","stroke","currentColor","stroke-width","1.5","stroke-linecap","round","aria-hidden","true"],["d","M2 4h8M2 8h5M2 12h3"],["d","M12 3v10M10 11l2 2 2-2"],[1,"option",3,"selected"],[1,"option",3,"click"]],template:function(n,a){n&1&&(h(0,"header",0)(1,"span",1),R(2,"CATTANEO"),u(),h(3,"div",2)(4,"div",3)(5,"button",4),W("click",function(d){return a.toggleMenu("theme",d)}),S(),h(6,"svg",5),H(7,"rect",6)(8,"rect",7)(9,"rect",8)(10,"rect",9),u()(),y(11,hn,3,0,"div",10),u(),J(),h(12,"div",3)(13,"button",11),W("click",function(d){return a.toggleMenu("sort",d)}),S(),h(14,"svg",12),H(15,"path",13)(16,"path",14),u()(),y(17,kn,3,0,"div",10),u()()()),n&2&&(s(5),w("open",a.openMenu()==="theme"),s(6),A(a.openMenu()==="theme"?11:-1),s(2),w("open",a.openMenu()==="sort"),s(4),A(a.openMenu()==="sort"?17:-1))},dependencies:[ie],styles:['@charset "UTF-8";.app-header[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;padding:0 20px;height:var(--header-height, 52px);background:var(--bg-header, #fff);border-bottom:1px solid var(--border-header, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);flex-shrink:0}.app-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{font-weight:700;font-size:15px;letter-spacing:3px;color:var(--text-logo, #111)}.app-header[_ngcontent-%COMP%]   .controls[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px}.menu-wrap[_ngcontent-%COMP%]{position:relative}.menu-btn[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 6px);background:transparent;color:var(--text, #222);cursor:pointer;transition:background .15s,border-color .15s}.menu-btn[_ngcontent-%COMP%]:hover{background:var(--bg, #f5f5f5);border-color:var(--text-muted, #aaa)}.menu-btn.open[_ngcontent-%COMP%]{background:var(--text, #222);border-color:var(--text, #222);color:var(--bg, #fff)}.dropdown[_ngcontent-%COMP%]{position:absolute;top:calc(100% + 6px);right:0;min-width:130px;background:var(--bg-header, #fff);border:1px solid var(--border, #e0e0e0);border-radius:6px;box-shadow:0 4px 16px #0000001a;z-index:200;overflow:hidden}.option[_ngcontent-%COMP%]{display:block;width:100%;padding:8px 12px;font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:12px;text-align:left;background:transparent;border:none;color:var(--text, #222);cursor:pointer;transition:background .1s}.option[_ngcontent-%COMP%]:hover{background:var(--border, #f0f0f0)}.option.selected[_ngcontent-%COMP%]{font-weight:600;padding-left:10px;border-left:2px solid var(--text, #222)}'],changeDetection:0});let i=o;return i})();var Je=(()=>{let o=class o{};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=B({type:o,selectors:[["app-footer"]],decls:11,vars:0,consts:[[1,"app-footer"],["routerLink","/dmca"],[1,"sep"],["routerLink","/privacy"],["routerLink","/terms"]],template:function(n,a){n&1&&(c(0,"footer",0)(1,"a",1),R(2,"DMCA"),m(),c(3,"span",2),R(4,"\xB7"),m(),c(5,"a",3),R(6,"Privacy Policy"),m(),c(7,"span",2),R(8,"\xB7"),m(),c(9,"a",4),R(10,"Terms of Use"),m()())},dependencies:[we],styles:['.app-footer[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:10px;height:32px;background:var(--bg-footer, #f5f5f5);border-top:1px solid var(--border, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:11px;flex-shrink:0}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{color:var(--text-muted, #aaa);text-decoration:none;letter-spacing:.5px;transition:color .2s}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{color:var(--text)}.app-footer[_ngcontent-%COMP%]   .sep[_ngcontent-%COMP%]{color:var(--border, #ccc)}'],changeDetection:0});let i=o;return i})();var We=(()=>{let o=class o{constructor(){this.isSupported=typeof navigator<"u"&&"mediaSession"in navigator}setMetadata(e){this.isSupported&&(navigator.mediaSession.metadata=new MediaMetadata({title:e.title,artist:"Hern\xE1n Cattaneo",artwork:[{src:"assets/icons/favicon_io/android-chrome-192x192.png",sizes:"192x192",type:"image/png"},{src:"assets/icons/favicon_io/android-chrome-512x512.png",sizes:"512x512",type:"image/png"}]}))}setPlaybackState(e){this.isSupported&&(navigator.mediaSession.playbackState=e)}setPositionState(e,n){if(this.isSupported&&!(!Number.isFinite(e)||!Number.isFinite(n)))try{navigator.mediaSession.setPositionState({duration:e,playbackRate:1,position:n})}catch(a){console.debug("setPositionState error:",a)}}registerHandlers(e){this.isSupported&&(navigator.mediaSession.setActionHandler("play",e.play),navigator.mediaSession.setActionHandler("pause",e.pause),navigator.mediaSession.setActionHandler("seekbackward",()=>e.seekbackward()),navigator.mediaSession.setActionHandler("seekforward",()=>e.seekforward()),navigator.mediaSession.setActionHandler("seekto",n=>{typeof n.seekTime=="number"&&e.seek(n.seekTime)}))}};o.\u0275fac=function(n){return new(n||o)},o.\u0275prov=T({token:o,factory:o.\u0275fac,providedIn:"root"});let i=o;return i})();var Rn=["audioPlayer"],gn=["pipVideo"],Mn=()=>[import("./chunk-DVXD6NFT.js").then(i=>i.VisualizerComponent)];function Sn(i,o){i&1&&(S(),c(0,"svg",4),D(1,"rect",18)(2,"rect",19),m())}function xn(i,o){i&1&&(S(),c(0,"svg",4),D(1,"polygon",20),m())}function yn(i,o){if(i&1){let r=C();c(0,"button",21),v("click",function(){p(r);let n=l(2);return k(n.togglePip())}),S(),c(1,"svg",4),D(2,"rect",22)(3,"rect",23),m()()}}function An(i,o){if(i&1){let r=C();c(0,"button",32),v("click",function(){p(r);let n=l(4);return k(n.confirmDelete())}),R(1," \u2715 Remove "),m()}}function Dn(i,o){if(i&1){let r=C();c(0,"button",33),v("click",function(){p(r);let n=l(4);return k(n.isConfirmingDelete=!0)}),R(1," Remove "),m()}}function fn(i,o){if(i&1){let r=C();c(0,"div",27),v("mouseleave",function(){p(r);let n=l(3);return k(n.isConfirmingDelete=!1)}),c(1,"button",28),S(),c(2,"svg",4),D(3,"path",29),m()(),y(4,An,2,0,"button",30)(5,Dn,2,0,"button",31),m()}if(i&2){let r=l(3);s(4),A(r.isConfirmingDelete?4:5)}}function bn(i,o){if(i&1&&(c(0,"span",35),R(1),m()),i&2){l(2);let r=X(0);s(),V("",r,"%")}}function Cn(i,o){i&1&&(S(),c(0,"svg",36),D(1,"circle",37),m())}function vn(i,o){if(i&1){let r=C();c(0,"button",34),v("click",function(){p(r);let n=l(3);return k(n.cancelDownload())}),y(1,bn,2,1,"span",35)(2,Cn,2,0,":svg:svg",36),m()}if(i&2){l();let r=X(0);s(),A(r>=0?1:2)}}function Pn(i,o){if(i&1){let r=C();c(0,"button",38),v("click",function(){p(r);let n=l(3);return k(n.startDownload())}),S(),c(1,"svg",4),D(2,"path",39),m()()}}function Tn(i,o){if(i&1&&(ne(0),y(1,fn,6,1,"div",24)(2,vn,3,1,"button",25)(3,Pn,3,0,"button",26)),i&2){let r,e=l(2),n=ae(e.downloadService.progress().get(e.currentContent.id)),a=e.downloadService.downloaded().has(e.currentContent.id);s(),A((r=!0)===a?1:r===(typeof n=="number")?2:3)}}function wn(i,o){i&1&&D(0,"app-visualizer")}function En(i,o){if(i&1){let r=C();c(0,"div",2)(1,"button",3),v("click",function(){p(r);let n=l();return k(n.togglePlay())}),y(2,Sn,3,0,":svg:svg",4)(3,xn,2,0,":svg:svg",4),m(),c(4,"button",5),v("click",function(){p(r);let n=l();return k(n.showVisualizer=!n.showVisualizer)}),S(),c(5,"svg",4),D(6,"rect",6)(7,"rect",7)(8,"rect",8)(9,"rect",9),m()(),y(10,yn,4,0,"button",10),y(11,Tn,4,2),J(),c(12,"div",11)(13,"div",12),R(14),m(),c(15,"div",13),ye(16,wn,1,0),Ae(17,16,Mn),m(),c(19,"input",14),v("pointerdown",function(){p(r);let n=l();return k(n.isDragging=!0)})("pointerup",function(){p(r);let n=l();return k(n.isDragging=!1)})("pointercancel",function(){p(r);let n=l();return k(n.isDragging=!1)})("input",function(n){p(r);let a=l();return k(a.onSeek(n))}),m()(),c(20,"audio",15,0),v("timeupdate",function(){p(r);let n=l();return k(n.onTimeUpdate())})("loadedmetadata",function(){p(r);let n=l();return k(n.onMetadata())})("ended",function(){p(r);let n=l();return k(n.onAudioEnded())})("playing",function(){p(r);let n=l();return k(n.onAudioPlaying())}),D(22,"source",16),m(),D(23,"video",17,1),m()}if(i&2){let r=l();s(),Y("aria-label",r.isPlaying?"Pause":"Play"),s(),A(r.isPlaying?2:3),s(2),w("active",r.showVisualizer),Y("aria-label",r.showVisualizer?"Hide visualizer":"Show visualizer"),s(6),A(r.pipSupported?10:-1),s(),A(r.currentContent?11:-1),s(3),I(r.currentContent.title),s(),w("vis-open",r.showVisualizer),s(2),De(r.showVisualizer),s(2),Q("--progress-pct",r.progressPercent+"%"),w("dragging",r.isDragging),de("value",r.progressPercent),s(3),de("src",r.currentContent.link)}}var Ve=(()=>{let o=class o{set audioPlayerRef(e){this.audioElement=e?.nativeElement??null,this.audioElement&&this.audioAnalysis.connect(this.audioElement),this.syncAudio()}set pipVideoRef(e){e?.nativeElement&&!this._pipCanvas&&(this._pipVideo=e.nativeElement,this._initPip())}constructor(e){this.playerService=e,this.currentContent=null,this.progressPercent=0,this.duration=0,this.isPlaying=!1,this.isDragging=!1,this.showVisualizer=!1,this.isConfirmingDelete=!1,this.audioElement=null,this.lastState=null,this.activeLink=null,this.lastReportedPosition=0,this.audioAnalysis=g(He),this.mediaSessionService=g(We),this.downloadService=g(le),this._destroyRef=g(ee),this._pipCanvas=null,this._pipCtx=null,this._pipVideo=null,this._pipFreqData=new Uint8Array(128),this.pipSupported=typeof document<"u"&&!!document.pictureInPictureEnabled,typeof document<"u"&&document.addEventListener("pointerdown",()=>this.audioAnalysis.resume(),{once:!0}),typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.hidden?this.isPlaying&&this._pipVideo&&this.pipSupported&&this._pipVideo.requestPictureInPicture?.().catch(()=>{}):(this.audioAnalysis.resume(),this.audioElement?.paused&&this.lastState?.isPlaying&&this.audioElement.play())}),this.mediaSessionService.registerHandlers({play:()=>{this.lastState?.content&&this.playerService.performAction("play",this.lastState.content)},pause:()=>this.playerService.performAction("pause"),seekbackward:()=>{if(!this.audioElement)return;let n=Math.max(0,this.audioElement.currentTime-15);this.playerService.performAction("seek",void 0,n),this.audioElement&&(this.audioElement.currentTime=n)},seekforward:()=>{if(!this.audioElement)return;let n=Math.min(this.duration,this.audioElement.currentTime+15);this.playerService.performAction("seek",void 0,n),this.audioElement&&(this.audioElement.currentTime=n)},seek:n=>{let a=Math.max(0,Math.min(this.duration,n));this.playerService.performAction("seek",void 0,a),this.audioElement&&(this.audioElement.currentTime=a)}}),this.playerService.getState().pipe(ue()).subscribe(n=>{this.lastState=n,this.currentContent=n.content,this.isPlaying=n.isPlaying,n.content&&(this.mediaSessionService.setMetadata(n.content),n.isPlaying||this.mediaSessionService.setPlaybackState("paused")),this.syncAudio()})}togglePlay(){this.lastState&&(this.audioAnalysis.resume(),this.lastState.isPlaying?this.playerService.performAction("pause"):(this.playerService.performAction("play",this.lastState.content??void 0),this._pipVideo?.play()))}onMetadata(){this.duration=this.audioElement?.duration??0,this.mediaSessionService.setPositionState(this.duration,this.audioElement?.currentTime??0),this.syncAudio()}onTimeUpdate(){if(!this.audioElement||!this.lastState)return;!this.isDragging&&this.audioElement.duration&&(this.progressPercent=this.audioElement.currentTime/this.audioElement.duration*100);let e=this.audioElement.currentTime;Math.abs(e-this.lastState.currentTime)>1&&this.playerService.performAction("seek",void 0,e),Math.abs(e-this.lastReportedPosition)>2&&(this.mediaSessionService.setPositionState(this.duration,e),this.lastReportedPosition=e)}onSeek(e){let n=+e.target.value,a=n/100*this.duration;this.progressPercent=n,this.playerService.performAction("seek",void 0,a),this.audioElement&&(this.audioElement.currentTime=a)}onAudioEnded(){this.playerService.performAction("stop")}onAudioPlaying(){this.mediaSessionService.setPlaybackState("playing"),this.audioAnalysis.resume(),this._pipVideo?.play()}_initPip(){let e=this._pipVideo;if(!e||typeof document.createElement("canvas").captureStream!="function")return;let a=document.createElement("canvas");a.width=320,a.height=90,this._pipCanvas=a,this._pipCtx=a.getContext("2d"),e.srcObject=a.captureStream(25),e.muted=!0,this.audioAnalysis.frequencyData$.pipe(ue(this._destroyRef)).subscribe(t=>{this._pipFreqData=t,this._drawPipFrame()})}_drawPipFrame(){let e=this._pipCtx,n=this._pipCanvas;if(!e||!n)return;let a=n.width,t=n.height;e.fillStyle="#0a0a0a",e.fillRect(0,0,a,t);let d=this.currentContent?.title??"";e.fillStyle="#ffffff",e.font="11px system-ui, sans-serif",e.save(),e.rect(8,0,a-16,20),e.clip(),e.fillText(d,8,14),e.restore();let x=64,P=a/x,F=70;for(let f=0;f<x;f++){let G=(this._pipFreqData[f]??0)/255*F;e.fillStyle=`hsl(${Math.round(f/x*240)}, 80%, 55%)`,e.fillRect(Math.floor(f*P),t-G,Math.max(1,Math.floor(P)-1),G)}}togglePip(){this._pipVideo&&(document.pictureInPictureElement?document.exitPictureInPicture().catch(()=>{}):this._pipVideo.requestPictureInPicture?.().catch(()=>{}))}startDownload(){this.currentContent&&this.downloadService.startDownload(this.currentContent)}cancelDownload(){this.currentContent&&this.downloadService.cancelDownload(this.currentContent.id)}confirmDelete(){return E(this,null,function*(){this.currentContent&&(yield this.downloadService.deleteDownload(this.currentContent.id),this.isConfirmingDelete=!1)})}syncAudio(){if(!this.audioElement||!this.lastState)return;let{content:e,currentTime:n,isPlaying:a}=this.lastState;if(!e){this.audioElement.pause(),this.activeLink&&(this.audioElement.removeAttribute("src"),this.audioElement.load(),this.activeLink=null);return}let t=this.downloadService.getBlobUrl(e.id)??e.link;this.activeLink!==t&&(this.audioElement.src=t,this.audioElement.load(),this.activeLink=t),Math.abs(this.audioElement.currentTime-n)>1&&(this.audioElement.currentTime=n),a&&this.audioElement.paused?this.audioElement.play():!a&&!this.audioElement.paused&&(this.audioElement.pause(),this._pipVideo?.pause())}ngOnDestroy(){this._pipVideo&&(this._pipVideo.srcObject=null,this._pipVideo=null),this._pipCanvas=null,this._pipCtx=null}};o.\u0275fac=function(n){return new(n||o)(xe(re))},o.\u0275cmp=B({type:o,selectors:[["app-episode-player"]],viewQuery:function(n,a){if(n&1&&be(Rn,5)(gn,5),n&2){let t;ce(t=me())&&(a.audioPlayerRef=t.first),ce(t=me())&&(a.pipVideoRef=t.first)}},decls:1,vars:1,consts:[["audioPlayer",""],["pipVideo",""],[1,"floating-player"],[1,"play-btn",3,"click"],["viewBox","0 0 16 16","width","14","height","14","fill","currentColor","aria-hidden","true"],[1,"vis-btn",3,"click"],["x","1","y","8","width","3","height","7","rx","1"],["x","5","y","4","width","3","height","11","rx","1"],["x","9","y","6","width","3","height","9","rx","1"],["x","13","y","2","width","3","height","13","rx","1"],["aria-label","Picture in Picture",1,"pip-btn"],[1,"track-info"],[1,"track-title"],[1,"vis-wrapper"],["type","range","min","0","max","100","step","0.1","aria-label","Seek",1,"seek-bar",3,"pointerdown","pointerup","pointercancel","input","value"],["controls","","playsinline","","crossorigin","anonymous",2,"display","none",3,"timeupdate","loadedmetadata","ended","playing"],["type","audio/mpeg",3,"src"],["muted","","playsinline","","webkit-playsinline","",2,"position","fixed","width","1px","height","1px","opacity","0.01","pointer-events","none","top","0","left","0"],["x","2","y","1","width","5","height","14","rx","1"],["x","9","y","1","width","5","height","14","rx","1"],["points","3,1 15,8 3,15"],["aria-label","Picture in Picture",1,"pip-btn",3,"click"],["x","1","y","3","width","14","height","10","rx","1","fill","none","stroke","currentColor","stroke-width","1.5"],["x","8","y","7","width","6","height","4","rx","1"],[1,"download-btn-wrapper"],["aria-label","Cancel download",1,"download-btn","downloading"],["aria-label","Download episode",1,"download-btn"],[1,"download-btn-wrapper",3,"mouseleave"],["aria-label","Downloaded - hover to remove",1,"download-btn","downloaded"],["d","M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"],["aria-label","Confirm delete",1,"delete-confirm-btn"],["aria-label","Remove download",1,"remove-btn"],["aria-label","Confirm delete",1,"delete-confirm-btn",3,"click"],["aria-label","Remove download",1,"remove-btn",3,"click"],["aria-label","Cancel download",1,"download-btn","downloading",3,"click"],[1,"progress-text"],["viewBox","0 0 16 16","width","12","height","12","fill","currentColor","aria-hidden","true"],["cx","8","cy","8","r","6","fill","none","stroke","currentColor","stroke-width","1","opacity","0.3"],["aria-label","Download episode",1,"download-btn",3,"click"],["d","M8 12L2 6h4V1h4v5h4L8 12z"]],template:function(n,a){n&1&&y(0,En,25,17,"div",2),n&2&&A(a.currentContent?0:-1)},styles:['@charset "UTF-8";[_nghost-%COMP%]{pointer-events:none}.floating-player[_ngcontent-%COMP%]{pointer-events:auto;position:fixed;bottom:52px;left:20px;right:20px;z-index:100;display:flex;align-items:center;gap:12px;padding:12px 16px;background:var(--bg-player, #fff);border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 8px);box-shadow:var(--player-shadow, 0 2px 12px rgba(0, 0, 0, .1));font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);transition:background .3s ease,border-color .3s ease,box-shadow .3s ease}.play-btn[_ngcontent-%COMP%]{width:36px;height:36px;flex-shrink:0;border-radius:var(--player-radius, 50%);border:1px solid var(--border, transparent);background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:box-shadow .2s}.track-info[_ngcontent-%COMP%]{flex:1;min-width:0}.track-title[_ngcontent-%COMP%]{font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--text)}.seek-bar[_ngcontent-%COMP%]{-webkit-appearance:none;appearance:none;display:block;width:100%;height:3px;margin-top:8px;border-radius:2px;outline:none;cursor:pointer;background:linear-gradient(to right,var(--player-fill, #222) var(--progress-pct, 0%),var(--player-track, #e0e0e0) var(--progress-pct, 0%));touch-action:pan-x}.seek-bar[_ngcontent-%COMP%]::-webkit-slider-thumb{-webkit-appearance:none;width:0;height:0;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease,margin-top .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-webkit-slider-thumb, .seek-bar[_ngcontent-%COMP%]:active::-webkit-slider-thumb{width:18px;height:18px;margin-top:-7px}.seek-bar[_ngcontent-%COMP%]::-moz-range-thumb{width:0;height:0;border:none;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-moz-range-thumb, .seek-bar[_ngcontent-%COMP%]:active::-moz-range-thumb{width:18px;height:18px}body[data-theme=minimal-2d][data-mode=dark][_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=minimal-2d][data-mode=dark]   [_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_glow-pulse 1.4s ease-in-out infinite}@keyframes _ngcontent-%COMP%_glow-pulse{0%,to{box-shadow:none}50%{box-shadow:var(--glow, none)}}.vis-wrapper[_ngcontent-%COMP%]{overflow:hidden;max-height:0;opacity:0;transition:max-height .35s ease,opacity .25s ease}.vis-wrapper.vis-open[_ngcontent-%COMP%]{max-height:52px;opacity:1}.vis-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s}.vis-btn.active[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}.pip-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s}.download-btn-wrapper[_ngcontent-%COMP%]{display:flex;align-items:center;gap:4px;position:relative}.download-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s,color .2s;font-size:11px;font-weight:500}.download-btn[_ngcontent-%COMP%]:hover{opacity:.75}.download-btn.downloaded[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}.download-btn.downloading[_ngcontent-%COMP%]{opacity:.7}.download-btn[_ngcontent-%COMP%]   .progress-text[_ngcontent-%COMP%]{font-size:10px;font-weight:600}.remove-btn[_ngcontent-%COMP%]{padding:4px 8px;font-size:10px;font-weight:600;white-space:nowrap;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 4px);background:transparent;color:var(--text, #666);cursor:pointer;transition:background .2s,color .2s}.remove-btn[_ngcontent-%COMP%]:hover{background:#0000000d;color:var(--text, #222)}.delete-confirm-btn[_ngcontent-%COMP%]{padding:4px 8px;font-size:10px;font-weight:600;white-space:nowrap;border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 4px);background:#dc35451a;color:#dc3545;cursor:pointer;transition:background .2s,color .2s}.delete-confirm-btn[_ngcontent-%COMP%]:hover{background:#dc354533}']});let i=o;return i})();var Ue=(()=>{let o=class o{constructor(){this._theme=g(U)}};o.\u0275fac=function(n){return new(n||o)},o.\u0275cmp=B({type:o,selectors:[["app-root"]],decls:6,vars:0,consts:[[1,"app-container"],[1,"app-content"]],template:function(n,a){n&1&&(c(0,"div",0),D(1,"app-header"),c(2,"main",1),D(3,"router-outlet"),m(),D(4,"app-episode-player")(5,"app-footer"),m())},dependencies:[Te,ze,Je,Ve],styles:[".app-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;height:100vh;max-height:-webkit-fill-available;background:var(--bg, #fff)}.app-content[_ngcontent-%COMP%]{flex:1;overflow-y:auto;padding-bottom:144px}"]});let i=o;return i})();Pe(Ue,O(K({},he),{providers:[Ce(),...he.providers]})).then(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.register("./sw.js").catch(i=>console.warn("SW registration failed",i))}).catch(i=>console.error(i));
