import{$ as Ti,$a as Fe,A as bi,Aa as Wa,B as Pa,Ba as Ua,C as de,Ca as ja,D as En,Da as _a,E as ne,Ea as qa,F as T,Fa as Ya,G as Ea,Ga as en,H as k,Ha as ue,I as Hn,Ia as me,J as Ha,Ja as De,K as E,Ka as ye,L as D,La as Gi,M as m,Ma as K,N as La,Na as j,O as Ba,Oa as _,P as Me,Pa as v,Q as W,Qa as y,R as I,Ra as On,S as G,Sa as Be,T as Se,Ta as Ae,U as Ze,Ua as nn,V as wi,Va as ve,W as F,Wa as C,X as $e,Xa as Za,Y as Fa,Ya as $a,Z as Le,Za as Qa,_ as Ln,_a as an,a as h,aa as Pi,ab as P,b as w,ba as Q,bb as X,c as u,ca as Qe,cb as In,d as b,da as ie,db as Xa,e as ya,ea as Ei,eb as eo,f as Aa,fa as Hi,fb as no,g as va,ga as Na,gb as on,h as se,ha as Li,hb as io,i as O,ia as Oa,ib as ao,j as V,ja as Bn,jb as oo,k as $,ka as Bi,kb as to,l as M,la as Fn,m as xa,ma as Ia,n as vi,na as A,o as Ca,oa as Xe,p as B,pa as Ga,q as ba,qa as Ka,r as le,ra as za,s as wa,sa as Fi,t as Pn,ta as Ni,u as Ee,ua as Ja,v as xi,va as Oi,w as Ci,wa as U,x as He,xa as Nn,y as Ta,ya as Ii,z as ce,za as Va}from"./chunk-OFJ5GZGZ.js";var ro=null;function ae(){return ro}function Ki(i){ro??=i}var tn=class{},Gn=(()=>{let e=class e{historyGo(n){throw new Error("")}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(so),providedIn:"platform"}));let i=e;return i})();var so=(()=>{let e=class e extends Gn{_location;_history;_doc=m(F);constructor(){super(),this._location=window.location,this._history=window.history}getBaseHrefFromDOM(){return ae().getBaseHref(this._doc)}onPopState(n){let a=ae().getGlobalEventTarget(this._doc,"window");return a.addEventListener("popstate",n,!1),()=>a.removeEventListener("popstate",n)}onHashChange(n){let a=ae().getGlobalEventTarget(this._doc,"window");return a.addEventListener("hashchange",n,!1),()=>a.removeEventListener("hashchange",n)}get href(){return this._location.href}get protocol(){return this._location.protocol}get hostname(){return this._location.hostname}get port(){return this._location.port}get pathname(){return this._location.pathname}get search(){return this._location.search}get hash(){return this._location.hash}set pathname(n){this._location.pathname=n}pushState(n,a,t){this._history.pushState(n,a,t)}replaceState(n,a,t){this._history.replaceState(n,a,t)}forward(){this._history.forward()}back(){this._history.back()}historyGo(n=0){this._history.go(n)}getState(){return this._history.state}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>new e,providedIn:"platform"}));let i=e;return i})();function uo(i,e){return i?e?i.endsWith("/")?e.startsWith("/")?i+e.slice(1):i+e:e.startsWith("/")?i+e:`${i}/${e}`:i:e}function lo(i){let e=i.search(/#|\?|$/);return i[e-1]==="/"?i.slice(0,e-1)+i.slice(e):i}function he(i){return i&&i[0]!=="?"?`?${i}`:i}var Kn=(()=>{let e=class e{historyGo(n){throw new Error("")}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(Tt),providedIn:"root"}));let i=e;return i})(),wt=new E(""),Tt=(()=>{let e=class e extends Kn{_platformLocation;_baseHref;_removeListenerFns=[];constructor(n,a){super(),this._platformLocation=n,this._baseHref=a??this._platformLocation.getBaseHrefFromDOM()??m(F).location?.origin??""}ngOnDestroy(){for(;this._removeListenerFns.length;)this._removeListenerFns.pop()()}onPopState(n){this._removeListenerFns.push(this._platformLocation.onPopState(n),this._platformLocation.onHashChange(n))}getBaseHref(){return this._baseHref}prepareExternalUrl(n){return uo(this._baseHref,n)}path(n=!1){let a=this._platformLocation.pathname+he(this._platformLocation.search),t=this._platformLocation.hash;return t&&n?`${a}${t}`:a}pushState(n,a,t,r){let s=this.prepareExternalUrl(t+he(r));this._platformLocation.pushState(n,a,s)}replaceState(n,a,t,r){let s=this.prepareExternalUrl(t+he(r));this._platformLocation.replaceState(n,a,s)}forward(){this._platformLocation.forward()}back(){this._platformLocation.back()}getState(){return this._platformLocation.getState()}historyGo(n=0){this._platformLocation.historyGo?.(n)}};u(e,"\u0275fac",function(a){return new(a||e)(D(Gn),D(wt,8))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})(),Ne=(()=>{let e=class e{_subject=new se;_basePath;_locationStrategy;_urlChangeListeners=[];_urlChangeSubscription=null;constructor(n){this._locationStrategy=n;let a=this._locationStrategy.getBaseHref();this._basePath=Ht(lo(co(a))),this._locationStrategy.onPopState(t=>{this._subject.next({url:this.path(!0),pop:!0,state:t.state,type:t.type})})}ngOnDestroy(){this._urlChangeSubscription?.unsubscribe(),this._urlChangeListeners=[]}path(n=!1){return this.normalize(this._locationStrategy.path(n))}getState(){return this._locationStrategy.getState()}isCurrentPathEqualTo(n,a=""){return this.path()==this.normalize(n+he(a))}normalize(n){return e.stripTrailingSlash(Et(this._basePath,co(n)))}prepareExternalUrl(n){return n&&n[0]!=="/"&&(n="/"+n),this._locationStrategy.prepareExternalUrl(n)}go(n,a="",t=null){this._locationStrategy.pushState(t,"",n,a),this._notifyUrlChangeListeners(this.prepareExternalUrl(n+he(a)),t)}replaceState(n,a="",t=null){this._locationStrategy.replaceState(t,"",n,a),this._notifyUrlChangeListeners(this.prepareExternalUrl(n+he(a)),t)}forward(){this._locationStrategy.forward()}back(){this._locationStrategy.back()}historyGo(n=0){this._locationStrategy.historyGo?.(n)}onUrlChange(n){return this._urlChangeListeners.push(n),this._urlChangeSubscription??=this.subscribe(a=>{this._notifyUrlChangeListeners(a.url,a.state)}),()=>{let a=this._urlChangeListeners.indexOf(n);this._urlChangeListeners.splice(a,1),this._urlChangeListeners.length===0&&(this._urlChangeSubscription?.unsubscribe(),this._urlChangeSubscription=null)}}_notifyUrlChangeListeners(n="",a){this._urlChangeListeners.forEach(t=>t(n,a))}subscribe(n,a,t){return this._subject.subscribe({next:n,error:a??void 0,complete:t??void 0})}};u(e,"normalizeQueryParams",he),u(e,"joinWithSlash",uo),u(e,"stripTrailingSlash",lo),u(e,"\u0275fac",function(a){return new(a||e)(D(Kn))}),u(e,"\u0275prov",k({token:e,factory:()=>Pt(),providedIn:"root"}));let i=e;return i})();function Pt(){return new Ne(D(Kn))}function Et(i,e){if(!i||!e.startsWith(i))return e;let o=e.substring(i.length);return o===""||["/",";","?","#"].includes(o[0])?o:e}function co(i){return i.replace(/\/index.html$/,"")}function Ht(i){if(new RegExp("^(https?:)?//").test(i)){let[,o]=i.split(/\/\/[^\/]+/);return o}return i}var Oe=(()=>{let e=class e{};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275mod",Nn({type:e})),u(e,"\u0275inj",Hn({}));let i=e;return i})();function zi(i,e){e=encodeURIComponent(e);for(let o of i.split(";")){let n=o.indexOf("="),[a,t]=n==-1?[o,""]:[o.slice(0,n),o.slice(n+1)];if(a.trim()===e)return decodeURIComponent(t)}return null}var rn=class{};var mo="browser";var sn=class{_doc;constructor(e){this._doc=e}manager},zn=(()=>{let e=class e extends sn{constructor(n){super(n)}supports(n){return!0}addEventListener(n,a,t,r){return n.addEventListener(a,t,r),()=>this.removeEventListener(n,a,t,r)}removeEventListener(n,a,t,r){return n.removeEventListener(a,t,r)}};u(e,"\u0275fac",function(a){return new(a||e)(D(F))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})(),Wn=new E(""),Ui=(()=>{let e=class e{_zone;_plugins;_eventNameToPlugin=new Map;constructor(n,a){this._zone=a,n.forEach(s=>{s.manager=this});let t=n.filter(s=>!(s instanceof zn));this._plugins=t.slice().reverse();let r=n.find(s=>s instanceof zn);r&&this._plugins.push(r)}addEventListener(n,a,t,r){return this._findPluginFor(a).addEventListener(n,a,t,r)}getZone(){return this._zone}_findPluginFor(n){let a=this._eventNameToPlugin.get(n);if(a)return a;if(a=this._plugins.find(r=>r.supports(n)),!a)throw new T(5101,!1);return this._eventNameToPlugin.set(n,a),a}};u(e,"\u0275fac",function(a){return new(a||e)(D(Wn),D(Ln))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})(),Ji="ng-app-id";function ho(i){for(let e of i)e.remove()}function po(i,e){let o=e.createElement("style");return o.textContent=i,o}function Bt(i,e,o,n){let a=i.head?.querySelectorAll(`style[${Ji}="${e}"],link[${Ji}="${e}"]`);if(a)for(let t of a)t.removeAttribute(Ji),t instanceof HTMLLinkElement?n.set(t.href.slice(t.href.lastIndexOf("/")+1),{usage:0,elements:[t]}):t.textContent&&o.set(t.textContent,{usage:0,elements:[t]})}function Wi(i,e){let o=e.createElement("link");return o.setAttribute("rel","stylesheet"),o.setAttribute("href",i),o}var ji=(()=>{let e=class e{doc;appId;nonce;inline=new Map;external=new Map;hosts=new Set;constructor(n,a,t,r={}){this.doc=n,this.appId=a,this.nonce=t,Bt(n,a,this.inline,this.external),this.hosts.add(n.head)}addStyles(n,a){for(let t of n)this.addUsage(t,this.inline,po);a?.forEach(t=>this.addUsage(t,this.external,Wi))}removeStyles(n,a){for(let t of n)this.removeUsage(t,this.inline);a?.forEach(t=>this.removeUsage(t,this.external))}addUsage(n,a,t){let r=a.get(n);r?r.usage++:a.set(n,{usage:1,elements:[...this.hosts].map(s=>this.addElement(s,t(n,this.doc)))})}removeUsage(n,a){let t=a.get(n);t&&(t.usage--,t.usage<=0&&(ho(t.elements),a.delete(n)))}ngOnDestroy(){for(let[,{elements:n}]of[...this.inline,...this.external])ho(n);this.hosts.clear()}addHost(n){this.hosts.add(n);for(let[a,{elements:t}]of this.inline)t.push(this.addElement(n,po(a,this.doc)));for(let[a,{elements:t}]of this.external)t.push(this.addElement(n,Wi(a,this.doc)))}removeHost(n){this.hosts.delete(n)}addElement(n,a){return this.nonce&&a.setAttribute("nonce",this.nonce),n.appendChild(a)}};u(e,"\u0275fac",function(a){return new(a||e)(D(F),D(Li),D(Bi,8),D(Bn))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})(),Vi={svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/",math:"http://www.w3.org/1998/Math/MathML"},_i=/%COMP%/g;var Ro="%COMP%",Ft=`_nghost-${Ro}`,Nt=`_ngcontent-${Ro}`,Ot=!0,It=new E("",{factory:()=>Ot});function Gt(i){return Nt.replace(_i,i)}function Kt(i){return Ft.replace(_i,i)}function ko(i,e){return e.map(o=>o.replace(_i,i))}var qi=(()=>{let e=class e{eventManager;sharedStylesHost;appId;removeStylesOnCompDestroy;doc;ngZone;nonce;tracingService;rendererByCompId=new Map;defaultRenderer;constructor(n,a,t,r,s,l,c=null,d=null){this.eventManager=n,this.sharedStylesHost=a,this.appId=t,this.removeStylesOnCompDestroy=r,this.doc=s,this.ngZone=l,this.nonce=c,this.tracingService=d,this.defaultRenderer=new ln(n,s,l,this.tracingService)}createRenderer(n,a){if(!n||!a)return this.defaultRenderer;let t=this.getOrCreateRenderer(n,a);return t instanceof Vn?t.applyToHost(n):t instanceof cn&&t.applyStyles(),t}getOrCreateRenderer(n,a){let t=this.rendererByCompId,r=t.get(a.id);if(!r){let s=this.doc,l=this.ngZone,c=this.eventManager,d=this.sharedStylesHost,g=this.removeStylesOnCompDestroy,p=this.tracingService;switch(a.encapsulation){case Fn.Emulated:r=new Vn(c,d,a,this.appId,g,s,l,p);break;case Fn.ShadowDom:return new Jn(c,n,a,s,l,this.nonce,p,d);case Fn.ExperimentalIsolatedShadowDom:return new Jn(c,n,a,s,l,this.nonce,p);default:r=new cn(c,d,a,g,s,l,p);break}t.set(a.id,r)}return r}ngOnDestroy(){this.rendererByCompId.clear()}componentReplaced(n){this.rendererByCompId.delete(n)}};u(e,"\u0275fac",function(a){return new(a||e)(D(Ui),D(ji),D(Li),D(It),D(F),D(Ln),D(Bi),D(Ka,8))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})(),ln=class{eventManager;doc;ngZone;tracingService;data=Object.create(null);throwOnSyntheticProps=!0;constructor(e,o,n,a){this.eventManager=e,this.doc=o,this.ngZone=n,this.tracingService=a}destroy(){}destroyNode=null;createElement(e,o){return o?this.doc.createElementNS(Vi[o]||o,e):this.doc.createElement(e)}createComment(e){return this.doc.createComment(e)}createText(e){return this.doc.createTextNode(e)}appendChild(e,o){(go(e)?e.content:e).appendChild(o)}insertBefore(e,o,n){e&&(go(e)?e.content:e).insertBefore(o,n)}removeChild(e,o){o.remove()}selectRootElement(e,o){let n=typeof e=="string"?this.doc.querySelector(e):e;if(!n)throw new T(-5104,!1);return o||(n.textContent=""),n}parentNode(e){return e.parentNode}nextSibling(e){return e.nextSibling}setAttribute(e,o,n,a){if(a){o=a+":"+o;let t=Vi[a];t?e.setAttributeNS(t,o,n):e.setAttribute(o,n)}else e.setAttribute(o,n)}removeAttribute(e,o,n){if(n){let a=Vi[n];a?e.removeAttributeNS(a,o):e.removeAttribute(`${n}:${o}`)}else e.removeAttribute(o)}addClass(e,o){e.classList.add(o)}removeClass(e,o){e.classList.remove(o)}setStyle(e,o,n,a){a&(Xe.DashCase|Xe.Important)?e.style.setProperty(o,n,a&Xe.Important?"important":""):e.style[o]=n}removeStyle(e,o,n){n&Xe.DashCase?e.style.removeProperty(o):e.style[o]=""}setProperty(e,o,n){e!=null&&(e[o]=n)}setValue(e,o){e.nodeValue=o}listen(e,o,n,a){if(typeof e=="string"&&(e=ae().getGlobalEventTarget(this.doc,e),!e))throw new T(5102,!1);let t=this.decoratePreventDefault(n);return this.tracingService?.wrapEventListener&&(t=this.tracingService.wrapEventListener(e,o,t)),this.eventManager.addEventListener(e,o,t,a)}decoratePreventDefault(e){return o=>{if(o==="__ngUnwrap__")return e;e(o)===!1&&o.preventDefault()}}};function go(i){return i.tagName==="TEMPLATE"&&i.content!==void 0}var Jn=class extends ln{hostEl;sharedStylesHost;shadowRoot;constructor(e,o,n,a,t,r,s,l){super(e,a,t,s),this.hostEl=o,this.sharedStylesHost=l,this.shadowRoot=o.attachShadow({mode:"open"}),this.sharedStylesHost&&this.sharedStylesHost.addHost(this.shadowRoot);let c=n.styles;c=ko(n.id,c);for(let g of c){let p=document.createElement("style");r&&p.setAttribute("nonce",r),p.textContent=g,this.shadowRoot.appendChild(p)}let d=n.getExternalStyles?.();if(d)for(let g of d){let p=Wi(g,a);r&&p.setAttribute("nonce",r),this.shadowRoot.appendChild(p)}}nodeOrShadowRoot(e){return e===this.hostEl?this.shadowRoot:e}appendChild(e,o){return super.appendChild(this.nodeOrShadowRoot(e),o)}insertBefore(e,o,n){return super.insertBefore(this.nodeOrShadowRoot(e),o,n)}removeChild(e,o){return super.removeChild(null,o)}parentNode(e){return this.nodeOrShadowRoot(super.parentNode(this.nodeOrShadowRoot(e)))}destroy(){this.sharedStylesHost&&this.sharedStylesHost.removeHost(this.shadowRoot)}},cn=class extends ln{sharedStylesHost;removeStylesOnCompDestroy;styles;styleUrls;constructor(e,o,n,a,t,r,s,l){super(e,t,r,s),this.sharedStylesHost=o,this.removeStylesOnCompDestroy=a;let c=n.styles;this.styles=l?ko(l,c):c,this.styleUrls=n.getExternalStyles?.(l)}applyStyles(){this.sharedStylesHost.addStyles(this.styles,this.styleUrls)}destroy(){this.removeStylesOnCompDestroy&&Ga.size===0&&this.sharedStylesHost.removeStyles(this.styles,this.styleUrls)}},Vn=class extends cn{contentAttr;hostAttr;constructor(e,o,n,a,t,r,s,l){let c=a+"-"+n.id;super(e,o,n,t,r,s,l,c),this.contentAttr=Gt(c),this.hostAttr=Kt(c)}applyToHost(e){this.applyStyles(),this.setAttribute(e,this.hostAttr,"")}createElement(e,o){let n=super.createElement(e,o);return super.setAttribute(n,this.contentAttr,""),n}};var Un=class i extends tn{supportsDOMEvents=!0;static makeCurrent(){Ki(new i)}onAndCancel(e,o,n,a){return e.addEventListener(o,n,a),()=>{e.removeEventListener(o,n,a)}}dispatchEvent(e,o){e.dispatchEvent(o)}remove(e){e.remove()}createElement(e,o){return o=o||this.getDefaultDocument(),o.createElement(e)}createHtmlDocument(){return document.implementation.createHTMLDocument("fakeTitle")}getDefaultDocument(){return document}isElementNode(e){return e.nodeType===Node.ELEMENT_NODE}isShadowRoot(e){return e instanceof DocumentFragment}getGlobalEventTarget(e,o){return o==="window"?window:o==="document"?e:o==="body"?e.body:null}getBaseHref(e){let o=zt();return o==null?null:Jt(o)}resetBaseElement(){dn=null}getUserAgent(){return window.navigator.userAgent}getCookie(e){return zi(document.cookie,e)}},dn=null;function zt(){return dn=dn||document.head.querySelector("base"),dn?dn.getAttribute("href"):null}function Jt(i){return new URL(i,document.baseURI).pathname}var Vt=(()=>{let e=class e{build(){return new XMLHttpRequest}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})(),fo=["alt","control","meta","shift"],Wt={"\b":"Backspace","	":"Tab","\x7F":"Delete","\x1B":"Escape",Del:"Delete",Esc:"Escape",Left:"ArrowLeft",Right:"ArrowRight",Up:"ArrowUp",Down:"ArrowDown",Menu:"ContextMenu",Scroll:"ScrollLock",Win:"OS"},Ut={alt:i=>i.altKey,control:i=>i.ctrlKey,meta:i=>i.metaKey,shift:i=>i.shiftKey},Mo=(()=>{let e=class e extends sn{constructor(n){super(n)}supports(n){return e.parseEventName(n)!=null}addEventListener(n,a,t,r){let s=e.parseEventName(a),l=e.eventCallback(s.fullKey,t,this.manager.getZone());return this.manager.getZone().runOutsideAngular(()=>ae().onAndCancel(n,s.domEventName,l,r))}static parseEventName(n){let a=n.toLowerCase().split("."),t=a.shift();if(a.length===0||!(t==="keydown"||t==="keyup"))return null;let r=e._normalizeKey(a.pop()),s="",l=a.indexOf("code");if(l>-1&&(a.splice(l,1),s="code."),fo.forEach(d=>{let g=a.indexOf(d);g>-1&&(a.splice(g,1),s+=d+".")}),s+=r,a.length!=0||r.length===0)return null;let c={};return c.domEventName=t,c.fullKey=s,c}static matchEventFullKeyCode(n,a){let t=Wt[n.key]||n.key,r="";return a.indexOf("code.")>-1&&(t=n.code,r="code."),t==null||!t?!1:(t=t.toLowerCase(),t===" "?t="space":t==="."&&(t="dot"),fo.forEach(s=>{if(s!==t){let l=Ut[s];l(n)&&(r+=s+".")}}),r+=t,r===a)}static eventCallback(n,a,t){return r=>{e.matchEventFullKeyCode(r,n)&&t.runGuarded(()=>a(r))}}static _normalizeKey(n){return n==="esc"?"escape":n}};u(e,"\u0275fac",function(a){return new(a||e)(D(F))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac}));let i=e;return i})();function Yi(i,e,o){return b(this,null,function*(){let n=h({rootComponent:i},jt(e,o));return io(n)})}function jt(i,e){return{platformRef:e?.platformRef,appProviders:[...$t,...i?.providers??[]],platformProviders:Zt}}function _t(){Un.makeCurrent()}function qt(){return new Ti}function Yt(){return Na(document),document}var Zt=[{provide:Bn,useValue:mo},{provide:Oa,useValue:_t,multi:!0},{provide:F,useFactory:Yt}];var $t=[{provide:Ba,useValue:"root"},{provide:Ti,useFactory:qt},{provide:Wn,useClass:zn,multi:!0},{provide:Wn,useClass:Mo,multi:!0},qi,ji,Ui,{provide:za,useExisting:qi},{provide:rn,useClass:Vt},[]];var So=(()=>{let e=class e{_doc;constructor(n){this._doc=n}getTitle(){return this._doc.title}setTitle(n){this._doc.title=n||""}};u(e,"\u0275fac",function(a){return new(a||e)(D(F))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})();var R="primary",yn=Symbol("RouteTitle"),ea=class{params;constructor(e){this.params=e||{}}has(e){return Object.prototype.hasOwnProperty.call(this.params,e)}get(e){if(this.has(e)){let o=this.params[e];return Array.isArray(o)?o[0]:o}return null}getAll(e){if(this.has(e)){let o=this.params[e];return Array.isArray(o)?o:[o]}return[]}get keys(){return Object.keys(this.params)}};function be(i){return new ea(i)}function Zi(i,e,o){for(let n=0;n<i.length;n++){let a=i[n],t=e[n];if(a[0]===":")o[a.substring(1)]=t;else if(a!==t.path)return!1}return!0}function Po(i,e,o){let n=o.path.split("/"),a=n.indexOf("**");if(a===-1){if(n.length>i.length||o.pathMatch==="full"&&(e.hasChildren()||n.length<i.length))return null;let l={},c=i.slice(0,n.length);return Zi(n,c,l)?{consumed:c,posParams:l}:null}if(a!==n.lastIndexOf("**"))return null;let t=n.slice(0,a),r=n.slice(a+1);if(t.length+r.length>i.length||o.pathMatch==="full"&&e.hasChildren()&&o.path!=="**")return null;let s={};return!Zi(t,i.slice(0,t.length),s)||!Zi(r,i.slice(i.length-r.length),s)?null:{consumed:i,posParams:s}}function $n(i){return new Promise((e,o)=>{i.pipe(ce()).subscribe({next:n=>e(n),error:n=>o(n)})})}function er(i,e){if(i.length!==e.length)return!1;for(let o=0;o<i.length;++o)if(!ee(i[o],e[o]))return!1;return!0}function ee(i,e){let o=i?na(i):void 0,n=e?na(e):void 0;if(!o||!n||o.length!=n.length)return!1;let a;for(let t=0;t<o.length;t++)if(a=o[t],!Eo(i[a],e[a]))return!1;return!0}function na(i){return[...Object.keys(i),...Object.getOwnPropertySymbols(i)]}function Eo(i,e){if(Array.isArray(i)&&Array.isArray(e)){if(i.length!==e.length)return!1;let o=[...i].sort(),n=[...e].sort();return o.every((a,t)=>n[t]===a)}else return i===e}function nr(i){return i.length>0?i[i.length-1]:null}function Pe(i){return vi(i)?i:Ua(i)?$(Promise.resolve(i)):M(i)}function Ho(i){return vi(i)?$n(i):Promise.resolve(i)}var ir={exact:Bo,subset:Fo},Lo={exact:ar,subset:or,ignored:()=>!0};function Do(i,e,o){return ir[o.paths](i.root,e.root,o.matrixParams)&&Lo[o.queryParams](i.queryParams,e.queryParams)&&!(o.fragment==="exact"&&i.fragment!==e.fragment)}function ar(i,e){return ee(i,e)}function Bo(i,e,o){if(!xe(i.segments,e.segments)||!qn(i.segments,e.segments,o)||i.numberOfChildren!==e.numberOfChildren)return!1;for(let n in e.children)if(!i.children[n]||!Bo(i.children[n],e.children[n],o))return!1;return!0}function or(i,e){return Object.keys(e).length<=Object.keys(i).length&&Object.keys(e).every(o=>Eo(i[o],e[o]))}function Fo(i,e,o){return No(i,e,e.segments,o)}function No(i,e,o,n){if(i.segments.length>o.length){let a=i.segments.slice(0,o.length);return!(!xe(a,o)||e.hasChildren()||!qn(a,o,n))}else if(i.segments.length===o.length){if(!xe(i.segments,o)||!qn(i.segments,o,n))return!1;for(let a in e.children)if(!i.children[a]||!Fo(i.children[a],e.children[a],n))return!1;return!0}else{let a=o.slice(0,i.segments.length),t=o.slice(i.segments.length);return!xe(i.segments,a)||!qn(i.segments,a,n)||!i.children[R]?!1:No(i.children[R],e,t,n)}}function qn(i,e,o){return e.every((n,a)=>Lo[o](i[a].parameters,n.parameters))}var Z=class{root;queryParams;fragment;_queryParamMap;constructor(e=new S([],{}),o={},n=null){this.root=e,this.queryParams=o,this.fragment=n}get queryParamMap(){return this._queryParamMap??=be(this.queryParams),this._queryParamMap}toString(){return sr.serialize(this)}},S=class{segments;children;parent=null;constructor(e,o){this.segments=e,this.children=o,Object.values(o).forEach(n=>n.parent=this)}hasChildren(){return this.numberOfChildren>0}get numberOfChildren(){return Object.keys(this.children).length}toString(){return Yn(this)}},pe=class{path;parameters;_parameterMap;constructor(e,o){this.path=e,this.parameters=o}get parameterMap(){return this._parameterMap??=be(this.parameters),this._parameterMap}toString(){return Io(this)}};function tr(i,e){return xe(i,e)&&i.every((o,n)=>ee(o.parameters,e[n].parameters))}function xe(i,e){return i.length!==e.length?!1:i.every((o,n)=>o.path===e[n].path)}function rr(i,e){let o=[];return Object.entries(i.children).forEach(([n,a])=>{n===R&&(o=o.concat(e(a,n)))}),Object.entries(i.children).forEach(([n,a])=>{n!==R&&(o=o.concat(e(a,n)))}),o}var An=(()=>{let e=class e{};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>new ge,providedIn:"root"}));let i=e;return i})(),ge=class{parse(e){let o=new aa(e);return new Z(o.parseRootSegment(),o.parseQueryParams(),o.parseFragment())}serialize(e){let o=`/${un(e.root,!0)}`,n=dr(e.queryParams),a=typeof e.fragment=="string"?`#${lr(e.fragment)}`:"";return`${o}${n}${a}`}},sr=new ge;function Yn(i){return i.segments.map(e=>Io(e)).join("/")}function un(i,e){if(!i.hasChildren())return Yn(i);if(e){let o=i.children[R]?un(i.children[R],!1):"",n=[];return Object.entries(i.children).forEach(([a,t])=>{a!==R&&n.push(`${a}:${un(t,!1)}`)}),n.length>0?`${o}(${n.join("//")})`:o}else{let o=rr(i,(n,a)=>a===R?[un(i.children[R],!1)]:[`${a}:${un(n,!1)}`]);return Object.keys(i.children).length===1&&i.children[R]!=null?`${Yn(i)}/${o[0]}`:`${Yn(i)}/(${o.join("//")})`}}function Oo(i){return encodeURIComponent(i).replace(/%40/g,"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",")}function jn(i){return Oo(i).replace(/%3B/gi,";")}function lr(i){return encodeURI(i)}function ia(i){return Oo(i).replace(/\(/g,"%28").replace(/\)/g,"%29").replace(/%26/gi,"&")}function Zn(i){return decodeURIComponent(i)}function yo(i){return Zn(i.replace(/\+/g,"%20"))}function Io(i){return`${ia(i.path)}${cr(i.parameters)}`}function cr(i){return Object.entries(i).map(([e,o])=>`;${ia(e)}=${ia(o)}`).join("")}function dr(i){let e=Object.entries(i).map(([o,n])=>Array.isArray(n)?n.map(a=>`${jn(o)}=${jn(a)}`).join("&"):`${jn(o)}=${jn(n)}`).filter(o=>o);return e.length?`?${e.join("&")}`:""}var ur=/^[^\/()?;#]+/;function $i(i){let e=i.match(ur);return e?e[0]:""}var mr=/^[^\/()?;=#]+/;function hr(i){let e=i.match(mr);return e?e[0]:""}var pr=/^[^=?&#]+/;function gr(i){let e=i.match(pr);return e?e[0]:""}var Rr=/^[^&#]+/;function kr(i){let e=i.match(Rr);return e?e[0]:""}var aa=class{url;remaining;constructor(e){this.url=e,this.remaining=e}parseRootSegment(){return this.consumeOptional("/"),this.remaining===""||this.peekStartsWith("?")||this.peekStartsWith("#")?new S([],{}):new S([],this.parseChildren())}parseQueryParams(){let e={};if(this.consumeOptional("?"))do this.parseQueryParam(e);while(this.consumeOptional("&"));return e}parseFragment(){return this.consumeOptional("#")?decodeURIComponent(this.remaining):null}parseChildren(e=0){if(e>50)throw new T(4010,!1);if(this.remaining==="")return{};this.consumeOptional("/");let o=[];for(this.peekStartsWith("(")||o.push(this.parseSegment());this.peekStartsWith("/")&&!this.peekStartsWith("//")&&!this.peekStartsWith("/(");)this.capture("/"),o.push(this.parseSegment());let n={};this.peekStartsWith("/(")&&(this.capture("/"),n=this.parseParens(!0,e));let a={};return this.peekStartsWith("(")&&(a=this.parseParens(!1,e)),(o.length>0||Object.keys(n).length>0)&&(a[R]=new S(o,n)),a}parseSegment(){let e=$i(this.remaining);if(e===""&&this.peekStartsWith(";"))throw new T(4009,!1);return this.capture(e),new pe(Zn(e),this.parseMatrixParams())}parseMatrixParams(){let e={};for(;this.consumeOptional(";");)this.parseParam(e);return e}parseParam(e){let o=hr(this.remaining);if(!o)return;this.capture(o);let n="";if(this.consumeOptional("=")){let a=$i(this.remaining);a&&(n=a,this.capture(n))}e[Zn(o)]=Zn(n)}parseQueryParam(e){let o=gr(this.remaining);if(!o)return;this.capture(o);let n="";if(this.consumeOptional("=")){let r=kr(this.remaining);r&&(n=r,this.capture(n))}let a=yo(o),t=yo(n);if(e.hasOwnProperty(a)){let r=e[a];Array.isArray(r)||(r=[r],e[a]=r),r.push(t)}else e[a]=t}parseParens(e,o){let n={};for(this.capture("(");!this.consumeOptional(")")&&this.remaining.length>0;){let a=$i(this.remaining),t=this.remaining[a.length];if(t!=="/"&&t!==")"&&t!==";")throw new T(4010,!1);let r;a.indexOf(":")>-1?(r=a.slice(0,a.indexOf(":")),this.capture(r),this.capture(":")):e&&(r=R);let s=this.parseChildren(o+1);n[r??R]=Object.keys(s).length===1&&s[R]?s[R]:new S([],s),this.consumeOptional("//")}return n}peekStartsWith(e){return this.remaining.startsWith(e)}consumeOptional(e){return this.peekStartsWith(e)?(this.remaining=this.remaining.substring(e.length),!0):!1}capture(e){if(!this.consumeOptional(e))throw new T(4011,!1)}};function Go(i){return i.segments.length>0?new S([],{[R]:i}):i}function Ko(i){let e={};for(let[n,a]of Object.entries(i.children)){let t=Ko(a);if(n===R&&t.segments.length===0&&t.hasChildren())for(let[r,s]of Object.entries(t.children))e[r]=s;else(t.segments.length>0||t.hasChildren())&&(e[n]=t)}let o=new S(i.segments,e);return fr(o)}function fr(i){if(i.numberOfChildren===1&&i.children[R]){let e=i.children[R];return new S(i.segments.concat(e.segments),e.children)}return i}function ze(i){return i instanceof Z}function zo(i,e,o=null,n=null,a=new ge){let t=Jo(i);return Vo(t,e,o,n,a)}function Jo(i){let e;function o(t){let r={};for(let l of t.children){let c=o(l);r[l.outlet]=c}let s=new S(t.url,r);return t===i&&(e=s),s}let n=o(i.root),a=Go(n);return e??a}function Vo(i,e,o,n,a){let t=i;for(;t.parent;)t=t.parent;if(e.length===0)return Qi(t,t,t,o,n,a);let r=Mr(e);if(r.toRoot())return Qi(t,t,new S([],{}),o,n,a);let s=Sr(r,t,i),l=s.processChildren?hn(s.segmentGroup,s.index,r.commands):Uo(s.segmentGroup,s.index,r.commands);return Qi(t,s.segmentGroup,l,o,n,a)}function Qn(i){return typeof i=="object"&&i!=null&&!i.outlets&&!i.segmentPath}function Rn(i){return typeof i=="object"&&i!=null&&i.outlets}function Ao(i,e,o){i||="\u0275";let n=new Z;return n.queryParams={[i]:e},o.parse(o.serialize(n)).queryParams[i]}function Qi(i,e,o,n,a,t){let r={};for(let[c,d]of Object.entries(n??{}))r[c]=Array.isArray(d)?d.map(g=>Ao(c,g,t)):Ao(c,d,t);let s;i===e?s=o:s=Wo(i,e,o);let l=Go(Ko(s));return new Z(l,r,a)}function Wo(i,e,o){let n={};return Object.entries(i.children).forEach(([a,t])=>{t===e?n[a]=o:n[a]=Wo(t,e,o)}),new S(i.segments,n)}var Xn=class{isAbsolute;numberOfDoubleDots;commands;constructor(e,o,n){if(this.isAbsolute=e,this.numberOfDoubleDots=o,this.commands=n,e&&n.length>0&&Qn(n[0]))throw new T(4003,!1);let a=n.find(Rn);if(a&&a!==nr(n))throw new T(4004,!1)}toRoot(){return this.isAbsolute&&this.commands.length===1&&this.commands[0]=="/"}};function Mr(i){if(typeof i[0]=="string"&&i.length===1&&i[0]==="/")return new Xn(!0,0,i);let e=0,o=!1,n=i.reduce((a,t,r)=>{if(typeof t=="object"&&t!=null){if(t.outlets){let s={};return Object.entries(t.outlets).forEach(([l,c])=>{s[l]=typeof c=="string"?c.split("/"):c}),[...a,{outlets:s}]}if(t.segmentPath)return[...a,t.segmentPath]}return typeof t!="string"?[...a,t]:r===0?(t.split("/").forEach((s,l)=>{l==0&&s==="."||(l==0&&s===""?o=!0:s===".."?e++:s!=""&&a.push(s))}),a):[...a,t]},[]);return new Xn(o,e,n)}var Ge=class{segmentGroup;processChildren;index;constructor(e,o,n){this.segmentGroup=e,this.processChildren=o,this.index=n}};function Sr(i,e,o){if(i.isAbsolute)return new Ge(e,!0,0);if(!o)return new Ge(e,!1,NaN);if(o.parent===null)return new Ge(o,!0,0);let n=Qn(i.commands[0])?0:1,a=o.segments.length-1+n;return Dr(o,a,i.numberOfDoubleDots)}function Dr(i,e,o){let n=i,a=e,t=o;for(;t>a;){if(t-=a,n=n.parent,!n)throw new T(4005,!1);a=n.segments.length}return new Ge(n,!1,a-t)}function yr(i){return Rn(i[0])?i[0].outlets:{[R]:i}}function Uo(i,e,o){if(i??=new S([],{}),i.segments.length===0&&i.hasChildren())return hn(i,e,o);let n=Ar(i,e,o),a=o.slice(n.commandIndex);if(n.match&&n.pathIndex<i.segments.length){let t=new S(i.segments.slice(0,n.pathIndex),{});return t.children[R]=new S(i.segments.slice(n.pathIndex),i.children),hn(t,0,a)}else return n.match&&a.length===0?new S(i.segments,{}):n.match&&!i.hasChildren()?oa(i,e,o):n.match?hn(i,0,a):oa(i,e,o)}function hn(i,e,o){if(o.length===0)return new S(i.segments,{});{let n=yr(o),a={};if(Object.keys(n).some(t=>t!==R)&&i.children[R]&&i.numberOfChildren===1&&i.children[R].segments.length===0){let t=hn(i.children[R],e,o);return new S(i.segments,t.children)}return Object.entries(n).forEach(([t,r])=>{typeof r=="string"&&(r=[r]),r!==null&&(a[t]=Uo(i.children[t],e,r))}),Object.entries(i.children).forEach(([t,r])=>{n[t]===void 0&&(a[t]=r)}),new S(i.segments,a)}}function Ar(i,e,o){let n=0,a=e,t={match:!1,pathIndex:0,commandIndex:0};for(;a<i.segments.length;){if(n>=o.length)return t;let r=i.segments[a],s=o[n];if(Rn(s))break;let l=`${s}`,c=n<o.length-1?o[n+1]:null;if(a>0&&l===void 0)break;if(l&&c&&typeof c=="object"&&c.outlets===void 0){if(!xo(l,c,r))return t;n+=2}else{if(!xo(l,{},r))return t;n++}a++}return{match:!0,pathIndex:a,commandIndex:n}}function oa(i,e,o){let n=i.segments.slice(0,e),a=0;for(;a<o.length;){let t=o[a];if(Rn(t)){let l=vr(t.outlets);return new S(n,l)}if(a===0&&Qn(o[0])){let l=i.segments[e];n.push(new pe(l.path,vo(o[0]))),a++;continue}let r=Rn(t)?t.outlets[R]:`${t}`,s=a<o.length-1?o[a+1]:null;r&&s&&Qn(s)?(n.push(new pe(r,vo(s))),a+=2):(n.push(new pe(r,{})),a++)}return new S(n,{})}function vr(i){let e={};return Object.entries(i).forEach(([o,n])=>{typeof n=="string"&&(n=[n]),n!==null&&(e[o]=oa(new S([],{}),0,n))}),e}function vo(i){let e={};return Object.entries(i).forEach(([o,n])=>e[o]=`${n}`),e}function xo(i,e,o){return i==o.path&&ee(e,o.parameters)}var pn="imperative",H=(function(i){return i[i.NavigationStart=0]="NavigationStart",i[i.NavigationEnd=1]="NavigationEnd",i[i.NavigationCancel=2]="NavigationCancel",i[i.NavigationError=3]="NavigationError",i[i.RoutesRecognized=4]="RoutesRecognized",i[i.ResolveStart=5]="ResolveStart",i[i.ResolveEnd=6]="ResolveEnd",i[i.GuardsCheckStart=7]="GuardsCheckStart",i[i.GuardsCheckEnd=8]="GuardsCheckEnd",i[i.RouteConfigLoadStart=9]="RouteConfigLoadStart",i[i.RouteConfigLoadEnd=10]="RouteConfigLoadEnd",i[i.ChildActivationStart=11]="ChildActivationStart",i[i.ChildActivationEnd=12]="ChildActivationEnd",i[i.ActivationStart=13]="ActivationStart",i[i.ActivationEnd=14]="ActivationEnd",i[i.Scroll=15]="Scroll",i[i.NavigationSkipped=16]="NavigationSkipped",i})(H||{}),J=class{id;url;constructor(e,o){this.id=e,this.url=o}},we=class extends J{type=H.NavigationStart;navigationTrigger;restoredState;constructor(e,o,n="imperative",a=null){super(e,o),this.navigationTrigger=n,this.restoredState=a}toString(){return`NavigationStart(id: ${this.id}, url: '${this.url}')`}},te=class extends J{urlAfterRedirects;type=H.NavigationEnd;constructor(e,o,n){super(e,o),this.urlAfterRedirects=n}toString(){return`NavigationEnd(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}')`}},L=(function(i){return i[i.Redirect=0]="Redirect",i[i.SupersededByNewNavigation=1]="SupersededByNewNavigation",i[i.NoDataFromResolver=2]="NoDataFromResolver",i[i.GuardRejected=3]="GuardRejected",i[i.Aborted=4]="Aborted",i})(L||{}),kn=(function(i){return i[i.IgnoredSameUrlNavigation=0]="IgnoredSameUrlNavigation",i[i.IgnoredByUrlHandlingStrategy=1]="IgnoredByUrlHandlingStrategy",i})(kn||{}),q=class extends J{reason;code;type=H.NavigationCancel;constructor(e,o,n,a){super(e,o),this.reason=n,this.code=a}toString(){return`NavigationCancel(id: ${this.id}, url: '${this.url}')`}};function jo(i){return i instanceof q&&(i.code===L.Redirect||i.code===L.SupersededByNewNavigation)}var re=class extends J{reason;code;type=H.NavigationSkipped;constructor(e,o,n,a){super(e,o),this.reason=n,this.code=a}},Te=class extends J{error;target;type=H.NavigationError;constructor(e,o,n,a){super(e,o),this.error=n,this.target=a}toString(){return`NavigationError(id: ${this.id}, url: '${this.url}', error: ${this.error})`}},Je=class extends J{urlAfterRedirects;state;type=H.RoutesRecognized;constructor(e,o,n,a){super(e,o),this.urlAfterRedirects=n,this.state=a}toString(){return`RoutesRecognized(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}', state: ${this.state})`}},ei=class extends J{urlAfterRedirects;state;type=H.GuardsCheckStart;constructor(e,o,n,a){super(e,o),this.urlAfterRedirects=n,this.state=a}toString(){return`GuardsCheckStart(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}', state: ${this.state})`}},ni=class extends J{urlAfterRedirects;state;shouldActivate;type=H.GuardsCheckEnd;constructor(e,o,n,a,t){super(e,o),this.urlAfterRedirects=n,this.state=a,this.shouldActivate=t}toString(){return`GuardsCheckEnd(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}', state: ${this.state}, shouldActivate: ${this.shouldActivate})`}},ii=class extends J{urlAfterRedirects;state;type=H.ResolveStart;constructor(e,o,n,a){super(e,o),this.urlAfterRedirects=n,this.state=a}toString(){return`ResolveStart(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}', state: ${this.state})`}},ai=class extends J{urlAfterRedirects;state;type=H.ResolveEnd;constructor(e,o,n,a){super(e,o),this.urlAfterRedirects=n,this.state=a}toString(){return`ResolveEnd(id: ${this.id}, url: '${this.url}', urlAfterRedirects: '${this.urlAfterRedirects}', state: ${this.state})`}},oi=class{route;type=H.RouteConfigLoadStart;constructor(e){this.route=e}toString(){return`RouteConfigLoadStart(path: ${this.route.path})`}},ti=class{route;type=H.RouteConfigLoadEnd;constructor(e){this.route=e}toString(){return`RouteConfigLoadEnd(path: ${this.route.path})`}},ri=class{snapshot;type=H.ChildActivationStart;constructor(e){this.snapshot=e}toString(){return`ChildActivationStart(path: '${this.snapshot.routeConfig&&this.snapshot.routeConfig.path||""}')`}},si=class{snapshot;type=H.ChildActivationEnd;constructor(e){this.snapshot=e}toString(){return`ChildActivationEnd(path: '${this.snapshot.routeConfig&&this.snapshot.routeConfig.path||""}')`}},li=class{snapshot;type=H.ActivationStart;constructor(e){this.snapshot=e}toString(){return`ActivationStart(path: '${this.snapshot.routeConfig&&this.snapshot.routeConfig.path||""}')`}},ci=class{snapshot;type=H.ActivationEnd;constructor(e){this.snapshot=e}toString(){return`ActivationEnd(path: '${this.snapshot.routeConfig&&this.snapshot.routeConfig.path||""}')`}};var Ve=class{},We=class{url;navigationBehaviorOptions;constructor(e,o){this.url=e,this.navigationBehaviorOptions=o}};function xr(i){return!(i instanceof Ve)&&!(i instanceof We)}var di=class{rootInjector;outlet=null;route=null;children;attachRef=null;get injector(){return this.route?.snapshot._environmentInjector??this.rootInjector}constructor(e){this.rootInjector=e,this.children=new _e(this.rootInjector)}},_e=(()=>{let e=class e{rootInjector;contexts=new Map;constructor(n){this.rootInjector=n}onChildOutletCreated(n,a){let t=this.getOrCreateContext(n);t.outlet=a,this.contexts.set(n,t)}onChildOutletDestroyed(n){let a=this.getContext(n);a&&(a.outlet=null,a.attachRef=null)}onOutletDeactivated(){let n=this.contexts;return this.contexts=new Map,n}onOutletReAttached(n){this.contexts=n}getOrCreateContext(n){let a=this.getContext(n);return a||(a=new di(this.rootInjector),this.contexts.set(n,a)),a}getContext(n){return this.contexts.get(n)||null}};u(e,"\u0275fac",function(a){return new(a||e)(D(Me))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})(),ui=class{_root;constructor(e){this._root=e}get root(){return this._root.value}parent(e){let o=this.pathFromRoot(e);return o.length>1?o[o.length-2]:null}children(e){let o=ta(e,this._root);return o?o.children.map(n=>n.value):[]}firstChild(e){let o=ta(e,this._root);return o&&o.children.length>0?o.children[0].value:null}siblings(e){let o=ra(e,this._root);return o.length<2?[]:o[o.length-2].children.map(a=>a.value).filter(a=>a!==e)}pathFromRoot(e){return ra(e,this._root).map(o=>o.value)}};function ta(i,e){if(i===e.value)return e;for(let o of e.children){let n=ta(i,o);if(n)return n}return null}function ra(i,e){if(i===e.value)return[e];for(let o of e.children){let n=ra(i,o);if(n.length)return n.unshift(e),n}return[]}var z=class{value;children;constructor(e,o){this.value=e,this.children=o}toString(){return`TreeNode(${this.value})`}};function Ie(i){let e={};return i&&i.children.forEach(o=>e[o.value.outlet]=o),e}var fn=class extends ui{snapshot;constructor(e,o){super(e),this.snapshot=o,pa(this,e)}toString(){return this.snapshot.toString()}};function _o(i,e){let o=Cr(i,e),n=new O([new pe("",{})]),a=new O({}),t=new O({}),r=new O({}),s=new O(""),l=new Re(n,a,r,s,t,R,i,o.root);return l.snapshot=o.root,new fn(new z(l,[]),o)}function Cr(i,e){let o={},n={},a={},r=new Ce([],o,a,"",n,R,i,null,{},e);return new Mn("",new z(r,[]))}var Re=class{urlSubject;paramsSubject;queryParamsSubject;fragmentSubject;dataSubject;outlet;component;snapshot;_futureSnapshot;_routerState;_paramMap;_queryParamMap;title;url;params;queryParams;fragment;data;constructor(e,o,n,a,t,r,s,l){this.urlSubject=e,this.paramsSubject=o,this.queryParamsSubject=n,this.fragmentSubject=a,this.dataSubject=t,this.outlet=r,this.component=s,this._futureSnapshot=l,this.title=this.dataSubject?.pipe(B(c=>c[yn]))??M(void 0),this.url=e,this.params=o,this.queryParams=n,this.fragment=a,this.data=t}get routeConfig(){return this._futureSnapshot.routeConfig}get root(){return this._routerState.root}get parent(){return this._routerState.parent(this)}get firstChild(){return this._routerState.firstChild(this)}get children(){return this._routerState.children(this)}get pathFromRoot(){return this._routerState.pathFromRoot(this)}get paramMap(){return this._paramMap??=this.params.pipe(B(e=>be(e))),this._paramMap}get queryParamMap(){return this._queryParamMap??=this.queryParams.pipe(B(e=>be(e))),this._queryParamMap}toString(){return this.snapshot?this.snapshot.toString():`Future(${this._futureSnapshot})`}};function mi(i,e,o="emptyOnly"){let n,{routeConfig:a}=i;return e!==null&&(o==="always"||a?.path===""||!e.component&&!e.routeConfig?.loadComponent)?n={params:h(h({},e.params),i.params),data:h(h({},e.data),i.data),resolve:h(h(h(h({},i.data),e.data),a?.data),i._resolvedData)}:n={params:h({},i.params),data:h({},i.data),resolve:h(h({},i.data),i._resolvedData??{})},a&&Yo(a)&&(n.resolve[yn]=a.title),n}var Ce=class{url;params;queryParams;fragment;data;outlet;component;routeConfig;_resolve;_resolvedData;_routerState;_paramMap;_queryParamMap;_environmentInjector;get title(){return this.data?.[yn]}constructor(e,o,n,a,t,r,s,l,c,d){this.url=e,this.params=o,this.queryParams=n,this.fragment=a,this.data=t,this.outlet=r,this.component=s,this.routeConfig=l,this._resolve=c,this._environmentInjector=d}get root(){return this._routerState.root}get parent(){return this._routerState.parent(this)}get firstChild(){return this._routerState.firstChild(this)}get children(){return this._routerState.children(this)}get pathFromRoot(){return this._routerState.pathFromRoot(this)}get paramMap(){return this._paramMap??=be(this.params),this._paramMap}get queryParamMap(){return this._queryParamMap??=be(this.queryParams),this._queryParamMap}toString(){let e=this.url.map(n=>n.toString()).join("/"),o=this.routeConfig?this.routeConfig.path:"";return`Route(url:'${e}', path:'${o}')`}},Mn=class extends ui{url;constructor(e,o){super(o),this.url=e,pa(this,o)}toString(){return qo(this._root)}};function pa(i,e){e.value._routerState=i,e.children.forEach(o=>pa(i,o))}function qo(i){let e=i.children.length>0?` { ${i.children.map(qo).join(", ")} } `:"";return`${i.value}${e}`}function Xi(i){if(i.snapshot){let e=i.snapshot,o=i._futureSnapshot;i.snapshot=o,ee(e.queryParams,o.queryParams)||i.queryParamsSubject.next(o.queryParams),e.fragment!==o.fragment&&i.fragmentSubject.next(o.fragment),ee(e.params,o.params)||i.paramsSubject.next(o.params),er(e.url,o.url)||i.urlSubject.next(o.url),ee(e.data,o.data)||i.dataSubject.next(o.data)}else i.snapshot=i._futureSnapshot,i.dataSubject.next(i._futureSnapshot.data)}function sa(i,e){let o=ee(i.params,e.params)&&tr(i.url,e.url),n=!i.parent!=!e.parent;return o&&!n&&(!i.parent||sa(i.parent,e.parent))}function Yo(i){return typeof i.title=="string"||i.title===null}var Zo=new E(""),vn=(()=>{let e=class e{activated=null;get activatedComponentRef(){return this.activated}_activatedRoute=null;name=R;activateEvents=new Le;deactivateEvents=new Le;attachEvents=new Le;detachEvents=new Le;routerOutletData=eo();parentContexts=m(_e);location=m(Ni);changeDetector=m(on);inputBinder=m(Ri,{optional:!0});supportsBindingToComponentInputs=!0;ngOnChanges(n){if(n.name){let{firstChange:a,previousValue:t}=n.name;if(a)return;this.isTrackedInParentContexts(t)&&(this.deactivate(),this.parentContexts.onChildOutletDestroyed(t)),this.initializeOutletWithName()}}ngOnDestroy(){this.isTrackedInParentContexts(this.name)&&this.parentContexts.onChildOutletDestroyed(this.name),this.inputBinder?.unsubscribeFromRouteData(this)}isTrackedInParentContexts(n){return this.parentContexts.getContext(n)?.outlet===this}ngOnInit(){this.initializeOutletWithName()}initializeOutletWithName(){if(this.parentContexts.onChildOutletCreated(this.name,this),this.activated)return;let n=this.parentContexts.getContext(this.name);n?.route&&(n.attachRef?this.attach(n.attachRef,n.route):this.activateWith(n.route,n.injector))}get isActivated(){return!!this.activated}get component(){if(!this.activated)throw new T(4012,!1);return this.activated.instance}get activatedRoute(){if(!this.activated)throw new T(4012,!1);return this._activatedRoute}get activatedRouteData(){return this._activatedRoute?this._activatedRoute.snapshot.data:{}}detach(){if(!this.activated)throw new T(4012,!1);this.location.detach();let n=this.activated;return this.activated=null,this._activatedRoute=null,this.detachEvents.emit(n.instance),n}attach(n,a){this.activated=n,this._activatedRoute=a,this.location.insert(n.hostView),this.inputBinder?.bindActivatedRouteToOutletComponent(this),this.attachEvents.emit(n.instance)}deactivate(){if(this.activated){let n=this.component;this.activated.destroy(),this.activated=null,this._activatedRoute=null,this.deactivateEvents.emit(n)}}activateWith(n,a){if(this.isActivated)throw new T(4013,!1);this._activatedRoute=n;let t=this.location,s=n.snapshot.component,l=this.parentContexts.getOrCreateContext(this.name).children,c=new la(n,l,t.injector,this.routerOutletData);this.activated=t.createComponent(s,{index:t.length,injector:c,environmentInjector:a}),this.changeDetector.markForCheck(),this.inputBinder?.bindActivatedRouteToOutletComponent(this),this.activateEvents.emit(this.activated.instance)}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275dir",Ii({type:e,selectors:[["router-outlet"]],inputs:{name:"name",routerOutletData:[1,"routerOutletData"]},outputs:{activateEvents:"activate",deactivateEvents:"deactivate",attachEvents:"attach",detachEvents:"detach"},exportAs:["outlet"],features:[Ei]}));let i=e;return i})(),la=class{route;childContexts;parent;outletData;constructor(e,o,n,a){this.route=e,this.childContexts=o,this.parent=n,this.outletData=a}get(e,o){return e===Re?this.route:e===_e?this.childContexts:e===Zo?this.outletData:this.parent.get(e,o)}},Ri=new E("");var ga=(()=>{let e=class e{};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275cmp",U({type:e,selectors:[["ng-component"]],exportAs:["emptyRouterOutlet"],decls:1,vars:0,template:function(a,t){a&1&&_(0,"router-outlet")},dependencies:[vn],encapsulation:2}));let i=e;return i})();function Ra(i){let e=i.children&&i.children.map(Ra),o=e?w(h({},i),{children:e}):h({},i);return!o.component&&!o.loadComponent&&(e||o.loadChildren)&&o.outlet&&o.outlet!==R&&(o.component=ga),o}function br(i,e,o){let n=Sn(i,e._root,o?o._root:void 0);return new fn(n,e)}function Sn(i,e,o){if(o&&i.shouldReuseRoute(e.value,o.value.snapshot)){let n=o.value;n._futureSnapshot=e.value;let a=wr(i,e,o);return new z(n,a)}else{if(i.shouldAttach(e.value)){let t=i.retrieve(e.value);if(t!==null){let r=t.route;return r.value._futureSnapshot=e.value,r.children=e.children.map(s=>Sn(i,s)),r}}let n=Tr(e.value),a=e.children.map(t=>Sn(i,t));return new z(n,a)}}function wr(i,e,o){return e.children.map(n=>{for(let a of o.children)if(i.shouldReuseRoute(n.value,a.value.snapshot))return Sn(i,n,a);return Sn(i,n)})}function Tr(i){return new Re(new O(i.url),new O(i.params),new O(i.queryParams),new O(i.fragment),new O(i.data),i.outlet,i.component,i)}var Ue=class{redirectTo;navigationBehaviorOptions;constructor(e,o){this.redirectTo=e,this.navigationBehaviorOptions=o}},$o="ngNavigationCancelingError";function hi(i,e){let{redirectTo:o,navigationBehaviorOptions:n}=ze(e)?{redirectTo:e,navigationBehaviorOptions:void 0}:e,a=Qo(!1,L.Redirect);return a.url=o,a.navigationBehaviorOptions=n,a}function Qo(i,e){let o=new Error(`NavigationCancelingError: ${i||""}`);return o[$o]=!0,o.cancellationCode=e,o}function Pr(i){return Xo(i)&&ze(i.url)}function Xo(i){return!!i&&i[$o]}var ca=class{routeReuseStrategy;futureState;currState;forwardEvent;inputBindingEnabled;constructor(e,o,n,a,t){this.routeReuseStrategy=e,this.futureState=o,this.currState=n,this.forwardEvent=a,this.inputBindingEnabled=t}activate(e){let o=this.futureState._root,n=this.currState?this.currState._root:null;this.deactivateChildRoutes(o,n,e),Xi(this.futureState.root),this.activateChildRoutes(o,n,e)}deactivateChildRoutes(e,o,n){let a=Ie(o);e.children.forEach(t=>{let r=t.value.outlet;this.deactivateRoutes(t,a[r],n),delete a[r]}),Object.values(a).forEach(t=>{this.deactivateRouteAndItsChildren(t,n)})}deactivateRoutes(e,o,n){let a=e.value,t=o?o.value:null;if(a===t)if(a.component){let r=n.getContext(a.outlet);r&&this.deactivateChildRoutes(e,o,r.children)}else this.deactivateChildRoutes(e,o,n);else t&&this.deactivateRouteAndItsChildren(o,n)}deactivateRouteAndItsChildren(e,o){e.value.component&&this.routeReuseStrategy.shouldDetach(e.value.snapshot)?this.detachAndStoreRouteSubtree(e,o):this.deactivateRouteAndOutlet(e,o)}detachAndStoreRouteSubtree(e,o){let n=o.getContext(e.value.outlet),a=n&&e.value.component?n.children:o,t=Ie(e);for(let r of Object.values(t))this.deactivateRouteAndItsChildren(r,a);if(n&&n.outlet){let r=n.outlet.detach(),s=n.children.onOutletDeactivated();this.routeReuseStrategy.store(e.value.snapshot,{componentRef:r,route:e,contexts:s})}}deactivateRouteAndOutlet(e,o){let n=o.getContext(e.value.outlet),a=n&&e.value.component?n.children:o,t=Ie(e);for(let r of Object.values(t))this.deactivateRouteAndItsChildren(r,a);n&&(n.outlet&&(n.outlet.deactivate(),n.children.onOutletDeactivated()),n.attachRef=null,n.route=null)}activateChildRoutes(e,o,n){let a=Ie(o);e.children.forEach(t=>{this.activateRoutes(t,a[t.value.outlet],n),this.forwardEvent(new ci(t.value.snapshot))}),e.children.length&&this.forwardEvent(new si(e.value.snapshot))}activateRoutes(e,o,n){let a=e.value,t=o?o.value:null;if(Xi(a),a===t)if(a.component){let r=n.getOrCreateContext(a.outlet);this.activateChildRoutes(e,o,r.children)}else this.activateChildRoutes(e,o,n);else if(a.component){let r=n.getOrCreateContext(a.outlet);if(this.routeReuseStrategy.shouldAttach(a.snapshot)){let s=this.routeReuseStrategy.retrieve(a.snapshot);this.routeReuseStrategy.store(a.snapshot,null),r.children.onOutletReAttached(s.contexts),r.attachRef=s.componentRef,r.route=s.route.value,r.outlet&&r.outlet.attach(s.componentRef,s.route.value),Xi(s.route.value),this.activateChildRoutes(e,null,r.children)}else r.attachRef=null,r.route=a,r.outlet&&r.outlet.activateWith(a,r.injector),this.activateChildRoutes(e,null,r.children)}else this.activateChildRoutes(e,null,n)}},pi=class{path;route;constructor(e){this.path=e,this.route=this.path[this.path.length-1]}},Ke=class{component;route;constructor(e,o){this.component=e,this.route=o}};function Er(i,e,o){let n=i._root,a=e?e._root:null;return mn(n,a,o,[n.value])}function Hr(i){let e=i.routeConfig?i.routeConfig.canActivateChild:null;return!e||e.length===0?null:{node:i,guards:e}}function qe(i,e){let o=Symbol(),n=e.get(i,o);return n===o?typeof i=="function"&&!Ha(i)?i:e.get(i):n}function mn(i,e,o,n,a={canDeactivateChecks:[],canActivateChecks:[]}){let t=Ie(e);return i.children.forEach(r=>{Lr(r,t[r.value.outlet],o,n.concat([r.value]),a),delete t[r.value.outlet]}),Object.entries(t).forEach(([r,s])=>gn(s,o.getContext(r),a)),a}function Lr(i,e,o,n,a={canDeactivateChecks:[],canActivateChecks:[]}){let t=i.value,r=e?e.value:null,s=o?o.getContext(i.value.outlet):null;if(r&&t.routeConfig===r.routeConfig){let l=Br(r,t,t.routeConfig.runGuardsAndResolvers);l?a.canActivateChecks.push(new pi(n)):(t.data=r.data,t._resolvedData=r._resolvedData),t.component?mn(i,e,s?s.children:null,n,a):mn(i,e,o,n,a),l&&s&&s.outlet&&s.outlet.isActivated&&a.canDeactivateChecks.push(new Ke(s.outlet.component,r))}else r&&gn(e,s,a),a.canActivateChecks.push(new pi(n)),t.component?mn(i,null,s?s.children:null,n,a):mn(i,null,o,n,a);return a}function Br(i,e,o){if(typeof o=="function")return W(e._environmentInjector,()=>o(i,e));switch(o){case"pathParamsChange":return!xe(i.url,e.url);case"pathParamsOrQueryParamsChange":return!xe(i.url,e.url)||!ee(i.queryParams,e.queryParams);case"always":return!0;case"paramsOrQueryParamsChange":return!sa(i,e)||!ee(i.queryParams,e.queryParams);default:return!sa(i,e)}}function gn(i,e,o){let n=Ie(i),a=i.value;Object.entries(n).forEach(([t,r])=>{a.component?e?gn(r,e.children.getContext(t),o):gn(r,null,o):gn(r,e,o)}),a.component?e&&e.outlet&&e.outlet.isActivated?o.canDeactivateChecks.push(new Ke(e.outlet.component,a)):o.canDeactivateChecks.push(new Ke(null,a)):o.canDeactivateChecks.push(new Ke(null,a))}function xn(i){return typeof i=="function"}function Fr(i){return typeof i=="boolean"}function Nr(i){return i&&xn(i.canLoad)}function Or(i){return i&&xn(i.canActivate)}function Ir(i){return i&&xn(i.canActivateChild)}function Gr(i){return i&&xn(i.canDeactivate)}function Kr(i){return i&&xn(i.canMatch)}function et(i){return i instanceof Ca||i?.name==="EmptyError"}var _n=Symbol("INITIAL_VALUE");function je(){return de(i=>ba(i.map(e=>e.pipe(He(1),Pa(_n)))).pipe(B(e=>{for(let o of e)if(o!==!0){if(o===_n)return _n;if(o===!1||zr(o))return o}return!0}),Ee(e=>e!==_n),He(1)))}function zr(i){return ze(i)||i instanceof Ue}function nt(i){return i.aborted?M(void 0).pipe(He(1)):new va(e=>{let o=()=>{e.next(),e.complete()};return i.addEventListener("abort",o),()=>i.removeEventListener("abort",o)})}function it(i){return En(nt(i))}function Jr(i){return le(e=>{let{targetSnapshot:o,currentSnapshot:n,guards:{canActivateChecks:a,canDeactivateChecks:t}}=e;return t.length===0&&a.length===0?M(w(h({},e),{guardsResult:!0})):Vr(t,o,n).pipe(le(r=>r&&Fr(r)?Wr(o,a,i):M(r)),B(r=>w(h({},e),{guardsResult:r})))})}function Vr(i,e,o){return $(i).pipe(le(n=>Yr(n.component,n.route,o,e)),ce(n=>n!==!0,!0))}function Wr(i,e,o){return $(e).pipe(Ci(n=>wa(jr(n.route.parent,o),Ur(n.route,o),qr(i,n.path),_r(i,n.route))),ce(n=>n!==!0,!0))}function Ur(i,e){return i!==null&&e&&e(new li(i)),M(!0)}function jr(i,e){return i!==null&&e&&e(new ri(i)),M(!0)}function _r(i,e){let o=e.routeConfig?e.routeConfig.canActivate:null;if(!o||o.length===0)return M(!0);let n=o.map(a=>Pn(()=>{let t=e._environmentInjector,r=qe(a,t),s=Or(r)?r.canActivate(e,i):W(t,()=>r(e,i));return Pe(s).pipe(ce())}));return M(n).pipe(je())}function qr(i,e){let o=e[e.length-1],a=e.slice(0,e.length-1).reverse().map(t=>Hr(t)).filter(t=>t!==null).map(t=>Pn(()=>{let r=t.guards.map(s=>{let l=t.node._environmentInjector,c=qe(s,l),d=Ir(c)?c.canActivateChild(o,i):W(l,()=>c(o,i));return Pe(d).pipe(ce())});return M(r).pipe(je())}));return M(a).pipe(je())}function Yr(i,e,o,n){let a=e&&e.routeConfig?e.routeConfig.canDeactivate:null;if(!a||a.length===0)return M(!0);let t=a.map(r=>{let s=e._environmentInjector,l=qe(r,s),c=Gr(l)?l.canDeactivate(i,e,o,n):W(s,()=>l(i,e,o,n));return Pe(c).pipe(ce())});return M(t).pipe(je())}function Zr(i,e,o,n,a){let t=e.canLoad;if(t===void 0||t.length===0)return M(!0);let r=t.map(s=>{let l=qe(s,i),c=Nr(l)?l.canLoad(e,o):W(i,()=>l(e,o)),d=Pe(c);return a?d.pipe(it(a)):d});return M(r).pipe(je(),at(n))}function at(i){return Aa(ne(e=>{if(typeof e!="boolean")throw hi(i,e)}),B(e=>e===!0))}function $r(i,e,o,n,a){let t=e.canMatch;if(!t||t.length===0)return M(!0);let r=t.map(s=>{let l=qe(s,i),c=Kr(l)?l.canMatch(e,o):W(i,()=>l(e,o));return Pe(c).pipe(it(a))});return M(r).pipe(je(),at(n))}var oe=class i extends Error{segmentGroup;constructor(e){super(),this.segmentGroup=e||null,Object.setPrototypeOf(this,i.prototype)}},Dn=class i extends Error{urlTree;constructor(e){super(),this.urlTree=e,Object.setPrototypeOf(this,i.prototype)}};function Qr(i){throw new T(4e3,!1)}function Xr(i){throw Qo(!1,L.GuardRejected)}var da=class{urlSerializer;urlTree;constructor(e,o){this.urlSerializer=e,this.urlTree=o}lineralizeSegments(e,o){return b(this,null,function*(){let n=[],a=o.root;for(;;){if(n=n.concat(a.segments),a.numberOfChildren===0)return n;if(a.numberOfChildren>1||!a.children[R])throw Qr(`${e.redirectTo}`);a=a.children[R]}})}applyRedirectCommands(e,o,n,a,t){return b(this,null,function*(){let r=yield es(o,a,t);if(r instanceof Z)throw new Dn(r);let s=this.applyRedirectCreateUrlTree(r,this.urlSerializer.parse(r),e,n);if(r[0]==="/")throw new Dn(s);return s})}applyRedirectCreateUrlTree(e,o,n,a){let t=this.createSegmentGroup(e,o.root,n,a);return new Z(t,this.createQueryParams(o.queryParams,this.urlTree.queryParams),o.fragment)}createQueryParams(e,o){let n={};return Object.entries(e).forEach(([a,t])=>{if(typeof t=="string"&&t[0]===":"){let s=t.substring(1);n[a]=o[s]}else n[a]=t}),n}createSegmentGroup(e,o,n,a){let t=this.createSegments(e,o.segments,n,a),r={};return Object.entries(o.children).forEach(([s,l])=>{r[s]=this.createSegmentGroup(e,l,n,a)}),new S(t,r)}createSegments(e,o,n,a){return o.map(t=>t.path[0]===":"?this.findPosParam(e,t,a):this.findOrReturn(t,n))}findPosParam(e,o,n){let a=n[o.path.substring(1)];if(!a)throw new T(4001,!1);return a}findOrReturn(e,o){let n=0;for(let a of o){if(a.path===e.path)return o.splice(n),a;n++}return e}};function es(i,e,o){if(typeof i=="string")return Promise.resolve(i);let n=i,{queryParams:a,fragment:t,routeConfig:r,url:s,outlet:l,params:c,data:d,title:g,paramMap:p,queryParamMap:f}=e;return $n(Pe(W(o,()=>n({params:c,data:d,queryParams:a,fragment:t,routeConfig:r,url:s,outlet:l,title:g,paramMap:p,queryParamMap:f}))))}function ns(i,e){return i.providers&&!i._injector&&(i._injector=Oi(i.providers,e,`Route: ${i.path}`)),i._injector??e}function Y(i){return i.outlet||R}function is(i,e){let o=i.filter(n=>Y(n)===e);return o.push(...i.filter(n=>Y(n)!==e)),o}var ua={matched:!1,consumedSegments:[],remainingSegments:[],parameters:{},positionalParamSegments:{}};function as(i,e,o,n,a,t){let r=ot(i,e,o);return r.matched?(n=ns(e,n),$r(n,e,o,a,t).pipe(B(s=>s===!0?r:h({},ua)))):M(r)}function ot(i,e,o){if(e.path==="")return e.pathMatch==="full"&&(i.hasChildren()||o.length>0)?h({},ua):{matched:!0,consumedSegments:[],remainingSegments:o,parameters:{},positionalParamSegments:{}};let a=(e.matcher||Po)(o,i,e);if(!a)return h({},ua);let t={};Object.entries(a.posParams??{}).forEach(([s,l])=>{t[s]=l.path});let r=a.consumed.length>0?h(h({},t),a.consumed[a.consumed.length-1].parameters):t;return{matched:!0,consumedSegments:a.consumed,remainingSegments:o.slice(a.consumed.length),parameters:r,positionalParamSegments:a.posParams??{}}}function Co(i,e,o,n){return o.length>0&&rs(i,o,n)?{segmentGroup:new S(e,ts(n,new S(o,i.children))),slicedSegments:[]}:o.length===0&&ss(i,o,n)?{segmentGroup:new S(i.segments,os(i,o,n,i.children)),slicedSegments:o}:{segmentGroup:new S(i.segments,i.children),slicedSegments:o}}function os(i,e,o,n){let a={};for(let t of o)if(ki(i,e,t)&&!n[Y(t)]){let r=new S([],{});a[Y(t)]=r}return h(h({},n),a)}function ts(i,e){let o={};o[R]=e;for(let n of i)if(n.path===""&&Y(n)!==R){let a=new S([],{});o[Y(n)]=a}return o}function rs(i,e,o){return o.some(n=>ki(i,e,n)&&Y(n)!==R)}function ss(i,e,o){return o.some(n=>ki(i,e,n))}function ki(i,e,o){return(i.hasChildren()||e.length>0)&&o.pathMatch==="full"?!1:o.path===""}function ls(i,e,o){return e.length===0&&!i.children[o]}var ma=class{};function cs(i,e,o,n,a,t,r="emptyOnly",s){return b(this,null,function*(){return new ha(i,e,o,n,a,r,t,s).recognize()})}var ds=31,ha=class{injector;configLoader;rootComponentType;config;urlTree;paramsInheritanceStrategy;urlSerializer;abortSignal;applyRedirects;absoluteRedirectCount=0;allowRedirects=!0;constructor(e,o,n,a,t,r,s,l){this.injector=e,this.configLoader=o,this.rootComponentType=n,this.config=a,this.urlTree=t,this.paramsInheritanceStrategy=r,this.urlSerializer=s,this.abortSignal=l,this.applyRedirects=new da(this.urlSerializer,this.urlTree)}noMatchError(e){return new T(4002,`'${e.segmentGroup}'`)}recognize(){return b(this,null,function*(){let e=Co(this.urlTree.root,[],[],this.config).segmentGroup,{children:o,rootSnapshot:n}=yield this.match(e),a=new z(n,o),t=new Mn("",a),r=zo(n,[],this.urlTree.queryParams,this.urlTree.fragment);return r.queryParams=this.urlTree.queryParams,t.url=this.urlSerializer.serialize(r),{state:t,tree:r}})}match(e){return b(this,null,function*(){let o=new Ce([],Object.freeze({}),Object.freeze(h({},this.urlTree.queryParams)),this.urlTree.fragment,Object.freeze({}),R,this.rootComponentType,null,{},this.injector);try{return{children:yield this.processSegmentGroup(this.injector,this.config,e,R,o),rootSnapshot:o}}catch(n){if(n instanceof Dn)return this.urlTree=n.urlTree,this.match(n.urlTree.root);throw n instanceof oe?this.noMatchError(n):n}})}processSegmentGroup(e,o,n,a,t){return b(this,null,function*(){if(n.segments.length===0&&n.hasChildren())return this.processChildren(e,o,n,t);let r=yield this.processSegment(e,o,n,n.segments,a,!0,t);return r instanceof z?[r]:[]})}processChildren(e,o,n,a){return b(this,null,function*(){let t=[];for(let l of Object.keys(n.children))l==="primary"?t.unshift(l):t.push(l);let r=[];for(let l of t){let c=n.children[l],d=is(o,l),g=yield this.processSegmentGroup(e,d,c,l,a);r.push(...g)}let s=tt(r);return us(s),s})}processSegment(e,o,n,a,t,r,s){return b(this,null,function*(){for(let l of o)try{return yield this.processSegmentAgainstRoute(l._injector??e,o,l,n,a,t,r,s)}catch(c){if(c instanceof oe||et(c))continue;throw c}if(ls(n,a,t))return new ma;throw new oe(n)})}processSegmentAgainstRoute(e,o,n,a,t,r,s,l){return b(this,null,function*(){if(Y(n)!==r&&(r===R||!ki(a,t,n)))throw new oe(a);if(n.redirectTo===void 0)return this.matchSegmentAgainstRoute(e,a,n,t,r,l);if(this.allowRedirects&&s)return this.expandSegmentAgainstRouteUsingRedirect(e,a,o,n,t,r,l);throw new oe(a)})}expandSegmentAgainstRouteUsingRedirect(e,o,n,a,t,r,s){return b(this,null,function*(){let{matched:l,parameters:c,consumedSegments:d,positionalParamSegments:g,remainingSegments:p}=ot(o,a,t);if(!l)throw new oe(o);typeof a.redirectTo=="string"&&a.redirectTo[0]==="/"&&(this.absoluteRedirectCount++,this.absoluteRedirectCount>ds&&(this.allowRedirects=!1));let f=new Ce(t,c,Object.freeze(h({},this.urlTree.queryParams)),this.urlTree.fragment,bo(a),Y(a),a.component??a._loadedComponent??null,a,wo(a),e),x=mi(f,s,this.paramsInheritanceStrategy);if(f.params=Object.freeze(x.params),f.data=Object.freeze(x.data),this.abortSignal.aborted)throw new Error(this.abortSignal.reason);let ke=yield this.applyRedirects.applyRedirectCommands(d,a.redirectTo,g,f,e),fe=yield this.applyRedirects.lineralizeSegments(a,ke);return this.processSegment(e,n,o,fe.concat(p),r,!1,s)})}matchSegmentAgainstRoute(e,o,n,a,t,r){return b(this,null,function*(){if(this.abortSignal.aborted)throw new Error(this.abortSignal.reason);let s=yield $n(as(o,n,a,e,this.urlSerializer,this.abortSignal));if(n.path==="**"&&(o.children={}),!s?.matched)throw new oe(o);e=n._injector??e;let{routes:l}=yield this.getChildConfig(e,n,a),c=n._loadedInjector??e,{parameters:d,consumedSegments:g,remainingSegments:p}=s,f=new Ce(g,d,Object.freeze(h({},this.urlTree.queryParams)),this.urlTree.fragment,bo(n),Y(n),n.component??n._loadedComponent??null,n,wo(n),e),x=mi(f,r,this.paramsInheritanceStrategy);f.params=Object.freeze(x.params),f.data=Object.freeze(x.data);let{segmentGroup:ke,slicedSegments:fe}=Co(o,g,p,l);if(fe.length===0&&ke.hasChildren()){let Tn=yield this.processChildren(c,l,ke,f);return new z(f,Tn)}if(l.length===0&&fe.length===0)return new z(f,[]);let Ai=Y(n)===t,wn=yield this.processSegment(c,l,ke,fe,Ai?R:t,!0,f);return new z(f,wn instanceof z?[wn]:[])})}getChildConfig(e,o,n){return b(this,null,function*(){if(o.children)return{routes:o.children,injector:e};if(o.loadChildren){if(o._loadedRoutes!==void 0){let t=o._loadedNgModuleFactory;return t&&!o._loadedInjector&&(o._loadedInjector=t.create(e).injector),{routes:o._loadedRoutes,injector:o._loadedInjector}}if(this.abortSignal.aborted)throw new Error(this.abortSignal.reason);if(yield $n(Zr(e,o,n,this.urlSerializer,this.abortSignal))){let t=yield this.configLoader.loadChildren(e,o);return o._loadedRoutes=t.routes,o._loadedInjector=t.injector,o._loadedNgModuleFactory=t.factory,t}throw Xr(o)}return{routes:[],injector:e}})}};function us(i){i.sort((e,o)=>e.value.outlet===R?-1:o.value.outlet===R?1:e.value.outlet.localeCompare(o.value.outlet))}function ms(i){let e=i.value.routeConfig;return e&&e.path===""}function tt(i){let e=[],o=new Set;for(let n of i){if(!ms(n)){e.push(n);continue}let a=e.find(t=>n.value.routeConfig===t.value.routeConfig);a!==void 0?(a.children.push(...n.children),o.add(a)):e.push(n)}for(let n of o){let a=tt(n.children);e.push(new z(n.value,a))}return e.filter(n=>!o.has(n))}function bo(i){return i.data||{}}function wo(i){return i.resolve||{}}function hs(i,e,o,n,a,t,r){return le(s=>b(null,null,function*(){let{state:l,tree:c}=yield cs(i,e,o,n,s.extractedUrl,a,t,r);return w(h({},s),{targetSnapshot:l,urlAfterRedirects:c})}))}function ps(i){return le(e=>{let{targetSnapshot:o,guards:{canActivateChecks:n}}=e;if(!n.length)return M(e);let a=new Set(n.map(s=>s.route)),t=new Set;for(let s of a)if(!t.has(s))for(let l of rt(s))t.add(l);let r=0;return $(t).pipe(Ci(s=>a.has(s)?gs(s,o,i):(s.data=mi(s,s.parent,i).resolve,M(void 0))),ne(()=>r++),bi(1),le(s=>r===t.size?M(e):V))})}function rt(i){let e=i.children.map(o=>rt(o)).flat();return[i,...e]}function gs(i,e,o){let n=i.routeConfig,a=i._resolve;return n?.title!==void 0&&!Yo(n)&&(a[yn]=n.title),Pn(()=>(i.data=mi(i,i.parent,o).resolve,Rs(a,i,e).pipe(B(t=>(i._resolvedData=t,i.data=h(h({},i.data),t),null)))))}function Rs(i,e,o){let n=na(i);if(n.length===0)return M({});let a={};return $(n).pipe(le(t=>ks(i[t],e,o).pipe(ce(),ne(r=>{if(r instanceof Ue)throw hi(new ge,r);a[t]=r}))),bi(1),B(()=>a),xi(t=>et(t)?V:xa(t)))}function ks(i,e,o){let n=e._environmentInjector,a=qe(i,n),t=a.resolve?a.resolve(e,o):W(n,()=>a(e,o));return Pe(t)}function To(i){return de(e=>{let o=i(e);return o?$(o).pipe(B(()=>e)):M(e)})}var ka=(()=>{let e=class e{buildTitle(n){let a,t=n.root;for(;t!==void 0;)a=this.getResolvedTitleForRoute(t)??a,t=t.children.find(r=>r.outlet===R);return a}getResolvedTitleForRoute(n){return n.data[yn]}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(st),providedIn:"root"}));let i=e;return i})(),st=(()=>{let e=class e extends ka{title;constructor(n){super(),this.title=n}updateTitle(n){let a=this.buildTitle(n);a!==void 0&&this.title.setTitle(a)}};u(e,"\u0275fac",function(a){return new(a||e)(D(So))}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})(),Cn=new E("",{factory:()=>({})}),bn=new E(""),lt=(()=>{let e=class e{componentLoaders=new WeakMap;childrenLoaders=new WeakMap;onLoadStartListener;onLoadEndListener;compiler=m(Xa);loadComponent(n,a){return b(this,null,function*(){if(this.componentLoaders.get(a))return this.componentLoaders.get(a);if(a._loadedComponent)return Promise.resolve(a._loadedComponent);this.onLoadStartListener&&this.onLoadStartListener(a);let t=b(this,null,function*(){try{let r=yield Ho(W(n,()=>a.loadComponent())),s=yield ut(dt(r));return this.onLoadEndListener&&this.onLoadEndListener(a),a._loadedComponent=s,s}finally{this.componentLoaders.delete(a)}});return this.componentLoaders.set(a,t),t})}loadChildren(n,a){if(this.childrenLoaders.get(a))return this.childrenLoaders.get(a);if(a._loadedRoutes)return Promise.resolve({routes:a._loadedRoutes,injector:a._loadedInjector});this.onLoadStartListener&&this.onLoadStartListener(a);let t=b(this,null,function*(){try{let r=yield ct(a,this.compiler,n,this.onLoadEndListener);return a._loadedRoutes=r.routes,a._loadedInjector=r.injector,a._loadedNgModuleFactory=r.factory,r}finally{this.childrenLoaders.delete(a)}});return this.childrenLoaders.set(a,t),t}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})();function ct(i,e,o,n){return b(this,null,function*(){let a=yield Ho(W(o,()=>i.loadChildren())),t=yield ut(dt(a)),r;t instanceof Ja||Array.isArray(t)?r=t:r=yield e.compileModuleAsync(t),n&&n(i);let s,l,c=!1,d;return Array.isArray(r)?(l=r,c=!0):(s=r.create(o).injector,d=r,l=s.get(bn,[],{optional:!0,self:!0}).flat()),{routes:l.map(Ra),injector:s,factory:d}})}function fs(i){return i&&typeof i=="object"&&"default"in i}function dt(i){return fs(i)?i.default:i}function ut(i){return b(this,null,function*(){return i})}var fi=(()=>{let e=class e{};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(Ms),providedIn:"root"}));let i=e;return i})(),Ms=(()=>{let e=class e{shouldProcessUrl(n){return!0}extract(n){return n}merge(n,a){return n}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})(),mt=new E("");var Ss=()=>{},ht=new E(""),pt=(()=>{let e=class e{currentNavigation=Q(null,{equal:()=>!1});currentTransition=null;lastSuccessfulNavigation=Q(null);events=new se;transitionAbortWithErrorSubject=new se;configLoader=m(lt);environmentInjector=m(Me);destroyRef=m($e);urlSerializer=m(An);rootContexts=m(_e);location=m(Ne);inputBindingEnabled=m(Ri,{optional:!0})!==null;titleStrategy=m(ka);options=m(Cn,{optional:!0})||{};paramsInheritanceStrategy=this.options.paramsInheritanceStrategy||"emptyOnly";urlHandlingStrategy=m(fi);createViewTransition=m(mt,{optional:!0});navigationErrorHandler=m(ht,{optional:!0});navigationId=0;get hasRequestedNavigation(){return this.navigationId!==0}transitions;afterPreactivation=()=>M(void 0);rootComponentType=null;destroyed=!1;constructor(){let n=t=>this.events.next(new oi(t)),a=t=>this.events.next(new ti(t));this.configLoader.onLoadEndListener=a,this.configLoader.onLoadStartListener=n,this.destroyRef.onDestroy(()=>{this.destroyed=!0})}complete(){this.transitions?.complete()}handleNavigationRequest(n){let a=++this.navigationId;ie(()=>{this.transitions?.next(w(h({},n),{extractedUrl:this.urlHandlingStrategy.extract(n.rawUrl),targetSnapshot:null,targetRouterState:null,guards:{canActivateChecks:[],canDeactivateChecks:[]},guardsResult:null,id:a}))})}setupNavigations(n){return this.transitions=new O(null),this.transitions.pipe(Ee(a=>a!==null),de(a=>{let t=!1,r=new AbortController,s=()=>!t&&this.currentTransition?.id===a.id;return M(a).pipe(de(l=>{if(this.navigationId>a.id)return this.cancelNavigationTransition(a,"",L.SupersededByNewNavigation),V;this.currentTransition=a;let c=this.lastSuccessfulNavigation();this.currentNavigation.set({id:l.id,initialUrl:l.rawUrl,extractedUrl:l.extractedUrl,targetBrowserUrl:typeof l.extras.browserUrl=="string"?this.urlSerializer.parse(l.extras.browserUrl):l.extras.browserUrl,trigger:l.source,extras:l.extras,previousNavigation:c?w(h({},c),{previousNavigation:null}):null,abort:()=>r.abort()});let d=!n.navigated||this.isUpdatingInternalState()||this.isUpdatedBrowserUrl(),g=l.extras.onSameUrlNavigation??n.onSameUrlNavigation;if(!d&&g!=="reload")return this.events.next(new re(l.id,this.urlSerializer.serialize(l.rawUrl),"",kn.IgnoredSameUrlNavigation)),l.resolve(!1),V;if(this.urlHandlingStrategy.shouldProcessUrl(l.rawUrl))return M(l).pipe(de(p=>(this.events.next(new we(p.id,this.urlSerializer.serialize(p.extractedUrl),p.source,p.restoredState)),p.id!==this.navigationId?V:Promise.resolve(p))),hs(this.environmentInjector,this.configLoader,this.rootComponentType,n.config,this.urlSerializer,this.paramsInheritanceStrategy,r.signal),ne(p=>{a.targetSnapshot=p.targetSnapshot,a.urlAfterRedirects=p.urlAfterRedirects,this.currentNavigation.update(x=>(x.finalUrl=p.urlAfterRedirects,x));let f=new Je(p.id,this.urlSerializer.serialize(p.extractedUrl),this.urlSerializer.serialize(p.urlAfterRedirects),p.targetSnapshot);this.events.next(f)}));if(d&&this.urlHandlingStrategy.shouldProcessUrl(l.currentRawUrl)){let{id:p,extractedUrl:f,source:x,restoredState:ke,extras:fe}=l,Ai=new we(p,this.urlSerializer.serialize(f),x,ke);this.events.next(Ai);let wn=_o(this.rootComponentType,this.environmentInjector).snapshot;return this.currentTransition=a=w(h({},l),{targetSnapshot:wn,urlAfterRedirects:f,extras:w(h({},fe),{skipLocationChange:!1,replaceUrl:!1})}),this.currentNavigation.update(Tn=>(Tn.finalUrl=f,Tn)),M(a)}else return this.events.next(new re(l.id,this.urlSerializer.serialize(l.extractedUrl),"",kn.IgnoredByUrlHandlingStrategy)),l.resolve(!1),V}),B(l=>{let c=new ei(l.id,this.urlSerializer.serialize(l.extractedUrl),this.urlSerializer.serialize(l.urlAfterRedirects),l.targetSnapshot);return this.events.next(c),this.currentTransition=a=w(h({},l),{guards:Er(l.targetSnapshot,l.currentSnapshot,this.rootContexts)}),a}),Jr(l=>this.events.next(l)),de(l=>{if(a.guardsResult=l.guardsResult,l.guardsResult&&typeof l.guardsResult!="boolean")throw hi(this.urlSerializer,l.guardsResult);let c=new ni(l.id,this.urlSerializer.serialize(l.extractedUrl),this.urlSerializer.serialize(l.urlAfterRedirects),l.targetSnapshot,!!l.guardsResult);if(this.events.next(c),!s())return V;if(!l.guardsResult)return this.cancelNavigationTransition(l,"",L.GuardRejected),V;if(l.guards.canActivateChecks.length===0)return M(l);let d=new ii(l.id,this.urlSerializer.serialize(l.extractedUrl),this.urlSerializer.serialize(l.urlAfterRedirects),l.targetSnapshot);if(this.events.next(d),!s())return V;let g=!1;return M(l).pipe(ps(this.paramsInheritanceStrategy),ne({next:()=>{g=!0;let p=new ai(l.id,this.urlSerializer.serialize(l.extractedUrl),this.urlSerializer.serialize(l.urlAfterRedirects),l.targetSnapshot);this.events.next(p)},complete:()=>{g||this.cancelNavigationTransition(l,"",L.NoDataFromResolver)}}))}),To(l=>{let c=g=>{let p=[];if(g.routeConfig?._loadedComponent)g.component=g.routeConfig?._loadedComponent;else if(g.routeConfig?.loadComponent){let f=g._environmentInjector;p.push(this.configLoader.loadComponent(f,g.routeConfig).then(x=>{g.component=x}))}for(let f of g.children)p.push(...c(f));return p},d=c(l.targetSnapshot.root);return d.length===0?M(l):$(Promise.all(d).then(()=>l))}),To(()=>this.afterPreactivation()),de(()=>{let{currentSnapshot:l,targetSnapshot:c}=a,d=this.createViewTransition?.(this.environmentInjector,l.root,c.root);return d?$(d).pipe(B(()=>a)):M(a)}),He(1),B(l=>{let c=br(n.routeReuseStrategy,l.targetSnapshot,l.currentRouterState);this.currentTransition=a=l=w(h({},l),{targetRouterState:c}),this.currentNavigation.update(d=>(d.targetRouterState=c,d)),this.events.next(new Ve),s()&&(new ca(n.routeReuseStrategy,a.targetRouterState,a.currentRouterState,d=>this.events.next(d),this.inputBindingEnabled).activate(this.rootContexts),s()&&(t=!0,this.currentNavigation.update(d=>(d.abort=Ss,d)),this.lastSuccessfulNavigation.set(ie(this.currentNavigation)),this.events.next(new te(l.id,this.urlSerializer.serialize(l.extractedUrl),this.urlSerializer.serialize(l.urlAfterRedirects))),this.titleStrategy?.updateTitle(l.targetRouterState.snapshot),l.resolve(!0)))}),En(nt(r.signal).pipe(Ee(()=>!t&&!a.targetRouterState),ne(()=>{this.cancelNavigationTransition(a,r.signal.reason+"",L.Aborted)}))),ne({complete:()=>{t=!0}}),En(this.transitionAbortWithErrorSubject.pipe(ne(l=>{throw l}))),Ta(()=>{r.abort(),t||this.cancelNavigationTransition(a,"",L.SupersededByNewNavigation),this.currentTransition?.id===a.id&&(this.currentNavigation.set(null),this.currentTransition=null)}),xi(l=>{if(t=!0,this.destroyed)return a.resolve(!1),V;if(Xo(l))this.events.next(new q(a.id,this.urlSerializer.serialize(a.extractedUrl),l.message,l.cancellationCode)),Pr(l)?this.events.next(new We(l.url,l.navigationBehaviorOptions)):a.resolve(!1);else{let c=new Te(a.id,this.urlSerializer.serialize(a.extractedUrl),l,a.targetSnapshot??void 0);try{let d=W(this.environmentInjector,()=>this.navigationErrorHandler?.(c));if(d instanceof Ue){let{message:g,cancellationCode:p}=hi(this.urlSerializer,d);this.events.next(new q(a.id,this.urlSerializer.serialize(a.extractedUrl),g,p)),this.events.next(new We(d.redirectTo,d.navigationBehaviorOptions))}else throw this.events.next(c),l}catch(d){this.options.resolveNavigationPromiseOnError?a.resolve(!1):a.reject(d)}}return V}))}))}cancelNavigationTransition(n,a,t){let r=new q(n.id,this.urlSerializer.serialize(n.extractedUrl),a,t);this.events.next(r),n.resolve(!1)}isUpdatingInternalState(){return this.currentTransition?.extractedUrl.toString()!==this.currentTransition?.currentUrlTree.toString()}isUpdatedBrowserUrl(){let n=this.urlHandlingStrategy.extract(this.urlSerializer.parse(this.location.path(!0))),a=ie(this.currentNavigation),t=a?.targetBrowserUrl??a?.extractedUrl;return n.toString()!==t?.toString()&&!a?.extras.skipLocationChange}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})();function Ds(i){return i!==pn}var gt=new E("");var Rt=(()=>{let e=class e{};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(ys),providedIn:"root"}));let i=e;return i})(),gi=class{shouldDetach(e){return!1}store(e,o){}shouldAttach(e){return!1}retrieve(e){return null}shouldReuseRoute(e,o){return e.routeConfig===o.routeConfig}shouldDestroyInjector(e){return!0}},ys=(()=>{let e=class e extends gi{};u(e,"\u0275fac",(()=>{let n;return function(t){return(n||(n=Hi(e)))(t||e)}})()),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})(),fa=(()=>{let e=class e{urlSerializer=m(An);options=m(Cn,{optional:!0})||{};canceledNavigationResolution=this.options.canceledNavigationResolution||"replace";location=m(Ne);urlHandlingStrategy=m(fi);urlUpdateStrategy=this.options.urlUpdateStrategy||"deferred";currentUrlTree=new Z;getCurrentUrlTree(){return this.currentUrlTree}rawUrlTree=this.currentUrlTree;getRawUrlTree(){return this.rawUrlTree}createBrowserPath({finalUrl:n,initialUrl:a,targetBrowserUrl:t}){let r=n!==void 0?this.urlHandlingStrategy.merge(n,a):a,s=t??r;return s instanceof Z?this.urlSerializer.serialize(s):s}commitTransition({targetRouterState:n,finalUrl:a,initialUrl:t}){a&&n?(this.currentUrlTree=a,this.rawUrlTree=this.urlHandlingStrategy.merge(a,t),this.routerState=n):this.rawUrlTree=t}routerState=_o(null,m(Me));getRouterState(){return this.routerState}_stateMemento=this.createStateMemento();get stateMemento(){return this._stateMemento}updateStateMemento(){this._stateMemento=this.createStateMemento()}createStateMemento(){return{rawUrlTree:this.rawUrlTree,currentUrlTree:this.currentUrlTree,routerState:this.routerState}}restoredState(){return this.location.getState()}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:()=>m(As),providedIn:"root"}));let i=e;return i})(),As=(()=>{let e=class e extends fa{currentPageId=0;lastSuccessfulId=-1;get browserPageId(){return this.canceledNavigationResolution!=="computed"?this.currentPageId:this.restoredState()?.\u0275routerPageId??this.currentPageId}registerNonRouterCurrentEntryChangeListener(n){return this.location.subscribe(a=>{a.type==="popstate"&&setTimeout(()=>{n(a.url,a.state,"popstate")})})}handleRouterEvent(n,a){n instanceof we?this.updateStateMemento():n instanceof re?this.commitTransition(a):n instanceof Je?this.urlUpdateStrategy==="eager"&&(a.extras.skipLocationChange||this.setBrowserUrl(this.createBrowserPath(a),a)):n instanceof Ve?(this.commitTransition(a),this.urlUpdateStrategy==="deferred"&&!a.extras.skipLocationChange&&this.setBrowserUrl(this.createBrowserPath(a),a)):n instanceof q&&!jo(n)?this.restoreHistory(a):n instanceof Te?this.restoreHistory(a,!0):n instanceof te&&(this.lastSuccessfulId=n.id,this.currentPageId=this.browserPageId)}setBrowserUrl(n,{extras:a,id:t}){let{replaceUrl:r,state:s}=a;if(this.location.isCurrentPathEqualTo(n)||r){let l=this.browserPageId,c=h(h({},s),this.generateNgRouterState(t,l));this.location.replaceState(n,"",c)}else{let l=h(h({},s),this.generateNgRouterState(t,this.browserPageId+1));this.location.go(n,"",l)}}restoreHistory(n,a=!1){if(this.canceledNavigationResolution==="computed"){let t=this.browserPageId,r=this.currentPageId-t;r!==0?this.location.historyGo(r):this.getCurrentUrlTree()===n.finalUrl&&r===0&&(this.resetInternalState(n),this.resetUrlToCurrentUrlTree())}else this.canceledNavigationResolution==="replace"&&(a&&this.resetInternalState(n),this.resetUrlToCurrentUrlTree())}resetInternalState({finalUrl:n}){this.routerState=this.stateMemento.routerState,this.currentUrlTree=this.stateMemento.currentUrlTree,this.rawUrlTree=this.urlHandlingStrategy.merge(this.currentUrlTree,n??this.rawUrlTree)}resetUrlToCurrentUrlTree(){this.location.replaceState(this.urlSerializer.serialize(this.getRawUrlTree()),"",this.generateNgRouterState(this.lastSuccessfulId,this.currentPageId))}generateNgRouterState(n,a){return this.canceledNavigationResolution==="computed"?{navigationId:n,\u0275routerPageId:a}:{navigationId:n}}};u(e,"\u0275fac",(()=>{let n;return function(t){return(n||(n=Hi(e)))(t||e)}})()),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})();function Ma(i,e){i.events.pipe(Ee(o=>o instanceof te||o instanceof q||o instanceof Te||o instanceof re),B(o=>o instanceof te||o instanceof re?0:(o instanceof q?o.code===L.Redirect||o.code===L.SupersededByNewNavigation:!1)?2:1),Ee(o=>o!==2),He(1)).subscribe(()=>{e()})}var kt={paths:"exact",fragment:"ignored",matrixParams:"ignored",queryParams:"exact"},ft={paths:"subset",fragment:"ignored",matrixParams:"ignored",queryParams:"subset"},Mi=(()=>{let e=class e{get currentUrlTree(){return this.stateManager.getCurrentUrlTree()}get rawUrlTree(){return this.stateManager.getRawUrlTree()}disposed=!1;nonRouterCurrentEntryChangeSubscription;console=m(Wa);stateManager=m(fa);options=m(Cn,{optional:!0})||{};pendingTasks=m(Fa);urlUpdateStrategy=this.options.urlUpdateStrategy||"deferred";navigationTransitions=m(pt);urlSerializer=m(An);location=m(Ne);urlHandlingStrategy=m(fi);injector=m(Me);_events=new se;get events(){return this._events}get routerState(){return this.stateManager.getRouterState()}navigated=!1;routeReuseStrategy=m(Rt);injectorCleanup=m(gt,{optional:!0});onSameUrlNavigation=this.options.onSameUrlNavigation||"ignore";config=m(bn,{optional:!0})?.flat()??[];componentInputBindingEnabled=!!m(Ri,{optional:!0});currentNavigation=this.navigationTransitions.currentNavigation.asReadonly();constructor(){this.resetConfig(this.config),this.navigationTransitions.setupNavigations(this).subscribe({error:n=>{}}),this.subscribeToNavigationEvents()}eventsSubscription=new ya;subscribeToNavigationEvents(){let n=this.navigationTransitions.events.subscribe(a=>{try{let t=this.navigationTransitions.currentTransition,r=ie(this.navigationTransitions.currentNavigation);if(t!==null&&r!==null){if(this.stateManager.handleRouterEvent(a,r),a instanceof q&&a.code!==L.Redirect&&a.code!==L.SupersededByNewNavigation)this.navigated=!0;else if(a instanceof te)this.navigated=!0,this.injectorCleanup?.(this.routeReuseStrategy,this.routerState,this.config);else if(a instanceof We){let s=a.navigationBehaviorOptions,l=this.urlHandlingStrategy.merge(a.url,t.currentRawUrl),c=h({scroll:t.extras.scroll,browserUrl:t.extras.browserUrl,info:t.extras.info,skipLocationChange:t.extras.skipLocationChange,replaceUrl:t.extras.replaceUrl||this.urlUpdateStrategy==="eager"||Ds(t.source)},s);this.scheduleNavigation(l,pn,null,c,{resolve:t.resolve,reject:t.reject,promise:t.promise})}}xr(a)&&this._events.next(a)}catch(t){this.navigationTransitions.transitionAbortWithErrorSubject.next(t)}});this.eventsSubscription.add(n)}resetRootComponentType(n){this.routerState.root.component=n,this.navigationTransitions.rootComponentType=n}initialNavigation(){this.setUpLocationChangeListener(),this.navigationTransitions.hasRequestedNavigation||this.navigateToSyncWithBrowser(this.location.path(!0),pn,this.stateManager.restoredState())}setUpLocationChangeListener(){this.nonRouterCurrentEntryChangeSubscription??=this.stateManager.registerNonRouterCurrentEntryChangeListener((n,a,t)=>{this.navigateToSyncWithBrowser(n,t,a)})}navigateToSyncWithBrowser(n,a,t){let r={replaceUrl:!0},s=t?.navigationId?t:null;if(t){let c=h({},t);delete c.navigationId,delete c.\u0275routerPageId,Object.keys(c).length!==0&&(r.state=c)}let l=this.parseUrl(n);this.scheduleNavigation(l,a,s,r).catch(c=>{this.disposed||this.injector.get(Pi)(c)})}get url(){return this.serializeUrl(this.currentUrlTree)}getCurrentNavigation(){return ie(this.navigationTransitions.currentNavigation)}get lastSuccessfulNavigation(){return this.navigationTransitions.lastSuccessfulNavigation}resetConfig(n){this.config=n.map(Ra),this.navigated=!1}ngOnDestroy(){this.dispose()}dispose(){this._events.unsubscribe(),this.navigationTransitions.complete(),this.nonRouterCurrentEntryChangeSubscription?.unsubscribe(),this.nonRouterCurrentEntryChangeSubscription=void 0,this.disposed=!0,this.eventsSubscription.unsubscribe()}createUrlTree(n,a={}){let{relativeTo:t,queryParams:r,fragment:s,queryParamsHandling:l,preserveFragment:c}=a,d=c?this.currentUrlTree.fragment:s,g=null;switch(l??this.options.defaultQueryParamsHandling){case"merge":g=h(h({},this.currentUrlTree.queryParams),r);break;case"preserve":g=this.currentUrlTree.queryParams;break;default:g=r||null}g!==null&&(g=this.removeEmptyProps(g));let p;try{let f=t?t.snapshot:this.routerState.snapshot.root;p=Jo(f)}catch(f){(typeof n[0]!="string"||n[0][0]!=="/")&&(n=[]),p=this.currentUrlTree.root}return Vo(p,n,g,d??null,this.urlSerializer)}navigateByUrl(n,a={skipLocationChange:!1}){let t=ze(n)?n:this.parseUrl(n),r=this.urlHandlingStrategy.merge(t,this.rawUrlTree);return this.scheduleNavigation(r,pn,null,a)}navigate(n,a={skipLocationChange:!1}){return vs(n),this.navigateByUrl(this.createUrlTree(n,a),a)}serializeUrl(n){return this.urlSerializer.serialize(n)}parseUrl(n){try{return this.urlSerializer.parse(n)}catch(a){return this.console.warn(Ea(4018,!1)),this.urlSerializer.parse("/")}}isActive(n,a){let t;if(a===!0?t=h({},kt):a===!1?t=h({},ft):t=a,ze(n))return Do(this.currentUrlTree,n,t);let r=this.parseUrl(n);return Do(this.currentUrlTree,r,t)}removeEmptyProps(n){return Object.entries(n).reduce((a,[t,r])=>(r!=null&&(a[t]=r),a),{})}scheduleNavigation(n,a,t,r,s){if(this.disposed)return Promise.resolve(!1);let l,c,d;s?(l=s.resolve,c=s.reject,d=s.promise):d=new Promise((p,f)=>{l=p,c=f});let g=this.pendingTasks.add();return Ma(this,()=>{queueMicrotask(()=>this.pendingTasks.remove(g))}),this.navigationTransitions.handleNavigationRequest({source:a,restoredState:t,currentUrlTree:this.currentUrlTree,currentRawUrl:this.currentUrlTree,rawUrl:n,extras:r,resolve:l,reject:c,promise:d,currentSnapshot:this.routerState.snapshot,currentRouterState:this.routerState}),d.catch(Promise.reject.bind(Promise))}};u(e,"\u0275fac",function(a){return new(a||e)}),u(e,"\u0275prov",k({token:e,factory:e.\u0275fac,providedIn:"root"}));let i=e;return i})();function vs(i){for(let e=0;e<i.length;e++)if(i[e]==null)throw new T(4008,!1)}var bs=new E("");function Sa(i,...e){return La([{provide:bn,multi:!0,useValue:i},[],{provide:Re,useFactory:ws},{provide:ja,multi:!0,useFactory:Ts},e.map(o=>o.\u0275providers)])}function ws(){return m(Mi).routerState.root}function Ts(){let i=m(wi);return e=>{let o=i.get(_a);if(e!==o.components[0])return;let n=i.get(Mi),a=i.get(Ps);i.get(Es)===1&&n.initialNavigation(),i.get(Hs,null,{optional:!0})?.setUpPreloading(),i.get(bs,null,{optional:!0})?.init(),n.resetRootComponentType(o.componentTypes[0]),a.closed||(a.next(),a.complete(),a.unsubscribe())}}var Ps=new E("",{factory:()=>new se}),Es=new E("",{factory:()=>1});var Hs=new E("");var Si=class{constructor(){this.content=null,this.isPlaying=!1,this.currentTime=0}};var Di=(()=>{let e=class e{constructor(){this.state=new O(new Si)}performAction(n,a,t){let r=this.state.value;switch(n){case"play":a&&this.state.next({content:a,isPlaying:!0,currentTime:0});break;case"pause":this.state.next(w(h({},r),{isPlaying:!1}));break;case"stop":this.state.next(w(h({},r),{isPlaying:!1,currentTime:0}));break;case"seek":typeof t=="number"&&this.state.next(w(h({},r),{currentTime:t}));break}}getState(){return this.state.asObservable()}};e.\u0275fac=function(a){return new(a||e)},e.\u0275prov=k({token:e,factory:e.\u0275fac,providedIn:"root"});let i=e;return i})();var Mt=[{episodio:"B",titulo:"Resident #stayhome #quedateencasa special - Sunsetstrip Home Edition 4/4/2020",likes:"48",descargas:"51.2K",fecha:null,descripcion:`Full Sunsetstrip Home Edition 5 hr set, recorded on 4/4/2020
...
Elke Kleijn - Eenvoud (Navar Remix)`}];var St=(()=>{let e=class e{fetchEpisodes(){let n=Mt,a=n.map(x=>this.parseIntegerField(x.likes)),t=n.map(x=>this.parseDescargas(x.descargas)),r=n.map(x=>this.parseDateField(x.fecha)),s=n.map(x=>this.parseDateField(x.fechasubida)),l=n.map(x=>this.parseIntegerField(x.episodio)),c=this.createColorScale(this.getMaxValue(a)),d=this.createColorScale(this.getMaxValue(t)),g=this.createColorScale(this.getMaxValue(r)),p=this.createColorScale(this.getMaxValue(s)),f=this.createColorScale(this.getMaxValue(l),1);return M(n.map(x=>this.convertToEpisodeSort(x,c,d,g,p,f)))}convertToEpisodeSort(n,a,t,r,s,l){let c=this.parseIntegerField(n.likes),d=this.parseDescargas(n.descargas),g=this.parseDateField(n.fecha),p=this.parseDateField(n.fechasubida),f=this.parseIntegerField(n.episodio),x=n.tracklist??n.descripcion??"";return w(h({},n),{tracklist:x,_fechasubida:this.createExtendedField(n.fechasubida??"",p,this.resolveColor(s,p)),_fecha:this.createExtendedField(n.fecha??"",g,this.resolveColor(r,g)),_descargas:this.createExtendedField(n.descargas??"",d,this.resolveColor(t,d)),_likes:this.createExtendedField(n.likes??"",c,this.resolveColor(a,c)),_episodio:this.createExtendedField(n.episodio??"",f,this.resolveColor(l,f))})}createExtendedField(n,a=null,t="grey"){return{value:n??"",number:a,color:t}}parseDescargas(n){if(typeof n!="string")return null;let a=n.trim();if(!a)return null;let t=a.toLowerCase().endsWith("k")?1e3:1,r=parseFloat(a);return Number.isFinite(r)?r*t:null}parseIntegerField(n){if(typeof n!="string")return null;let a=parseInt(n,10);return Number.isFinite(a)?a:null}parseDateField(n){if(typeof n!="string")return null;let a=new Date(n).getTime();return Number.isFinite(a)?a:null}getMaxValue(n){let a=null;for(let t of n)typeof t=="number"&&Number.isFinite(t)&&(a===null||t>a)&&(a=t);return a}createColorScale(n,a=0){if(n===null)return null;let t=Math.min(a,n),r=n-t;return s=>{let l=r>0?(s-t)/r:0,c=Math.round(255*l),d=Math.round(128*(1-l));return`rgb(${c},${d},0)`}}resolveColor(n,a){return!n||a===null?"grey":n(a)}};e.\u0275fac=function(a){return new(a||e)},e.\u0275prov=k({token:e,factory:e.\u0275fac,providedIn:"root"});let i=e;return i})();var yi=(()=>{let e=class e{constructor(){this.options=Q([{value:"_likes",label:"Likes"},{value:"_descargas",label:"Descargas"},{value:"_fecha",label:"Fecha"},{value:"_episodio",label:"Episodio"}]),this.selectedField=Q("_likes")}setField(n){this.selectedField.set(n)}addOption(n){this.options().find(a=>a.value===n.value)||this.options.update(a=>[...a,n])}};e.\u0275fac=function(a){return new(a||e)},e.\u0275prov=k({token:e,factory:e.\u0275fac,providedIn:"root"});let i=e;return i})();function Ns(i){try{return localStorage.getItem(i)}catch(e){return null}}function Os(i,e){try{localStorage.setItem(i,e)}catch(o){}}var Ye=(()=>{let e=class e{constructor(){this.presets=[{label:"Legacy",style:"legacy",mode:"light"},{label:"Default \xB7 System",style:"default",mode:"system"},{label:"Default \xB7 Light",style:"default",mode:"light"},{label:"Default \xB7 Dark",style:"default",mode:"dark"},{label:"Minimal 2D \xB7 System",style:"minimal-2d",mode:"system"},{label:"Minimal 2D \xB7 Light",style:"minimal-2d",mode:"light"},{label:"Minimal 2D \xB7 Dark",style:"minimal-2d",mode:"dark"}],this._activePreset=Q(this.loadInitialPreset()),this.activePreset=this._activePreset.asReadonly(),this._resolvedMode=Q("light"),this.resolvedMode=this._resolvedMode.asReadonly(),this._mediaQuery=null,this._mediaListener=null,this.destroyRef=m($e),this.updateResolvedMode(this._activePreset().mode),this.applyPreset(),Qe(()=>{this._activePreset(),this.initSystemListener()}),Qe(()=>{let n=this._resolvedMode();typeof document<"u"&&document.body.setAttribute("data-mode",n)}),this.destroyRef.onDestroy(()=>{this.removeMediaListener()})}setPreset(n){this._activePreset.set(n),this.applyPreset(),Os("theme-preset",JSON.stringify({style:n.style,mode:n.mode}))}loadInitialPreset(){let n=this.presets.find(a=>a.label==="Default \xB7 System");try{let a=Ns("theme-preset");if(!a)return n;let t=JSON.parse(a);return this.presets.find(s=>s.style===t.style&&s.mode===t.mode)??n}catch(a){return n}}updateResolvedMode(n){if(n==="system"){let a=typeof window<"u"?window.matchMedia("(prefers-color-scheme: dark)").matches:!1;this._resolvedMode.set(a?"dark":"light")}else this._resolvedMode.set(n)}applyPreset(){let n=this._activePreset();this.updateResolvedMode(n.mode),document.body.setAttribute("data-theme",n.style);let a=`/assets/themes/theme-${n.style}.css`,t=document.getElementById("theme-css");t?t.href=a:(t=document.createElement("link"),t.id="theme-css",t.rel="stylesheet",t.href=a,document.head.appendChild(t))}initSystemListener(){let n=this._activePreset();this.removeMediaListener(),n.mode==="system"&&typeof window<"u"&&(this._mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this._mediaListener=()=>{this._resolvedMode.set(this._mediaQuery.matches?"dark":"light")},this._mediaQuery.addEventListener("change",this._mediaListener))}removeMediaListener(){this._mediaQuery&&this._mediaListener&&(this._mediaQuery.removeEventListener("change",this._mediaListener),this._mediaListener=null,this._mediaQuery=null)}};e.\u0275fac=function(a){return new(a||e)},e.\u0275prov=k({token:e,factory:e.\u0275fac,providedIn:"root"});let i=e;return i})();var Is=(i,e)=>e.episodio,Gs=(i,e)=>e.value;function Ks(i,e){if(i&1&&(v(0,"span",17),P(1),y()),i&2){let o=C(2).$implicit,n=C();A(),In("",n.trackCount(o.tracklist)," tracks")}}function zs(i,e){if(i&1&&(v(0,"div",9,0)(2,"div",10),P(3),y(),v(4,"div",11)(5,"span",12),Se(),v(6,"svg",13),On(7,"path",14),y(),P(8),y(),Ze(),v(9,"span",15),Se(),v(10,"svg",13),On(11,"path",16),y(),P(12),y(),ue(13,Ks,2,1,"span",17),y(),Ze(),On(14,"div",18),y()),i&2){let o,n=C().$implicit,a=C();an("background-color",((o=n[a.sort.selectedField()])==null?null:o.color)??"grey"),A(3),X(n.titulo),A(5),In(" ",n.likes," "),A(4),In(" ",n.descargas," "),A(),me(a.trackCount(n.tracklist)>0?13:-1),A(),Ae("innerHTML",a.tracklistWithBreaks(n.tracklist),Ia)}}function Js(i,e){if(i&1){let o=Be();v(0,"div",6),ve("click",function(){let a=I(o).$index,t=C();return G(t.onEpisodeClick(a))}),v(1,"div",7),P(2),y()(),ue(3,zs,15,7,"div",8)}if(i&2){let o,n=e.$implicit,a=e.$index,t=C();an("background-color",((o=n[t.sort.selectedField()])==null?null:o.color)??"grey")("animation-delay",t.animatingSort?t.Math.min(a,20)*70+"ms":"0ms"),en("data-episode-id",n.link),A(2),X(n.episodio),A(),me(t.selectedIndex===a?3:-1)}}function Vs(i,e){if(i&1&&(v(0,"option",5),P(1),y()),i&2){let o=e.$implicit,n=C();Ae("value",o.value)("selected",n.sort.selectedField()===o.value),A(),X(o.label)}}var Dt=(()=>{let e=class e{constructor(){this.selectedIndex=null,this.episodes=[],this.animatingSort=!1,this.Math=Math,this.playerService=m(Di),this.episodesService=m(St),this.cdr=m(on),this.sort=m(yi),this.theme=m(Ye),Qe(()=>{let n=this.sort.selectedField();if(this.episodes.length){let a=this.selectedIndex!==null?this.episodes[this.selectedIndex]?.link??null:null;ie(()=>this.triggerSortAnimation()),this.sortEpisodes(n),this.selectedIndex=a!==null?this.episodes.findIndex(t=>t.link===a):null,this.selectedIndex===-1&&(this.selectedIndex=null),this.cdr.markForCheck()}})}ngOnInit(){this.episodesService.fetchEpisodes().subscribe({next:n=>{this.episodes=n,n.some(a=>!!a.fechasubida)&&this.sort.addOption({value:"_fechasubida",label:"Fecha subida"}),this.sortEpisodes(this.sort.selectedField()),this.cdr.markForCheck()},error:n=>console.error("Error fetching episodes:",n)})}triggerSortAnimation(){this.theme.activePreset().style==="minimal-2d"&&(this.animatingSort=!0,setTimeout(()=>{this.animatingSort=!1,this.cdr.markForCheck()},800))}onEpisodeClick(n){this.selectedIndex=this.selectedIndex===n?null:n;let a=this.episodes[n];this.playContent({title:a.titulo,link:a.link??"",id:a.episodio??""}),this.selectedIndex!==null&&setTimeout(()=>document.querySelector(".episode-detail-row")?.scrollIntoView({behavior:"smooth",block:"center"}))}playContent(n){this.playerService.performAction("play",n)}onLegacySortChange(n){let a=n.target;this.sort.setField(a.value)}tracklistWithBreaks(n){return n?n.replace(/\n/g,"<br>"):""}trackCount(n){return n?n.split(`
`).filter(a=>a.trim()).length:0}sortEpisodes(n){this.episodes.length&&(this.episodes=[...this.episodes].sort((a,t)=>{let r=this.getSortableValue(a,n),s=this.getSortableValue(t,n);return r===null&&s===null?0:r===null?1:s===null?-1:s-r}))}getSortableValue(n,a){let t=n[a];if(!t)return null;if(typeof t.number=="number"&&Number.isFinite(t.number))return t.number;let r=parseFloat(t.value??"");return Number.isFinite(r)?r:null}};e.\u0275fac=function(a){return new(a||e)},e.\u0275cmp=U({type:e,selectors:[["app-episodes-grid"]],decls:9,vars:2,consts:[["detailRow",""],[1,"episode-grid"],[1,"legacy-sort-wrap"],["for","orderby"],["id","orderby",3,"change"],[3,"value","selected"],[1,"episode-item",3,"click"],[1,"episodio"],[1,"episode-detail-row",3,"background-color"],[1,"episode-detail-row"],[1,"titulo"],[1,"meta"],[1,"likes"],["viewBox","0 0 16 16","width","11","height","11","fill","currentColor","aria-hidden","true",2,"vertical-align","-1px"],["d","M8 14s-6-3.9-6-8a4 4 0 0 1 6-3.46A4 4 0 0 1 14 6c0 4.1-6 8-6 8z"],[1,"descargas"],["d","M8 12L2 6h4V1h4v5h4L8 12z"],[1,"track-count"],[1,"tracklist",3,"innerHTML"]],template:function(a,t){a&1&&(v(0,"div",1),De(1,Js,4,7,null,null,Is),y(),v(3,"div",2)(4,"label",3),P(5,"Ordenar:"),y(),v(6,"select",4),ve("change",function(s){return t.onLegacySortChange(s)}),De(7,Vs,2,3,"option",5,Gs),y()()),a&2&&(Fe("sorting",t.animatingSort),A(),ye(t.episodes),A(6),ye(t.sort.options()))},dependencies:[Oe],styles:['@charset "UTF-8";.legacy-sort-wrap[_ngcontent-%COMP%]{display:none;padding:8px 12px;font-size:12px}body[data-theme=legacy][_nghost-%COMP%]   .legacy-sort-wrap[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .legacy-sort-wrap[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px}.episode-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{display:grid;padding:0;width:auto;position:relative;z-index:1;cursor:pointer;height:85px;align-content:center;transition:all .3s ease;content-visibility:auto;contain-intrinsic-size:120px 85px}.episode-grid[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]   .episodio[_ngcontent-%COMP%]{text-align:center}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-item[_ngcontent-%COMP%]{border:1px solid var(--border, transparent);opacity:0;animation:_ngcontent-%COMP%_tile-in .5s steps(2) forwards;font-family:var(--font-ui)}body[data-theme=minimal-2d][_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .episode-grid.sorting[_ngcontent-%COMP%]   .episode-item[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_tile-sort .6s steps(2) forwards}@keyframes _ngcontent-%COMP%_tile-in{0%{opacity:0;transform:scaleX(1.06)}40%{opacity:1;transform:scaleX(.97) translate(1px)}70%{opacity:.7;transform:scaleX(1.02)}to{opacity:1;transform:none}}@keyframes _ngcontent-%COMP%_tile-sort{0%{opacity:1;filter:blur(0)}20%{opacity:.3;filter:blur(1px);transform:scaleX(1.04)}50%{opacity:.8;filter:blur(0);transform:scaleX(.98)}to{opacity:1;transform:none}}.episode-detail-row[_ngcontent-%COMP%]{grid-column:1/-1;transition:all .3s ease;padding:40px 30px;word-break:break-word;overflow-wrap:break-word;min-width:0}.episode-detail-row[_ngcontent-%COMP%]   .titulo[_ngcontent-%COMP%]{font-size:2em;font-weight:600;margin-bottom:8px}.episode-detail-row[_ngcontent-%COMP%]   .meta[_ngcontent-%COMP%]{display:flex;gap:16px;font-size:13px;opacity:.75;margin-bottom:16px}.episode-detail-row[_ngcontent-%COMP%]   .tracklist[_ngcontent-%COMP%]{max-height:300px;overflow-y:auto;font-size:13px;line-height:1.7;font-family:var(--font-ui, "Libre Franklin", sans-serif)}body[data-theme=minimal-2d][_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%], body[data-theme=minimal-2d]   [_nghost-%COMP%]   .tracklist[_ngcontent-%COMP%]{font-family:var(--font-ui);font-size:12px;color:var(--text);border-left:2px solid var(--accent, #333);padding-left:12px}'],changeDetection:0});let i=e;return i})();var yt=[{path:"",component:Dt},{path:"**",redirectTo:""}];var Da={providers:[Sa(yt)]};var Ws=(i,e)=>e.label,At=(i,e)=>e.value;function Us(i,e){if(i&1&&(v(0,"option",6),P(1),y()),i&2){let o=e.$implicit,n=e.$index,a=C();Ae("value",n)("selected",a.theme.activePreset()===o),A(),X(o.label)}}function js(i,e){if(i&1&&(v(0,"option",6),P(1),y()),i&2){let o=e.$implicit,n=C();Ae("value",o.value)("selected",n.sort.selectedField()===o.value),A(),X(o.label)}}function _s(i,e){if(i&1&&(v(0,"option",6),P(1),y()),i&2){let o=e.$implicit,n=C(2);Ae("value",o.value)("selected",n.mood.currentMood()===o.value),A(),X(o.label)}}function qs(i,e){if(i&1){let o=Be();v(0,"div",3)(1,"label",9),P(2,"Mood"),y(),v(3,"select",10),ve("change",function(a){I(o);let t=C();return G(t.onMoodChange(a))}),De(4,_s,2,3,"option",6,At),y()()}if(i&2){let o=C();A(4),ye(o.mood.moodOptions)}}var vt=(()=>{let e=class e{constructor(){this.theme=m(Ye),this.sort=m(yi),this.mood=m(ao)}onThemeChange(n){let a=n.target,t=Number(a.value);this.theme.setPreset(this.theme.presets[t])}onSortChange(n){let a=n.target;this.sort.setField(a.value)}onMoodChange(n){let a=n.target;this.mood.setMood(a.value)}};e.\u0275fac=function(a){return new(a||e)},e.\u0275cmp=U({type:e,selectors:[["app-header"]],decls:17,vars:1,consts:[[1,"app-header"],[1,"logo"],[1,"controls"],[1,"sort-wrap"],["for","header-theme",1,"sort-label"],["id","header-theme",1,"theme-select",3,"change"],[3,"value","selected"],["for","header-sort",1,"sort-label"],["id","header-sort",3,"change"],["for","header-mood",1,"sort-label"],["id","header-mood",3,"change"]],template:function(a,t){a&1&&(v(0,"header",0)(1,"span",1),P(2,"CATTANEO"),y(),v(3,"div",2)(4,"div",3)(5,"label",4),P(6,"Theme"),y(),v(7,"select",5),ve("change",function(s){return t.onThemeChange(s)}),De(8,Us,2,3,"option",6,Ws),y()(),v(10,"div",3)(11,"label",7),P(12,"Sort"),y(),v(13,"select",8),ve("change",function(s){return t.onSortChange(s)}),De(14,js,2,3,"option",6,At),y()(),ue(16,qs,6,0,"div",3),y()()),a&2&&(A(8),ye(t.theme.presets),A(6),ye(t.sort.options()),A(2),me(t.theme.activePreset().style!=="legacy"?16:-1))},dependencies:[Oe],styles:['@charset "UTF-8";.app-header[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;padding:0 20px;height:var(--header-height, 52px);background:var(--bg-header, #fff);border-bottom:1px solid var(--border-header, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);flex-shrink:0}.app-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{font-weight:700;font-size:15px;letter-spacing:3px;color:var(--text-logo, #111)}.app-header[_ngcontent-%COMP%]   .controls[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px}.app-header[_ngcontent-%COMP%]   .sort-wrap[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px}.app-header[_ngcontent-%COMP%]   .sort-label[_ngcontent-%COMP%]{font-size:10px;color:var(--text-muted);letter-spacing:.5px;text-transform:uppercase}.app-header[_ngcontent-%COMP%]   select[_ngcontent-%COMP%], .app-header[_ngcontent-%COMP%]   .theme-select[_ngcontent-%COMP%]{font-family:var(--font-ui);font-size:11px;padding:4px 8px;border:1px solid var(--border);border-radius:var(--player-radius, 4px);background:var(--bg);color:var(--text);cursor:pointer}body[data-theme=legacy][_nghost-%COMP%]   .app-header[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .app-header[_ngcontent-%COMP%]{display:none}'],changeDetection:0});let i=e;return i})();var xt=(()=>{let e=class e{};e.\u0275fac=function(a){return new(a||e)},e.\u0275cmp=U({type:e,selectors:[["app-footer"]],decls:7,vars:0,consts:[[1,"app-footer"],["href","/dmca","target","_blank","rel","noopener"],[1,"sep"],["href","/privacy","target","_blank","rel","noopener"]],template:function(a,t){a&1&&(v(0,"footer",0)(1,"a",1),P(2,"DMCA"),y(),v(3,"span",2),P(4,"\xB7"),y(),v(5,"a",3),P(6,"Privacy Policy"),y()())},styles:['@charset "UTF-8";.app-footer[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:center;gap:10px;height:32px;background:var(--bg-footer, #f5f5f5);border-top:1px solid var(--border, #e8e8e8);font-family:var(--font-ui, "Libre Franklin", sans-serif);font-size:11px;flex-shrink:0}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{color:var(--text-muted, #aaa);text-decoration:none;letter-spacing:.5px;transition:color .2s}.app-footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{color:var(--text)}.app-footer[_ngcontent-%COMP%]   .sep[_ngcontent-%COMP%]{color:var(--border, #ccc)}body[data-theme=legacy][_nghost-%COMP%]   .app-footer[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .app-footer[_ngcontent-%COMP%]{display:none}'],changeDetection:0});let i=e;return i})();var Ys=["audioPlayer"],Zs=()=>[import("./chunk-NOF5QWIN.js").then(i=>i.VisualizerComponent)];function $s(i,e){i&1&&(Se(),K(0,"svg",3),_(1,"rect",15)(2,"rect",16),j())}function Qs(i,e){i&1&&(Se(),K(0,"svg",3),_(1,"polygon",17),j())}function Xs(i,e){i&1&&_(0,"app-visualizer")}function el(i,e){if(i&1){let o=Be();K(0,"div",1)(1,"button",2),nn("click",function(){I(o);let a=C();return G(a.togglePlay())}),ue(2,$s,3,0,":svg:svg",3)(3,Qs,2,0,":svg:svg",3),j(),K(4,"button",4),nn("click",function(){I(o);let a=C();return G(a.showVisualizer=!a.showVisualizer)}),Se(),K(5,"svg",3),_(6,"rect",5)(7,"rect",6)(8,"rect",7)(9,"rect",8),j()(),Ze(),K(10,"div",9)(11,"div",10),P(12),j(),K(13,"div",11),Va(14,Xs,1,0),qa(15,14,Zs),j(),K(17,"input",12),nn("pointerdown",function(){I(o);let a=C();return G(a.isDragging=!0)})("pointerup",function(){I(o);let a=C();return G(a.isDragging=!1)})("pointercancel",function(){I(o);let a=C();return G(a.isDragging=!1)})("input",function(a){I(o);let t=C();return G(t.onSeek(a))}),j()(),K(18,"audio",13,0),nn("timeupdate",function(){I(o);let a=C();return G(a.onTimeUpdate())})("loadedmetadata",function(){I(o);let a=C();return G(a.onMetadata())})("ended",function(){I(o);let a=C();return G(a.onAudioEnded())}),_(20,"source",14),j()()}if(i&2){let o=C();A(),en("aria-label",o.isPlaying?"Pause":"Play"),A(),me(o.isPlaying?2:3),A(2),Fe("active",o.showVisualizer),en("aria-label",o.showVisualizer?"Hide visualizer":"Show visualizer"),A(8),X(o.currentContent.title),A(),Fe("vis-open",o.showVisualizer),A(2),Ya(o.showVisualizer),A(2),an("--progress-pct",o.progressPercent+"%"),Fe("dragging",o.isDragging),Gi("value",o.progressPercent),A(3),Gi("src",o.currentContent.link)}}var Ct=(()=>{let e=class e{set audioPlayerRef(n){this.audioElement=n?.nativeElement??null,this.audioElement&&this.audioAnalysis.connect(this.audioElement),this.syncAudio()}constructor(n){this.playerService=n,this.currentContent=null,this.progressPercent=0,this.duration=0,this.isPlaying=!1,this.isDragging=!1,this.showVisualizer=!1,this.audioElement=null,this.lastState=null,this.activeLink=null,this.audioAnalysis=m(oo),this.playerService.getState().pipe(to()).subscribe(a=>{this.lastState=a,this.currentContent=a.content,this.isPlaying=a.isPlaying,this.syncAudio()})}togglePlay(){this.lastState&&(this.audioAnalysis.resume(),this.lastState.isPlaying?this.playerService.performAction("pause"):this.playerService.performAction("play",this.lastState.content??void 0))}onMetadata(){this.duration=this.audioElement?.duration??0}onTimeUpdate(){if(!this.audioElement||!this.lastState)return;!this.isDragging&&this.audioElement.duration&&(this.progressPercent=this.audioElement.currentTime/this.audioElement.duration*100);let n=this.audioElement.currentTime;Math.abs(n-this.lastState.currentTime)>1&&this.playerService.performAction("seek",void 0,n)}onSeek(n){let a=+n.target.value,t=a/100*this.duration;this.progressPercent=a,this.playerService.performAction("seek",void 0,t),this.audioElement&&(this.audioElement.currentTime=t)}onAudioEnded(){this.playerService.performAction("stop")}syncAudio(){if(!this.audioElement||!this.lastState)return;let{content:n,currentTime:a,isPlaying:t}=this.lastState;if(!n){this.audioElement.pause(),this.activeLink&&(this.audioElement.removeAttribute("src"),this.audioElement.load(),this.activeLink=null);return}this.activeLink!==n.link&&(this.audioElement.src=n.link,this.audioElement.load(),this.activeLink=n.link),Math.abs(this.audioElement.currentTime-a)>1&&(this.audioElement.currentTime=a),t&&this.audioElement.paused?this.audioElement.play():!t&&!this.audioElement.paused&&this.audioElement.pause()}};e.\u0275fac=function(a){return new(a||e)(Fi(Di))},e.\u0275cmp=U({type:e,selectors:[["app-episode-player"]],viewQuery:function(a,t){if(a&1&&Za(Ys,5),a&2){let r;$a(r=Qa())&&(t.audioPlayerRef=r.first)}},decls:1,vars:1,consts:[["audioPlayer",""],[1,"floating-player"],[1,"play-btn",3,"click"],["viewBox","0 0 16 16","width","14","height","14","fill","currentColor","aria-hidden","true"],[1,"vis-btn",3,"click"],["x","1","y","8","width","3","height","7","rx","1"],["x","5","y","4","width","3","height","11","rx","1"],["x","9","y","6","width","3","height","9","rx","1"],["x","13","y","2","width","3","height","13","rx","1"],[1,"track-info"],[1,"track-title"],[1,"vis-wrapper"],["type","range","min","0","max","100","step","0.1","aria-label","Seek",1,"seek-bar",3,"pointerdown","pointerup","pointercancel","input","value"],["controls","","crossorigin","anonymous",2,"display","none",3,"timeupdate","loadedmetadata","ended"],["type","audio/mpeg",3,"src"],["x","2","y","1","width","5","height","14","rx","1"],["x","9","y","1","width","5","height","14","rx","1"],["points","3,1 15,8 3,15"]],template:function(a,t){a&1&&ue(0,el,21,15,"div",1),a&2&&me(t.currentContent?0:-1)},styles:['@charset "UTF-8";[_nghost-%COMP%]{pointer-events:none}.floating-player[_ngcontent-%COMP%]{pointer-events:auto;position:fixed;bottom:52px;left:20px;right:20px;z-index:100;display:flex;align-items:center;gap:12px;padding:12px 16px;background:var(--bg-player, #fff);border:1px solid var(--border, #e0e0e0);border-radius:var(--player-radius, 8px);box-shadow:var(--player-shadow, 0 2px 12px rgba(0, 0, 0, .1));font-family:var(--font-ui, "Libre Franklin", sans-serif);color:var(--text, #222);transition:background .3s ease,border-color .3s ease,box-shadow .3s ease}.play-btn[_ngcontent-%COMP%]{width:36px;height:36px;flex-shrink:0;border-radius:var(--player-radius, 50%);border:1px solid var(--border, transparent);background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:box-shadow .2s}.track-info[_ngcontent-%COMP%]{flex:1;min-width:0}.track-title[_ngcontent-%COMP%]{font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--text)}.seek-bar[_ngcontent-%COMP%]{-webkit-appearance:none;appearance:none;display:block;width:100%;height:3px;margin-top:8px;border-radius:2px;outline:none;cursor:pointer;background:linear-gradient(to right,var(--player-fill, #222) var(--progress-pct, 0%),var(--player-track, #e0e0e0) var(--progress-pct, 0%));touch-action:pan-x}.seek-bar[_ngcontent-%COMP%]::-webkit-slider-thumb{-webkit-appearance:none;width:0;height:0;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease,margin-top .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-webkit-slider-thumb, .seek-bar[_ngcontent-%COMP%]:active::-webkit-slider-thumb{width:18px;height:18px;margin-top:-7px}.seek-bar[_ngcontent-%COMP%]::-moz-range-thumb{width:0;height:0;border:none;border-radius:50%;background:var(--player-fill, #222);transition:width .12s ease,height .12s ease}.seek-bar.dragging[_ngcontent-%COMP%]::-moz-range-thumb, .seek-bar[_ngcontent-%COMP%]:active::-moz-range-thumb{width:18px;height:18px}body[data-theme=minimal-2d][data-mode=dark][_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=minimal-2d][data-mode=dark]   [_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_glow-pulse 1.4s ease-in-out infinite}@keyframes _ngcontent-%COMP%_glow-pulse{0%,to{box-shadow:none}50%{box-shadow:var(--glow, none)}}body[data-theme=legacy][_nghost-%COMP%]   .floating-player[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .floating-player[_ngcontent-%COMP%]{position:static;bottom:unset;left:unset;right:unset;border-radius:0;box-shadow:none;border:none;border-top:1px solid #ddd;background:#f0f0f0}body[data-theme=legacy][_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .play-btn[_ngcontent-%COMP%], body[data-theme=legacy][_nghost-%COMP%]   .track-info[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .track-info[_ngcontent-%COMP%]{display:none}body[data-theme=legacy][_nghost-%COMP%]   audio[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   audio[_ngcontent-%COMP%]{display:block!important;width:100%}.vis-wrapper[_ngcontent-%COMP%]{overflow:hidden;max-height:0;opacity:0;transition:max-height .35s ease,opacity .25s ease}.vis-wrapper.vis-open[_ngcontent-%COMP%]{max-height:52px;opacity:1}.vis-btn[_ngcontent-%COMP%]{width:28px;height:28px;flex-shrink:0;border-radius:var(--player-radius, 4px);border:1px solid var(--border, #e0e0e0);background:transparent;color:var(--text, #222);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:.5;transition:opacity .2s,background .2s}.vis-btn.active[_ngcontent-%COMP%]{opacity:1;background:var(--player-btn-bg, #222);color:var(--player-btn-fg, #fff);border-color:transparent}']});let i=e;return i})();var bt=(()=>{let e=class e{constructor(){this._theme=m(Ye)}};e.\u0275fac=function(a){return new(a||e)},e.\u0275cmp=U({type:e,selectors:[["app-root"]],decls:6,vars:0,consts:[[1,"app-container"],[1,"app-content"]],template:function(a,t){a&1&&(K(0,"div",0),_(1,"app-header"),K(2,"main",1),_(3,"router-outlet"),j(),_(4,"app-episode-player")(5,"app-footer"),j())},dependencies:[vn,vt,xt,Ct],styles:[".app-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;height:100vh;max-height:-webkit-fill-available;background:var(--bg, #fff)}.app-content[_ngcontent-%COMP%]{flex:1;overflow-y:auto;padding-bottom:144px}body[data-theme=legacy][_nghost-%COMP%]   .app-content[_ngcontent-%COMP%], body[data-theme=legacy]   [_nghost-%COMP%]   .app-content[_ngcontent-%COMP%]{padding-bottom:0}"]});let i=e;return i})();Yi(bt,w(h({},Da),{providers:[no(),...Da.providers]})).catch(i=>console.error(i));
